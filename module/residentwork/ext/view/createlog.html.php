...
<div id="mainContent" class="main-content fade">
    <div class="center-block">
        <div class="main-header">
            <h2><?php echo $this->lang->residentsupport->logBook;?></h2>
        </div>
        <form class="load-indicator main-form form-ajax" method='post' enctype='multipart/form-data' id='dataform'>
            <table class="table table-form">
                <tr>
                    <th><?php echo $lang->residentsupport->dutyDate;?></th>
                    <td ><?php echo html::input('dutyDate', '', "class='form-date form-control' ");?></td>
                </tr>

                <tr>
                    <th><?php echo $lang->residentsupport->type;?></th>
                    <td ><?php echo html::select('type', $typeList, '', "class='form-control chosen' onchange='switchUsers()' required");?></td>
                    <td>
                        <div class="input-group">
                            ...
                            <?php echo html::select('subType', $subTypeList, '', "class='form-control chosen' required");?>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <div class="input-group">
                            ...
                            <?php echo html::select('area', $areaList, '', "class='form-control chosen' required");?>
                        </div>
                    </td>
                </tr>
                <tr>
                    <th><?php echo $lang->residentwork->actualLeader;?></th>
                    <td><?php echo html::select('groupLeader',$users, '', "class='form-control chosen' onchange='switchUsers()'   required");?></td>
                    <td>
                        <div class="input-group">
                            ...
                            <?php echo html::select('realDutyuser[]', $users, '', "class='form-control chosen' onchange='switchUsers()' multiple required");?>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="radio" name="isEmergency" value="1" checked>&nbsp;是 &nbsp;&nbsp;
                        <input type="radio" name="isEmergency" value="2" >&nbsp;否
                    </td>
                </tr>
                <tr class="emergencyRemark">
                    <th><?php echo $lang->residentwork->emergencyRemark;?>（限制499字符）</th>
                    <td colspan='2'><?php echo html::textarea('remark', '', "class='form-control textarea' ");?></td>
                </tr>
                <tr >

                    <th><?php echo $lang->residentwork->desc;?></th>
                    <td colspan='2'><?php echo html::textarea('logs', '', "class='form-control textarea' required");?></td>
                </tr>
                <tr >
                    <th><?php echo $lang->residentwork->warnLogs;?>（限制499字符）</th>
                    <td colspan='2'><?php echo html::textarea('warnLogs', '', "class='form-control textarea' required");?></td>
                </tr>
                <tr >
                    <th><?php echo $lang->residentwork->analysis;?>（限制499字符）</th>
                    <td colspan='2'><?php echo html::textarea('analysis', '', "class='form-control textarea' ");?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan='2'><?php echo html::select('mailCtoUsers[]', $users, '', "class='form-control chosen' multiple ");?></td>
                </tr>
                <tr>
                    <!--   默认不推送值班日志                 -->
