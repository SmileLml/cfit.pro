...
<div class='row <?php echo $class;?>' id='cardMode'>
  ...
  <div class='col-md-3 col-sm-4'>
    <div class='panel panel-block flow-block' id='flowBlock'>
      ...
      <div class='panel-body'>
        ...
        <div class='footerbar hide pull-right' data-module='<?php echo $flow->module;?>'>
          ...
          if($canPreview) echo baseHTML::a($this->createLink("{$flow->module}", 'browse'), $lang->workflow->preview, "class='btn btn-default' data-app='{$flow->app}' target='_blank'");
