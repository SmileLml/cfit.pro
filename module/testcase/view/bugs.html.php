    ...
    <table class='table table-fixed'>
      ...
      <tbody>
        ...
        <tr class='text-center'>
          ...
          <td class='text-primary' title="<?php echo $bug->title?>"><?php echo html::a($this->createLink('bug', 'view', array('bugID' => $bug->id), '', true), $bug->title, '', "class='text-primary'");?></td>
          ...
          <td><?php echo html::a($this->createLink('bug', 'edit', array('bugID' => $bug->id), '', true), '<i class="icon-common-edit icon-edit"></i>', '', "class='text-primary'");?></td>
        </tr>
        <?php endforeach;?>
      </tbody>
    </table>
