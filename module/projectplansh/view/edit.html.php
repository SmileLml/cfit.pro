...
<div id="mainContent" class="main-content fade">
    <div class="center-block">
        <div class="main-header">
            <h2><?php echo $lang->projectplan->edit;?></h2>
        </div>
        <form class="load-indicator main-form form-ajax" method='post' enctype='multipart/form-data' id='dataform' onsubmit="return checkTaskDate()">
            <table class="table table-form">
                ...
                <tr>
                    ...
                    <td>
                        <div class='input-group required'>
                            <?php echo html::input('workload', $plan->workload, "placeholder = '自动计算' class='form-control' onblur='totalWorkload(this)' readonly maxlength='10'");?>
                            <span class='input-group-addon'><?php echo $lang->projectplan->monthly;?></span>
                        </div>
                    </td>
                    <td>
...
/*                        }
                ...
                <?php
                if($plan->status == "yearreviewing" && $plan->reviewStage <= 4 && $plan->reviewStage > 0){
?>
                    <tr>
                        <th></th>
                        <td class="required red" colspan='2'>【提示】修改变更内容请与部门负责人提前线下沟通确认，系统将通过邮件告知。<br />
                            【通知人】【默认为项目负责人所属部门负责人且不可取消，可支持添加其他人员】（不影响审批节点，仅做通知）
                        </td>

                    </tr>
                    <tr>
                        <th>通知人</th>
                        <td class="required" colspan='2'><?php echo html::select('email[]', $users, $leader->manager1, "class='form-control chosen' multiple ");?></td>

                    </tr>
                    <tr>
                        <th><?php echo $lang->projectplan->editmark;?></th>
                        <td class="required" colspan='2'><?php echo html::textarea('editmark', $plan->projectplan->editmark ?? '', "class='form-control' maxlength='1000'");?></td>
                    </tr>
                <?php
                }
                ?>
...
<script>
    $(function(){
        $("#email_chosen .chosen-choices li:eq(0) a").remove();
    })
