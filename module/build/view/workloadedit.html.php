...
<div id="mainContent" class="main-content fade">
  <div class="center-block">
    <div class="main-header">
      <h2><?php echo $lang->build->workloadEdit;?></h2>
    </div>
    <form class="load-indicator main-form form-ajax" method='post' enctype='multipart/form-data' id='dataform'>
      <table class="table table-form">
          <tr>
            <th class='w-140px'><?php echo $lang->build->account;?></th>
         ...
         <!-- <tr>
          ...
          ?>
          <tr>
            <th class='w-140px'><?php echo $lang->build->before;?></th>
            <td><?php echo html::select('before', $lang->build->statusListNew, $consumed->before, "class='form-control chosen'");?></td>
          </tr>
          <tr>
            <th class='w-140px'><?php echo $lang->build->after;?></th>
            <td><?php echo html::select('after', $lang->build->changestatusNew, $consumed->after, "class='form-control chosen'");?></td>
          </tr>
          <?php if($isLastConsumed):?>
              <tr>
                  <th class='w-140px'><?php echo $lang->build->nextUser;?></th>
                  <td><?php echo html::select('dealuser', $users, $build->dealuser, "class='form-control chosen'");?></td>
              </tr>
          <?php endif;?>
