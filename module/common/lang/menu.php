...
$lang->navIcons['reviewmanage'] = "<i class='icon icon-glasses'></i>"; //20220712 增加
global $config;
...
$lang->mainNav->reviewmanage = "{$lang->navIcons['reviewmanage']} 评审管理|reviewmanage|board|"; //20220712 增加
...
$lang->mainNav->menuOrder[22] = 'execution';
$lang->mainNav->menuOrder[21] = 'reviewmanage'; //20220712 增加
$lang->mainNav->menuOrder[24] = 'qa';
$lang->mainNav->menuOrder[26] = 'devops';
$lang->mainNav->menuOrder[31] = 'doc';
...
//$lang->my->menu->byme       = array('link' => "{$lang->my->byme}|my|byme|mode=bymeaudit"); //20220712 删除
...
$lang->my->menu->authorization   = array('link' => "$lang->authorization|my|authorization|");
...
//$lang->my->menuOrder[40] = 'byme'; //20220712 删除
...
$lang->my->menu->work['subMenu']->bug      = "实验室缺陷|my|work|mode=bug";
...
//20220712 删除
/*$lang->my->menu->byme['subMenu'] = new stdclass();
$lang->my->menu->byme['subMenu']->bymeaudit     = "{$lang->bymeaudit->common}|my|byme|mode=bymeaudit";

$lang->my->menu->byme['menuOrder'][5]  = 'bymeaudit';*/
...
$lang->product->menu->plan        = array('link' => "{$lang->productplan->menuCommon}|productplan|browse|productID=%s", 'subModule' => 'productplan');
...
$lang->scrum->menu->settings  = array('link' => "$lang->settings|project|view|project=%s", 'subModule' => 'stakeholder', 'alias' => 'edit,manageproducts,manageproductplans,group,managemembers,manageview,managepriv,whitelist,addwhitelist');
...
//$lang->scrum->menu->settings['subMenu']->productplans    = array('link' => "计划|project|manageProductplans|project=%s", 'alias' => 'manageproductplans');
...
$lang->execution->menu->settings = array('link' => "$lang->settings|execution|view|executionID=%s", 'subModule' => 'personnel', 'alias' => 'edit,manageproducts,manageproductplans,team,whitelist,addwhitelist,managemembers', 'class' => 'dropdown dropdown-hover');
...
//$lang->execution->menu->settings['subMenu']->productplans  = array('link' => "计划|execution|manageproductplans|executionID=%s");
...
$lang->qa->menu->bug        = array('link' => "{$lang->defect}|bug|browse|applicationID=%s&productID=%s", 'subModule' => 'bug');
$lang->qa->menu->testcase   = array('link' => "{$lang->testcase->shortCommon}|testcase|browse|applicationID=%s&productID=%s", 'subModule' => 'testcase,story');
$lang->qa->menu->testsuite  = array('link' => "{$lang->testcase->testsuite}|testsuite|browse|applicationID=%s&productID=%s", 'subModule' => 'testsuite');
$lang->qa->menu->testtask   = array('link' => "{$lang->testtask->common}|testtask|browse|applicationID=%s&productID=%s", 'subModule' => 'testtask', 'alias' => 'view,edit,linkcase,cases,start,close,batchrun,groupcase,report,importunitresult');
$lang->qa->menu->report     = array('link' => "{$lang->testreport->common}|testreport|browse|applicationID=%s&productID=%s", 'subModule' => 'testreport');
$lang->qa->menu->defect     = array('link' => "{$lang->qzdefect}|defect|browse", 'subModule' => 'defect');
...
$lang->qa->dividerMenu = ',bug,testtask,defect,';
...
$lang->report->menu->system   = array('link' => "{$lang->app->common}|safetystatistics|browse", 'alias' => 'params');
$lang->report->menu->secondmonthreport   = array('link' => "月报|secondmonthreport|browse", 'alias' => 'params');
$lang->report->menu->secondmonthdata   = array('link' => "数据结转|secondmonthdata|problem", 'alias' => 'params');
...
$lang->report->menuOrder[30] = 'system';
$lang->report->menuOrder[35] = 'secondmonthreport';
$lang->report->menuOrder[40] = 'secondmonthdata';
...
$lang->admin->menu->system    = array('link' => "{$lang->admin->system}|backup|index", 'subModule' => 'cron,cronconfig,backup,action,admin,search', 'exclude' => 'admin-index,admin-xuanxuan,admin-register,admin-ztcompany');
...
$lang->admin->menu->system['subMenu']->cronconfig = array('link' => "{$lang->admin->cronconfig}|cronconfig|browse", 'subModule' => 'cronconfig');
...
$lang->navGroup->implementionplan  = 'project';
$lang->navGroup->newexecution      = 'project';
...
$lang->navGroup->secondmonthreport = 'report';
$lang->navGroup->secondmonthdata = 'report';
...
$lang->navGroup->cronconfig  = 'admin';
