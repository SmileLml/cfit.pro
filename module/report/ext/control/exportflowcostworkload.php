...
{
    public function exportFlowCostWorkload($projectID = 0, $param = '')
    {
        ...
        if($_POST)
        {
            ...
            $fields['reviewDays']               = $this->lang->review->reviewDays;
            $fields['preReviewDays']            = $this->lang->review->preReviewDays;
            ...
            foreach($reviewList as $reviewID => $info)
            {
                ...
                $data[$i]->reviewDays               = $info->reviewDays;
                $data[$i]->preReviewDays            = $info->preReviewDays;
        ...
        $this->view->fileName  = $project->name . '_' . $this->lang->report->reviewFlowCostWorkload;
