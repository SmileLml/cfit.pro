    ...
    <form method='post' target='hiddenwin' onsubmit='return checkLeft();'>
      <table class='table table-form'>
        ...
        <tr>
          ...
          <td class='w-p25-f'><div class='datepicker-wrapper datepicker-date'><?php echo html::input('realStarted', helper::isZeroDate($task->realStarted) ? trim(substr(helper::now(), 0, 11)) : $task->realStarted, "class='form-control form-date' data-picker-position='bottom-right'");?></div></td>
          <td></td>
        </tr>
        <tr class="hide">
        ...
        <tr>
          <th><?php echo $lang->task->planHour;?></th>
          <td>
            <div class='input-group'>
              <?php echo html::input('estimate', '', "class='form-control'");?> <span class='input-group-addon'><?php echo $lang->task->hour;?></span>
            </div>
          </td>
        </tr>
        <tr class="hidden">
          ...
          <td>
            <div class='input-group'>
              <?php echo html::input('left', 1, "class='form-control'");?> <span class='input-group-addon'><?php echo $lang->task->hour;?></span>
            </div>
          </td>
        </tr>
        <tr class='hide'>
