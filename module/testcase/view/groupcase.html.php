...
<div class="main-table" data-ride="table" data-checkable="false" data-group="true">
  ...
  <div class="table-empty-tip">
    <p>
      ...
      <?php echo html::a($this->createLink('testcase', 'create', "applicationID=$applicationID&productID=$productID&branch=$branch&moduleID=$initModule"), "<i class='icon icon-plus'></i> " . $lang->testcase->create, '', "class='btn btn-info'");?>
      <?php endif;?>
    </p>
  </div>
  <?php else:?>
