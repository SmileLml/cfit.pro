...
$('#submit').click(function()
{
    ...
    var link = createLink('qareport', 'testcase', 'applicationID=' + applicationID + '&productID=' + productID + '&projectID=' + projectID);
    location.href = link;
...
$(function()
{
    var $link = $(<?php echo json_encode(html::a($this->createLink('report', 'reportExport', "type=testcase&params=". base64_encode("applicationID={$applicationID}&productID={$productID}&projectID={$projectID}")), $lang->export, '', "class='iframe btn btn-primary btn-sm'"));?>).modalTrigger({iframe:true, transition:'elastic'});
