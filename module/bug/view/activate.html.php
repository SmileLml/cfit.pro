...
<div id='mainContent' class='main-content'>
  <div class='center-block'>
    ...
    <form method='post' enctype='multipart/form-data' target='hiddenwin'>
      <input type="hidden" id="product" name="product" value="<?php echo $bug->product ?>">
      <table class='table table-form'>
        ...
        <tr>
          ...
          <td colspan='2'><?php echo html::select('openedBuild[]', $builds, $bug->openedBuild, 'size=4 multiple=multiple class="form-control chosen" onchange="loadProductLinkPlans()"');?></td>
        </tr>
        <tr>
          <th><?php echo $lang->bug->productplan;?></th>
          <td colspan='2' ><?php echo html::select('linkPlan[]', $linkPlan, $bug->linkPlan, "id='planIdBox' class='form-control chosen'  multiple=multiple $linkPlanDisabled");?></td>
        </tr>
        <tr>
