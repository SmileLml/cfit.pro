      ...
      <div class="col-sm-12">
        <div class="cell">
          ...
          <div class="detail">
            ...
            <div class="detail-content">
              <div class="row row-grid">
                ...
                <div class="col-xs-12">
                  <?php echo html::a($this->createLink('product', 'browse', "productID=$productID&branch=$product->branch"), "<i class='icon icon-product text-muted'></i> " . $product->code."_".$product->name . $branchName);?>
                </div>
                <?php endforeach;?>
              </div>
            </div>
          ...
          <div class="detail">
            ...
            <div class="detail">
                <div class="detail-title"><strong><?php echo $lang->project->test;?></strong></div>
                <div class="detail-content">
                    <table class="table table-data data-basic">
                        <tbody>
                        <tr>
                            <th class='w-120px'><?php echo $lang->project->isSafetyTest;?></th>
                            <td>
                                <?php echo $project->isSafetyTest > 1 ? zget($lang->project->isSafetyTestList, $project->isSafetyTest): '';?>

                                <?php if(common::hasPriv('project','edit')): ?>
                                    <?php echo html::a($this->createLink('project', 'editProjectInfo', "projectId=$project->id&field=isSafetyTest", '', true), "<i class='icon-edit'></i>", '', "data-toggle='modal' data-type='iframe' class='btn iframe'");?>
                                <?php endif;?>
                            </td>

                            <th class='w-120px'><?php echo $lang->project->isPerformanceTest;?></th>
                            <td>
                                <?php echo $project->isPerformanceTest > 1 ? zget($lang->project->isPerformanceTestList, $project->isPerformanceTest): '';?>

                                <?php if(common::hasPriv('project','edit')): ?>
                                    <?php echo html::a($this->createLink('project', 'editProjectInfo', "projectId=$project->id&field=isPerformanceTest", '', true), "<i class='icon-edit'></i>", '', "data-toggle='modal' data-type='iframe' class='btn iframe'");?>
                                <?php endif;?>
                            </td>
                        </tr>
                        </tbody>
