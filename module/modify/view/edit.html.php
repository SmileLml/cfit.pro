...
<div id="mainContent" class="main-content fade">
    <div class="center-block">
        <div class="main-header">
            <h2><?php echo $lang->modify->edit;?></h2>
        </div>
        <form class="load-indicator main-form form-ajax" method='post' enctype='multipart/form-data' id='dataform' novalidate>
                    ...
                    <div class="panel-body">
                        <table class="table table-form">
                            ...
                            <tr>
                                ...
                                <?php if($testingrequest->disable || $productenroll->disable):?>
                            ...
                            <?php
                                ...
                                if($modify->abnormalCode != ''){$abnormalCodedisabled = 'disabled';}
                                ?>
                            <tr>
                                <th><?php echo $lang->modify->secondorderId;?></th>
                                <td><?php echo html::select('secondorderId[]', $secondorderList, $modify->secondorderId, "class='form-control chosen' multiple $abnormalCodedisabled");?></td>
                                ...
                                <td>
                                    <?php echo html::select('abnormalCode', $abnormalList,$modify->abnormalCode, "class='form-control chosen ' onchange='selectabnormalCode()'");?>
                                    <?php if($modify->abnormalCode!=''):?>
                                    <div class="abnormalTips" style="margin-top:3px;color:red"><?php echo $this->lang->modify->abnormalTips?></div>
                                    <?php endif;?>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <?php if($testingrequest->disable || $productenroll->disable):?>
                                    <td><?php echo html::select('problemId[]', $problemSelectList, $modify->problemId, "class='form-control chosen problemIdClass' disabled multiple $abnormalCodedisabled");?></td>
                                ...
                                <?php else:?>
                                    <td><?php echo html::select('problemId[]', [], [], "class='form-control chosen problemIdClass'  multiple $abnormalCodedisabled");?></td>
                                <?php endif;?>
                                <!--关联需求 -->
                                <th class='w-100px'><?php echo $lang->modify->demandId;?></th>
                                <td><?php echo html::select('demandId[]', [], [], "class='form-control chosen demandIdClass'  onchange='selectDemand()' multiple $abnormalCodedisabled");?></td>
                            </tr>
                            <tr>
                                <!--关联需求任务 -->
                    ...
                    <div class="panel-body">
                        <table class="table table-form">
                            ...
                            <!-- <tr class="app-only">
                                ...
                                <td colspan="3" class="required">
                                    <?php if(!empty($modify) && $modifycncc->disable):?>
                                        <?php echo html::select('app[]', $apps, !empty($modify)?$modify->app:'', "id='appOnly' class='form-control chosen' multiple disabled");?>
                                        <div class="hidden"><?php echo html::select('app[]', $apps, !empty($modify)?$modify->appOnly:'', "id='appOnly' class='form-control chosen ' multiple");?></div>
                                    <?php else:?>
                                        <?php echo html::select('app[]', $apps, !empty($modify)?$modify->app:'', "id='appOnly' class='form-control chosen' multiple");?>
                                    <?php endif;?>
                                </td>
                            </tr> -->
                            <tr>
            ...
            <table class="table table-form">
                ...
                <?php if($modify->jsreturn == '1'):?>
                    <tr>
                        <th class='w-100px'><?php echo $lang->modify->ROR;?></th>
                        <td colspan="3" class="required"><?php echo html::input('ROR', '', "placeholder='请简述本次修订内容' class='form-control' ");?></td>
                    </tr>
                <?php endif;?>
                <?php foreach($modify->RORList as $key => $line):?>
                    <tr>
                        <th class='w-100px'></th>
                ...
                <tr>
                    ...
                    <?php if(in_array($modify->status,$lang->modify->alloweditStatus)):?>
                        <input type="hidden" name="issubmit" value="<?php echo $modify->issubmit;?>">
                    ...
                    <?php else:?>
                        ...
                        <td class='form-actions text-center' colspan='4'><?php echo html::submitButton($lang->modify->submit) . html::backButton();?></td>
                    <?php endif;?>
                </tr>
                </tbody>
            </table>
...
<input type="hidden" value="<?php echo $modify->status?>" id="status">
<table class="hidden">
    <tbody id="lineDemo">
    <tr>
        <td></td>
