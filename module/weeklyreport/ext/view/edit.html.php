...
<div id='mainContent' class='main-content'>
    ...
    <div class='main-header'>
        <h2><?php echo $lang->weeklyreport->edit;?></h2>
    </div>
        ...
        <table class='table table-form'>
                    ...
                    foreach ($report->reportMedium as $key=>$reportMedium) {
                        ...
                        <div class='table-row addandremoveflag'>
                            ...
                            <div class='table-row hidden'>
                                <div class='table-col productCol mediumCol mulitLineID'>
                                    <div class='input-group w-p100'>
                                        <input class="nouseMediumID" type='input' value="<?php echo $reportMedium->id;?>" id="MediumID[<?php echo $key ?>]" name="MediumID[<?php echo $key ?>]" />
                                    </div>
                                </div>
                            </div>
                    ...
                    <?php
                        ...
                        <div class='table-row addandremoveflag'>
                            ...
                            <div class='table-row hidden'>
                                <div class='table-col productCol mediumCol mulitLineID'>
                                    <div class='input-group w-p100'>
                                        <input class="nouseMediumID" type='input' value="0" id="MediumID[0]" name="MediumID[0]" />
                                    </div>
                                </div>
                            </div>
                    ...
                    foreach ($report->reportOutmile as $reportOutmile){
                        ...
                        <div class='table-row addandremoveflag'>
                            <div class='table-row '>
                                ...
                                <div class='table-col ' style="width: 300px;">
                            ...
                            <div class='table-row hidden'>
                                <div class='table-col productCol outmileCol mulitLineID'>
                                    <div class='input-group w-p100'>
                                        <input class="nouseOutmileID" type='input' value="<?php echo $reportOutmile->id;?>" id="OutmileID[]" name="OutmileID[]" />
                                    </div>
                                </div>
                            </div>
                            <div class='table-col actionCol text-middle'>
                        ...
                        <div class='table-row addandremoveflag'>
                            ...
                            <div class='table-row hidden'>
                                <div class='table-col productCol outmileCol mulitLineID'>
                                    <div class='input-group w-p100'>
                                        <input class="nouseOutmileID" type='input' value="0" id="OutmileID[]" name="OutmileID[]" />
                                    </div>
                                </div>
                            </div>
                            <div class='table-col actionCol text-middle'>
                    ...
                    foreach ($report->reportInsidemile as $reportInsidemile){
                        ...
                        <div class='table-row  addandremoveflag'>
                            ...
                            <div class='table-row hidden'>
                                <div class='table-col productCol outmileCol mulitLineID'>
                                    <div class='input-group w-p100'>
                                        <input class="nouseInsidemileID" type='input' value="<?php echo $reportInsidemile->id;?>" id="InsidemileID[]" name="InsidemileID[]" />
                                    </div>
                                </div>
                            </div>
                    ...
                    <?php
                        ...
                        <div class='table-row  addandremoveflag'>
                            ...
                            <div class='table-row hidden'>
                                <div class='table-col productCol outmileCol mulitLineID'>
                                    <div class='input-group w-p100'>
                                        <input class="nouseInsidemileID" type='input' value="0" id="InsidemileID[]" name="InsidemileID[]" />
                                    </div>
                                </div>
                            </div>
                            <div class='table-col actionCol text-middle required'>
            ...
            <tr>
                <td colspan='5' class='text-center form-actions'>
                    ...
                    <?php echo html::linkButton('返回',$refer,$referjump,"data-app='platform'",'btn btn-wide');?>
                </td>
            </tr>
        </table>
    </form>
...
<script>
    ...
    var outmileNewRow;
    var outmileNRowNum = <?php echo count($report->reportOutmile);?>;
    ...
    function addInsideMileItem(obj)
    {
        ...
        $next.find('.nouseInsidemileID').val(0);
        $next.find('.form-date').datepicker();
    }
    ...
    function addMediumItem(obj)
    {
        ...
        //介质ID
        let MediumID = "MediumID["+mediumNRowNumCount+"]";
        $next.find('.nouseMediumID').attr("id",MediumID).attr("name",MediumID).attr("value",0);
