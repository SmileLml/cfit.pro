...
<div id="mainContent" class="main-content fade">
  <div class="center-block">
    <div class="main-header">
      <h2><?php echo $curPendingNode->nodeCode == 'deptsSign' ? zget($lang->projectplansh->submitnodeCodeDesc, $curPendingNode->nodeCode) : $lang->projectplan->review . ' - ' . zget($lang->projectplansh->submitnodeCodeDesc, $curPendingNode->nodeCode);?></h2>
    </div>
