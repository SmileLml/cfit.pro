    ...
    <div class='main-header'>
      ...
      <?php if(!$checkRes['result']):?>
          ...
          <!--
            ...
            -->
          <?php include '../../review/ext/view/reviewBaseLine.html.php';?>
            <?php else:?>
          <form class="load-indicator main-form form-ajax" method='post' enctype='multipart/form-data' id='dataform'>
              <table class='table table-form'>
                  ...
                  <?php elseif($review->status == $lang->review->statusList['archive']):?> <!--待归档-->
                      <?php include '../../review/ext/view/reviewArchive.html.php';?>
                  <?php else:?>
                      <tr>
...
<?php if($review->status == 'baseline'):?>
    <?php include '../../review/ext/view/reviewBaseLineHidden.html.php';?>
<?php elseif($review->status == 'archive'):?>
    <?php include '../../review/ext/view/reviewArchiveHidden.html.php';?>
<?php endif;?>
