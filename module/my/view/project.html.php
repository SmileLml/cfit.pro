    ...
    <table class='table table-fixed' id='projectList'>
      <thead>
        <tr>
          ...
          <th class='c-mark w-120px'><?php echo $lang->project->code;?></th>
          <?php if($status == 'openedbyme'):?>
          <th class='w-120px'> <?php echo $lang->project->status;?></th>
          <?php endif;?>
          <th class='w-120px'><?php echo $lang->project->begin;?></th>
          <th class='w-120px'><?php echo $lang->project->end;?></th>
          <th class='text-right w-120px'><?php echo $lang->project->budget;?></th>
      ...
      <tbody id='projectTableList'>
        ...
        <tr>
          ...
          <td class='c-name text-left' title='<?php echo $project->name?>'>
            ...
            <td class='c-mark '> <?php echo $project->mark?></td>
          <?php if($status == 'openedbyme'):?>
