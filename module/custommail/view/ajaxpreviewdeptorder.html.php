    ...
    <td style='padding: 10px; border: none;'>
        <table cellpadding='0' cellspacing='0' style='width: 100%; border: 1px solid #e5e5e5; margin-bottom: 15px; border-collapse: collapse; font-size: 13px; text-align: left;'>
            <tr>
                ...
                <td style='padding: 5px; border: 1px solid #e5e5e5;'><?php echo 6688;?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="padding-left:7px;border:1px solid #e5e5e5;" class="textOVerThree" ><?php echo '待分析';?></td>
            </tr>
            <tr>
                ...
                <td style="padding-left:7px;border:1px solid #e5e5e5;" class="textOVerThree" ><?php echo 'admin';?></td>
            </tr>
            <tr>
                ...
                <td style="padding-left:7px;border:1px solid #e5e5e5;" class="textOVerThree" ><?php echo '这是一个预览摘要。';?></td>
            </tr>
            <tr>
                ...
                <td style='padding: 5px; border: 1px solid #e5e5e5;'><?php echo '2023-04-01';?></td>
            </tr>
        </table>
    </td>
</tr>
