...
<div id="mainContent" class="main-content">
  <div class="main-header">
    <h2><?php echo $lang->requirementinside->import;?></h2>
  </div>
...
<div id="mainContent" class="main-content">
  ...
  <form class='main-form' target='hiddenwin' method='post' style='overflow-x:auto'>
    <table class='table table-form' id='showData'>
      <thead>
        <tr>
          <th class='w-60px'><?php echo $lang->requirementinside->id?></th>
          <th class='w-200px required'><?php echo $lang->requirementinside->name?></th>
          <th class='w-200px required'><?php echo $lang->requirementinside->opinionID?></th>
          <!-- <th class='w-150px required'><?php echo $lang->requirementinside->deadLine?></th> -->
          <th class='w-200px required'><?php echo $lang->requirementinside->desc?></th>
          <th class='w-120px required'><?php echo $lang->requirementinside->app;?></th>
          <th class='w-120px required'><?php echo $lang->requirementinside->status;?></th>
          <th class='w-120px'><?php echo $lang->requirementinside->onlineTimeByDemand;?></th>
          <th class='w-100px required'><?php echo $lang->requirementinside->createdBy?></th>
          <th class='w-100px required'><?php echo $lang->requirementinside->projectManager?></th>
          <th class='w-150px'><?php echo $lang->requirementinside->dealUser?></th>
          <th class='w-200px'><?php echo $lang->requirementinside->comment;?></th>
          <th class='w-140px required'><?php echo $lang->requirementinside->consumed;?></th>
        </tr>
      </thead>
      <tbody>
        <?php
        ...
        <tr class='text-top'>
          <td>
            ...
            {
                echo $addID++ . " <sub style='vertical-align:sub;color:gray'>{$lang->requirementinside->new}</sub>";
            }
            ?>
          </td>
