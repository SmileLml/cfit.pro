...
<div id='mainMenu' class='clearfix'>
  ...
  <div class="btn-toolbar pull-right" id='createActionMenu'>
    ...
    $link = $this->createLink('domain', 'create');
  ...
  <table class='table has-sort-head' id='domainList'>
    <thead>
      ...
      <tr>
        ...
        <th class='w-90px'><?php common::printOrderLink('expireDate',  $orderBy, $vars, $lang->domain->expiredDate);?></th>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td title='<?php echo $domain->domain?>'><?php echo html::a($this->inlink('view', "id=$domain->id", 'html', true), $domain->domain, '', "class='iframe'");?></td>
        ...
        <td class='c-actions'>
          <?php
            common::printLink('domain','edit', "id={$domain->id}", "<i class='icon-common-edit icon-edit'> </i>", '', "data-toggle='modal' class='btn'");
