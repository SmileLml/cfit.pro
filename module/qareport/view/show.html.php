    ...
    <div class='cell'>
      <div class='panel'>
        <div class="panel-heading">
          ...
          <?php if(common::hasPriv('qareport', 'crystalExport')):?>
          <nav class="panel-actions btn-toolbar">
            <?php echo html::a($this->createLink('qareport', 'crystalExport', "step=$step&reportID=$reportID"), $lang->export, '', "data-width='600' class='export btn btn-primary btn-sm'")?>
          </nav>
          <?php endif;?>
        </div>
