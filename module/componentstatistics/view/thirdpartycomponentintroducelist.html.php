          ...
          <div class="with-padding">
              <form method='post'>
                  <div class="table-row" id='conditions'>
                      <div class='w-140px col-md-2 col-sm-2' >
                          <div style="line-height:24px;"><?php echo $lang->componentstatistics->componentIntroduceApplyTime;?>: </div>
                      </div>
                      <?php
      ...
      <div class='panel'>
        <div class="panel-heading">
          ...
          <nav class="panel-actions btn-toolbar">
            <?php if(common::hasPriv('componentstatistics', 'exportThirdpartyComponentIntroduceList')) echo html::a(inLink('exportThirdpartyComponentIntroduceList'), $lang->export, '', 'class="iframe btn btn-primary btn-sm"');?>
          </nav>
        </div>
        <div data-ride='table'>
            ...
            <thead>
              <tr class='text-center'>
                ...
                <th class='sort-disabled'><?php
                        ...
                        echo $lang->componentstatistics->examineVerdict;
            ...
            <tbody>
              ...
              <tr class="text-center">
                ...
                <td><?php
                        ...
                        echo zget($lang->componentstatistics->thirdcolumnkeylable,$key);
