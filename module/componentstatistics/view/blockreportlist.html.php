...
<div class="cell">
  <div class='panel'>
    <div class='panel-heading'>
      <div class='panel-title'><?php echo $lang->componentstatistics->name;?></div>
    </div>
    <div class='panel-body'>
      <div class='list-group'>
        <?php

        ksort($lang->componentstatistics->submenu->lists);
        foreach($lang->componentstatistics->submenu->lists as $list)
        {
            $list .= '|';
