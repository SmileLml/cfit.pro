...
$lang->risk->preventionAndremedy        = '风险应对措施';
$lang->risk->assignedToFrameWork = '指派架构部人员';
$lang->risk->assignedToFrameWorkDate = '指派架构部人员日期';
$lang->risk->assignToFrameWorkTitle   = '指派架构部项目风险';
/* Actions */
...
$lang->risk->action = new stdClass();
$lang->risk->action->assignedtoframeworked         = array('main' => '$date, 由 <strong>$actor</strong> 指派架构部人员<strong>$extra</strong>。');