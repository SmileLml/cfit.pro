   ...
   <!-- <?php /*if(!empty($task->team) && $task->assignedTo != $this->app->user->account):*/?>
    ...
    <form method='post' enctype='multipart/form-data' target='hiddenwin'>
      <table class='table table-form'>
        <tr <?php echo $source ? "class = 'hidden'"  :''?>>
        ...
        <tr <?php echo $source ? "class = 'hidden'"  :''?>>
          ...
          <td>
            <div class='input-group'><?php echo html::input('currentConsumed', '0.0', "class='form-control' readonly");?> <span class='input-group-addon'><?php echo $lang->task->hour;?></span></div>
          </td>
        </tr>
        <tr>
       ...
       <!-- <tr <?php /*echo $source ? "class = 'hidden'"  :''*/?>>
        ...
        <tr>
          ...
          <td><div class='datepicker-wrapper'><?php echo html::input('realStarted', $task->realStarted != '0000-00-00 00:00:00' ? substr($task->realStarted, 0, 11) : '', "class='form-control form-date' readonly='readonly'");?></div></td><td></td>
        </tr>
        <tr>
          <th><?php echo $lang->task->finishedDate;?></th>
          <td><div class='datepicker-wrapper'><?php echo html::input('finishedDate', $beginAndEnd->flag ? $beginAndEnd->end :  helper::today(), "class='form-control form-date' readonly='readonly'");?></div></td><td></td>
        </tr>
        <tr class='hide'>
...
<script>
    $(function()
    {
        ...
        //$(".form-date").eq(1).datetimepicker('setStartDate', '<?php echo $beginAndEnd->begin ?>');
        /*结束时间*/
        $(".form-date").datetimepicker(
