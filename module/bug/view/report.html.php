...
<?php $browseLink = $app->session->bugList ? $app->session->bugList : $this->createLink('bug', 'browse', "applicationID=$applicationID&productID=$productID&branch=0&browseType=$browseType&moduleID=$moduleID");?>
