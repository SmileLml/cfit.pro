      ...
      <div class='panel'>
        ...
        <div data-ride='table' class='scroll-table'>
          <table class='table table-condensed table-striped table-bordered table-fixed no-margin' id='programList'>
            ...
            <tbody>
              <tr>
                <td class='text-left'><?php echo $lang->report->titleList['staff'];?></td>
                <?php foreach($stages as $stage):?>
             ...
             <tr>
                <td class='text-left'><?php echo $lang->report->titleList['pv'];?></td>
                <?php foreach($stages as $stage):?>
             ...
             <tr>
                <td class='text-left'><?php echo $lang->report->titleList['ev'];?></td>
                <?php foreach($stages as $stage):?>
             ...
             <tr>
                <td class='text-left'><?php echo $lang->report->titleList['dv'];?></td>
                <?php foreach($stages as $stage):?>
             ...
             <tr>
                <td class='text-left'><?php echo $lang->report->titleList['dvrate'];?></td>
                <?php foreach($stages as $stage):?>
                <?php $pv = zget($pvList, $stage->id, 0);?>
                <?php $ev = zget($evList, $stage->id, 0);?>
                <td>
