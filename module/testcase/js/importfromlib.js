...
{
    link = createLink('testcase', 'importFromLib', 'applicationID=' + applicationID + '&productID=' + productID + '&projectID=' + projectID + '&branch=' + branch + '&moduleID=' + moduleID + '&libID='+libID);
    location.href = link;
}
