  ...
  <div class='side-col col-3'>
    <div class='panel panel-sm'>
      ...
      <div class='panel-body'>
        <form method='post' action='<?php echo $this->createLink($module, 'report');?>'>
          <?php echo html::checkBox('reports', $reportPairs, $checkedReports, '', 'block');?>
          <p><?php echo html::selectAll() . baseHTML::submitButton($lang->report->create);?></p>
        </form>
      </div>
    </div>
  </div>
  <div class='main-col col-9'>
    <div class='panel panel-sm'>
      <div class='panel-heading'>
        ...
        <span class='text-warning'><?php echo $lang->report->tip;?></span>
      </div>
