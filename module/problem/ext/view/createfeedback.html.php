...
<?php js::set('IfultimateSolutionSelect', html::select('IfultimateSolution', $this->lang->problem->ifultimateSolutionList, $problem->IfultimateSolution, "onchange='ifultimateChanged(this.value)' class='form-control chosen' ")); ?>
<?php js::set('dateStr', date('Y-m-d')); ?>
<?php js::set('dateTimeStr', date('Y-m-d H:i:s')); ?>
...
<?php js::set('problemGradeItem', html::select('problemGrade', $lang->problem->problemGradeList, $problem->problemGrade, " class='form-control chosen' ")); ?>
<style>
    .tooltip-diy {
        position: relative;
            ...
            <table class="table table-form">
                <?php if ($problem->createdBy != 'guestjx'): ?>
                    ...
                    <tr>
                        ...
                        <!--问题分级-->
                        <th><?php echo $lang->problem->problemGrade; ?><i class="icon icon-help tooltip-diy"><span class="tooltip-text"><?php echo $lang->problem->problemGradePrompt; ?></span></i></th>
                    ...
                    <tr id='solutionFeedbackTip' class="<?php if (5 != $problem->SolutionFeedback) echo 'hide'; ?>">
                        <th></th>
                        <td colspan='2' style="color:#F00010;"><?php echo $this->lang->problem->solutionFeedbackTip;?></td>
                    </tr>
                    <tr>
                        <!--是否为最终方案-下拉选择框-->
                        ...
                        <!--是否基准验证-->
                        <th id='standardVerifyId'><?php echo $lang->problem->standardVerify; ?></th>
                    ...
                    <tr>
                        ...
                        <td colspan='3'
                            class='required'><?php echo html::input('CorresProduct', $problem->CorresProduct, "class='form-control'"); ?></td>
                    </tr>
                    <!--问题退回原因-富文本-->
                    <tr class="hide">
                ...
                <?php else: ?>
                    ...
                    <tr class="notUltimate notReturn">
                        ...
                        <td colspan='3' class='required'
                            id="ultimateSolutionTd"><?php echo html::textarea('solution', $problem->solution, "class='form-control' 
                            maxlength='2000' rows ='3'"); ?></td>
                    </tr>
                    <!--发生原因-富文本-->
                    <tr class="notUltimate notReturn">
                    ...
                    <tr>
                        ...
                        <th><?php echo $lang->problem->TeleOfIssueHandler; ?></th>
                        <td class='required'
                            colspan='3'><?php echo html::input('TeleOfIssueHandler', $problem->TeleOfIssueHandler, "class='form-control' maxlength='20'"); ?></td>
                    </tr>
                <?php endif; ?>
                <tr>
                ...
                <tr><td class='form-actions text-center' colspan='4'><?php echo html::submitButton() . html::backButton(); ?></td></tr>
                </tbody>
            </table>
        </form>
    </div>
