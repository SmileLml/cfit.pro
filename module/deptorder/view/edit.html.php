...
<div id="mainContent" class="main-content fade">
  <div class="center-block">
    <div class="main-header">
      <h2><?php echo $lang->deptorder->edit;?></h2>
    </div>
          ...
          <tr>
              ...
              <td>
                  <div class='input-group'>
                      ...
                      <?php echo html::select('ccList[]', $users, $deptorder->ccList, "class='form-control chosen'multiple");?>
                  </div>
              </td>
          </tr>
          <tr>
              <th><?php echo $lang->deptorder->filelist;?></th>
              ...
              <td>
                  <div class='detail'>
                      <div class='detail-content article-content'>
                          <?php
                          if($deptorder->files){
                              echo $this->fetch('file', 'printFiles', array('files' => $deptorder->files, 'fieldset' => 'false', 'object' => null, 'canOperate' => true, 'isAjaxDel' => true));
                          }else{
