...
$(function()
{
    $.get(createLink('project', 'ajaxGetMaintenance',"user="+ maintenanceStaff+"&bearDept="+bearDept ), function(data)
    {
        $('#maintenanceStaff_chosen').remove();
        $('#maintenanceStaff').replaceWith(data);
        $('#maintenanceStaff').chosen();
    });
})