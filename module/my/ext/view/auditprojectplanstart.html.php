          ...
          <tbody>
            ...
            <tr>
              ...
              <td title=<?php echo $plan->outsides;?> class='text-ellipsis'><?php echo $plan->outsides;?></td>
                ...
                <td class='c-actions'>
                    <?php
                    common::printIcon('projectplan', 'initProject', "projectplanID=$plan->id&creationID=$plan->creationID", $plan, 'list', 'file-text',"_blank");
...
//                                        echo "<button type='button' class='disabled btn' title='".$this->lang->projectplan->submit."' style='pointer-events: unset;'><i class='icon-common-start disabled icon-start'></i></button>\n";
                            common::printIcon('projectplan', 'planChange', "id=$plan->id", $plan, 'list', 'feedback', '_blank', '', '', $lang->projectplan->planChange);
                        } else {
                    ...
                    common::printIcon('projectplan', 'execEdit', "id=$plan->id", $plan, 'list','change','_blank','','','',$lang->projectplan->execEdit);
