...
<div id="mainContent" class="main-content fade">
    <div class="center-block">
        <div class="main-header">
            <h2><?php echo $lang->demand->copytable; ?></h2>
        </div>
        <form class="load-indicator main-form form-ajax" method='post' enctype='multipart/form-data' id='dataform'>
            <table class="table table-form">
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <div style="color:red"><span> <?php echo $lang->demand->projectrelatedemand ?></span></div>
                    </td>
                </tr>
                <tr>
                    <th class='w-180px'><?php echo $lang->demand->opinionID; ?></th>
                    <td>
                        <?php echo html::select('opinionID', $opinions, $demand->opinionID, "class='form-control chosen' onchange='opinionChange(this.value)'"); ?>
                    </td>
                    <td>
                        <div class='input-group'>
                            <span class='input-group-addon'><?php echo $lang->demand->requirementID; ?></span>
                            <?php echo html::select('requirementID', '', $demand->requirementID, "class='form-control chosen' onchange='requirementChange(this.value)'"); ?>
                        </div>
                    </td>
                </tr>
                <tr>
...
<script>
    ...
    function opinionChange(opinionID,flag = false)
    {
        $.get(createLink('demand', 'ajaxGetRequirementCopy', "opinionID=" + opinionID + "&requirementID="+<?php echo $demand->requirementID; ?>), function (requirement) {
