...
$config->action->objectNameFields['outwarddelivery']   = 'code';
$config->action->objectNameFields['copyright']   = 'code';
$config->action->objectNameFields['copyrightqz'] = 'code';
$config->action->objectNameFields['change']        = 'code';
$config->action->objectNameFields['closingitem']   = 'projectId';
$config->action->objectNameFields['closingadvise'] = 'projectId';
$config->action->objectNameFields['review']        = 'title';
$config->action->objectNameFields['osspchange']    = 'code';
$config->action->objectNameFields['credit']   = 'code';
$config->action->objectNameFields['localesupport'] = 'id';
$config->action->objectNameFields['authorityapply'] = 'id';
$config->action->objectNameFields['qualitygate'] = 'code';
