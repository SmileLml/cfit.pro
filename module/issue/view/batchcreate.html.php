...
<div id = "mainContent" class="main-content fade in">
  <div class="main-header">
    <h2>
        <?php echo $lang->issue->batchCreate;?>
        <small>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo  $lang->issue->batchCreatetTips ;?></small>
    </h2>
  </div>
    ...
    <table class="table table-form">
      <thead>
        <tr class="text-center">
          ...
          <th class="w-140px required"><?php echo $lang->issue->owner;?></th>
          ...
          <th class="w-100px required"><?php echo $lang->issue->pri;?></th>
      ...
      <tbody>
        ...
        <tr data-key="<?php echo $i;?>">
          ...
          <td><?php echo html::select("dataList[$i][owner][]", $users, $this->app->user->account, 'class="form-control chosen" id="dataList' . $i . 'owner" multiple')?></td>
          ...
          <td><?php echo html::select("dataList[$i][assignedTo]", $assignUsers, '', 'class="form-control chosen" id="dataList' . $i . 'assignedTo"')?></td>
       </tr>
        <?php endfor;?>
      </tbody>
    </table>
