            ...
            <div class='detail-title'><?php echo $lang->kanbancard->legendBasicInfo;?></div>
              <table class="table table-form">
                  <tr>
                      ...
                      <td>
                          <?php echo html::select('type', $type, $card->type, "class='form-control chosen'");?>
                      </td>
                  </tr>
                <tr>
                ...
                <tr>
                  ...
                  <tr>
                      ...
                      <td>
                          <div class='input-group'>
                              <?php echo html::input('consumed', $card->consumed, "class='form-control' disabled ");?>
                              <span class='input-group-addon'>h</span>
                          </div>
                      </td>
                  </tr>
                ...
                <tr>
                  ...
                  <td>
                    <div class='input-group'>
                      <?php echo html::input('progress', $card->progress, "class='form-control' disabled ");?>
