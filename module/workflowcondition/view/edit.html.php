...
<form id='editConditionForm' class='conditionForm' method='post' action='<?php echo inlink('edit', "action=$action->id&key=$key");?>'>
  ...
  <table class='table table-form' id='conditionTable'>
    ...
    <tr class='dataTR' data-key='<?php echo $key;?>'>
      ...
      <td><?php echo html::select("operator[$key]", $config->workflowcondition->operatorList, $field->operator, "class='form-control'");?></td>
      <td id='paramTD'>
    ...
    <tr class='dataTR' data-key='<?php echo $key;?>'>
      ...
      <td><?php echo html::select("operator[$key]", $config->workflowcondition->operatorList, '', "class='form-control'");?></td>
...
$operator      = html::select("operator[KEY]", $config->workflowcondition->operatorList, '', "class='form-control'");
