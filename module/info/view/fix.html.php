...
<div id="mainMenu" class="clearfix">
  <div class="btn-toolbar pull-left">
    ...
    foreach($lang->info->labelList as $label => $labelName)
    {
        ...
        echo html::a($this->createLink('info', 'fix', "browseType=$label&param=0&orderBy=$orderBy&recTotal={$pager->recTotal}&recPerPage={$pager->recPerPage}"), '<span class="text">' . $labelName . '</span>', '', "class='btn btn-link $active'");
    }
    ?>
  ...
  <div class="btn-toolbar pull-right">
    <div class='btn-group'>
      ...
      $link  = common::hasPriv('info', 'export') ? $this->createLink('info', 'export', "action=fix&orderBy=$orderBy&browseType=$browseType") : '#';
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class='c-actions text-center'>
              ...
              // common::printIcon('info', 'copy', "infoID=$info->id&action=fix", $info, 'list');
