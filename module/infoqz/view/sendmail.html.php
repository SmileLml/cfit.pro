  ...
  <td style='padding: 10px; border: none;'>
    <table cellpadding='0' cellspacing='0' style='width: 100%; border: 1px solid #e5e5e5; margin-bottom: 15px; border-collapse: collapse; font-size: 13px; text-align: left;'>
        ...
        <tr>
            ...
            <td style="padding:7px;border:1px solid #e5e5e5;" >
                <?php
                $detailsURL = zget($this->config->mail, 'domain', common::getSysURL()) . helper::createLink('infoqz', 'view', "id=$info->id", 'html');
                echo html::a($detailsURL, $info->code, '', 'style="color:blue;"');
                ?>
            </td>
        </tr>
        ...
        <tr >
            ...
            <td style="width:490px;padding:7px;border:1px solid #e5e5e5;" class="textOVerThree" ><?php echo $info->desc;?></td>
        </tr>
        ...
        <tr >
            ...
            <td style="padding:7px;border:1px solid #e5e5e5;" ><?php echo $info->dealUsersStr;?></td>
        </tr>
        ...
        <?php if($isShowExternalStatus):?>
            <tr >
                ...
                <td style="padding:7px;border:1px solid #e5e5e5;" ><?php echo $info->externalStatusDesc;?></td>
            </tr>
            ...
            <tr >
                ...
                <td style="padding:7px;border:1px solid #e5e5e5;" ><?php echo $info->externalRejectReason;?></td>
            </tr>
