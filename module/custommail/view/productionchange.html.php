...
<div id='mainContent' class="main-row">
    ...
    <div class="main-col main-content">
        <div class="main-header">
            <div class="heading">
                <strong><?php echo $lang->custommail->common;?><i class="icon-angle-right"></i><?php echo $lang->custommail->issue;?></strong>
            </div>
        </div>
            ...
            <table class="table table-form">
                ...
                <tr>
                    ...
                    <td class='text-left form-actions'>
                        ...
                        <?php echo html::commonButton($lang->custommail->preview, 'data-type="ajax" data-title="' . $lang->custommail->preview . '" data-remote="' . $this->createLink('custommail', 'ajaxPreview', 'browseType=issue') . '" data-toggle="modal"', 'btn btn-wide btn-info triggerButton');?>
                    </td>
                </tr>
            </table>
        </form>
