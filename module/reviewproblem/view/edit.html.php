...
<div id="mainContent" class="main-content fade">
    <div class="center-block">
        <div class="main-header">
            <h2><?php echo $lang->reviewproblem->edit; ?></h2>
        </div>
        <form class="load-indicator main-form form-ajax" method="post" enctype="multipart/form-data" id="dataform">
            <table class="table table-form">
                <tbody>
                <tr>
                    <th class="w-120px"><?php echo $lang->reviewproblem->review; ?></th>
                    <td><?php echo html::select('review', $reviewPairs, $issue->review, 'class="form-control chosen"'); ?></td>
                    <td></td>
                </tr>
                <tr>
                    <th><?php echo $lang->reviewproblem->type; ?></th>
                    <td><?php echo html::select('type', $this->lang->reviewproblem->typeList, $issue->type, 'class="form-control chosen"'); ?></td>
                    <td></td>
                </tr>

                <tr>
                    <th><?php echo $lang->reviewproblem->raiseBy; ?></th>
                    <td><?php echo html::select('raiseBy', $users, $issue->raiseBy, 'class="form-control chosen"'); ?></td>
                    <td></td>
                </tr>

                <tr>
                    <th><?php echo $lang->reviewproblem->raiseDate; ?></th>
...
<!--                    <td>--><?php //echo html::select('status', $lang->reviewproblem->statusList, $issue->status, 'class="form-control chosen"'); ?><!--</td>-->
<!--                    <td></td>-->
<!--                </tr>-->
                <tr>
                    <th><?php echo $lang->reviewproblem->resolutionBy; ?></th>
                    <td><?php echo html::select('resolutionBy', $users, $issue->resolutionBy, 'class="form-control chosen"'); ?></td>
                    <td></td>
                </tr>
                <tr>
                    <th><?php echo $lang->reviewproblem->validation; ?></th>
