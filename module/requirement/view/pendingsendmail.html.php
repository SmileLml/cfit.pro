...
<tr>
    <td>
        <table cellpadding='0' cellspacing='0' width='600' style='border: none; border-collapse: collapse;'>
            <tr>
                <td style='padding: 10px; background-color: #F8FAFE; border: none; font-size: 14px; font-weight: 500; border-bottom: 1px solid #e5e5e5;'><?php echo $this->lang->requirement->deleteMaile;?></td>
            </tr>
        </table>
    </td>
</tr>
<tr>
    <td style='padding-top: 20px; border: none;'>
        <p style='font-size: 18px;font-weight: 500;padding-left:15px;'><?php echo $this->lang->requirement->tipmail;?></p>
    </td>
</tr>
<tr>
    <td style='padding: 10px; border: none;'>
        <table cellpadding='0' cellspacing='0' style='width: 100%; border: 1px solid #e5e5e5; margin-bottom: 15px; border-collapse: collapse; font-size: 13px; text-align: left;'>
            ...
            <tr>
                <th style='width: 100px; border: 1px solid #e5e5e5; background-color: #f5f5f5; padding: 5px;'><?php echo $this->lang->requirement->name; ?></th>
                <td style='padding: 5px; border: 1px solid #e5e5e5;'><?php echo $requirement->name;?></td>
            </tr>
            <tr>
                <th style='width: 100px; border: 1px solid #e5e5e5; background-color: #f5f5f5; padding: 5px;'><?php echo $this->lang->custommail->desc; ?></th>
                <td style='padding: 5px; border: 1px solid #e5e5e5;'><?php echo $requirement->desc;?></td>
            </tr>
        </table>
    </td>
</tr>
