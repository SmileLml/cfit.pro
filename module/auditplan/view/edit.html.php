      ...
      <table class="table table-form">
        <tbody>
          ...
          <tr>
            ...
            <td><?php echo html::input('checkDate', $auditplan->checkDate, "class='form-control form-date'");?></td>
            <td></td>
            <td></td>
          </tr>
          <tr>
...
{
    var link = createLink('auditplan', 'ajaxGetActivity', "projectID=<?php echo $auditplan->project;?>&processID=" + processID);
