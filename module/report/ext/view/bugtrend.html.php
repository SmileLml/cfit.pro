  ...
  <div class='main-col'>
    <div class='cell'>
      <div class="with-padding">
        <form action='<?php echo $this->createLink('report', 'bugtrend', "queryType=search");?>' method='post' id='bugtrendForm'>
          ...
          <div class="table-row" id='conditions'>
            ...
            <div class='form-row' style="text-align: center;">
              ...
              <?php echo html::commonButton($lang->crystal->query, 'onClick="showLoadingElement()" id="submit"', 'btn btn-primary');?>
