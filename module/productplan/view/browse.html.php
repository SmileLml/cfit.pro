  ...
  <div class="btn-toolbar pull-right">
      <div class='btn-group'>
          ...
          <ul class="dropdown-menu" id='exportActionMenu'>
              <?php
              $class = common::hasPriv('productplan', 'export') ? '' : "class=disabled";
              $misc  = common::hasPriv('productplan', 'export') ? "data-toggle='modal' data-type='iframe' class='export'" : "class=disabled";
              $link  = common::hasPriv('productplan', 'export') ? $this->createLink('productplan', 'export', "productID=$productID&branch=$branch&browseType=$browseType&orderBy=$orderBy") : '#';
              echo "<li $class>" . html::a($link, $lang->productplan->export, '', $misc) . "</li>";
              ?>
          </ul>
      </div>
