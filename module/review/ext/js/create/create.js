...
// 初始化qa、專家、參與人員評審選擇框與評審主席、專員一致
$.get(createLink('review', 'ajaxGetCommonList', "id="+'qa'), function(data)
{
    $('#qa_chosen').remove();
    $('#qa').replaceWith(data);
    $('#qa').chosen();
...
$.get(createLink('review', 'ajaxGetCommonList', "id="+'expert'), function(data)
{
    $('#expert_chosen').remove();
    $('#expert').replaceWith(data);
    $('#expert').chosen();
...
/*$.get(createLink('review', 'ajaxGetCommonList', "id="+'reviewedBy'), function(data)
{
