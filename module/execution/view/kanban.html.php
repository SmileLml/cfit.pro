...
<?php $projectClosed = $project->status == 'closed';?>
<div id='mainMenu' class='clearfix'>
  <div class='btn-toolbar pull-right'>
    ...
    ?>
    <?php if($canBeChanged and !$projectClosed):?>
    <div class='btn-group'>
...
<div id="kanban" class="main-table fade auto-fade-in" data-ride="table" data-checkable="false" data-group="true">
  ...
  <div class="table-empty-tip">
    <p>
      ...
      <?php if($canBeChanged and common::hasPriv('task', 'create', $checkObject) and !$projectClosed):?>
          ...
          <div class="boards-wrapper">
            <div class="boards">
              ...
              <div class="board" data-type="<?php echo $col;?>">
                ...
                <?php $disabled = (common::hasDBPriv($task, 'task') and !$projectClosed) ? '' : 'disabled';?>
                <div class='board-item <?php echo $disabled;?>' data-id='<?php echo $task->id?>' id='task-<?php echo $task->id?>' data-type='task'>
                  ...
                  <div class='info'>
                    ...
                    if(common::hasPriv('task', 'assignTo', $task) and !$projectClosed)
                    {
                ...
                <div class='board-item' data-id='<?php echo $bug->id?>' id='bug-<?php echo $bug->id?>' data-type='bug'>
                  ...
                  <div class='info'>
                    ...
                    if(common::hasPriv('bug', 'assignTo', $bug) and !$projectClosed)
                    {
