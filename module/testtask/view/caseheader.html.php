<div id='mainMenu' class='clearfix'>
  ...
  <div class='btn-toolbar pull-right'>
    <?php
    common::printIcon('testtask', 'linkBug', "taskID=$task->id", $task, 'button', 'link');
    common::printIcon('testtask', 'linkCase', "taskID=$task->id", $task, 'button', 'link');
    common::printIcon('testcase', 'export', "applicationID=$applicationID&productID=$productID&orderBy=`case`_desc&taskID=$task->id", '', 'button', '', '', 'export');
    common::printIcon('testtask', 'report', "applicationID=$applicationID&productID=$productID&taskID=$task->id&browseType=$browseType&branchID=0&moduleID=" . (empty($moduleID) ? '' : $moduleID));
