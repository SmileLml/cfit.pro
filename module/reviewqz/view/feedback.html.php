...
<div id="mainContent" class="main-content" style="height:600px;">
    <div class="center-block">
        <div class="main-header">
            <h2><?php echo $lang->reviewqz->feedbackQz;?></h2>
        </div>
            ...
            <table class="table table-form">
                ...
                <?php foreach($expertList as $key => $info):?>
                    <tr class="fields" style="height:60px;">
                        ...
                        <td><?php echo html::radio("status[$info->reviewer]", $lang->reviewqz->meetjoinList, $info->status);?></td>
                    </tr>
                <?php endforeach;?>
                <tr class="fields" style="height:60px;">
                ...
                <tr>
                    ...
                    <td colspan='2'>
                        <?php echo html::textarea('comment', '', "rows='4' class='form-control kindeditor' hidefocus='true' tabindex=''");?>
                    </td>
                </tr>
                <tr>
