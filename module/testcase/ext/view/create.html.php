    ...
    <form class='load-indicator main-form form-ajax' method='post' enctype='multipart/form-data' id='dataform' data-type='ajax'>
      <table class='table table-form'>
        <tbody>
          ...
          <tr>
            <th><?php echo $lang->testcase->applicationID;?></th>
            <td>
          ...
          <tr>
            <th>
              <?php echo $lang->testcase->project;?>
            </th>
            <td>
              <div class='table-row'>
                <div class='table-col' id='projectBox'>
                  <?php echo html::select('project', $projects, $projectID, "class='form-control chosen' onchange='getProjectExecutions(this.value)'");?>
                </div>
                <div class='table-col'>
                  <div class='input-group' id='executionIdBox'>
                    <span class='input-group-addon fix-border'><?php echo $lang->testcase->execution;?></span>
            ...
            <td style='padding-left: 15px;'>
              <div class='input-group' id='storyIdBox'>
                <span class='input-group-addon w-80px'><?php echo $lang->testcase->lblStory;?></span>
                <?php echo html::select('story', $stories, $storyID, 'class="form-control chosen"');?>
              </div>
            </td>
            <?php endif;?>
          </tr>
          ...
          <tr>
            ...
            <td colspan='2'><?php echo html::checkbox('categories', array_filter($lang->testcase->categoryList), $caseCategories);?></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td colspan='2'><?php echo html::textarea('intro', $intro, " rows='2' class='form-control'");?></td>
          </tr>
        </tbody>
        <tfoot>
          <tr>
