...
<div id="mainContent" class="main-content">
  <div class="center-block">
    <div class="main-header">
      <h2><?php echo $lang->newexecution->edit;?></h2>
    </div>
    <form class="load-indicator main-form form-ajax" id="createForm" method="post" target='hiddenwin'>
      <table class="table table-form">
        <tbody>
          <tr>
            <th><?php echo $lang->newexecution->name;?></th>
            <td><?php echo html::input('name', $execution->name, " readonly class='form-control input-product-title' required");?></td><td></td>
          </tr>
          <tr>
            <th><?php echo $lang->newexecution->code;?></th>
            <td><?php echo html::input('code', $execution->code, "class='form-control input-product-title'");?></td><td></td>
          </tr>
          <tr>
              <th><?php echo $lang->newexecution->begin;?></th>
              <td><?php echo html::input('begin', $execution->begin, "class='form-control form-date required'");?></td><td></td>
          </tr>
          <tr>
              <th><?php echo $lang->newexecution->end;?></th>
              <td><?php echo html::input('end', $execution->end, "class='form-control form-date required'");?></td><td></td>
          </tr>
          <tr>
          <tr>
            <th><?php echo $lang->newexecution->realBegan;?></th>
            <td><?php echo html::input('realBegan', $execution->realBegan, "class='form-control form-date required'");?></td><td></td>
          </tr>
          <tr>
            <th><?php echo $lang->newexecution->realEnd;?></th>
          ...
          <tr>
          <tr>
            <th><?php echo $lang->newexecution->desc;?></th>
            <td colspan='2'>
