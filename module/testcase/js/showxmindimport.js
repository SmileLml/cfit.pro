...
$(document).ready(function()
{
    ...
    $.get(createLink('testcase', 'ajaxGetXmindImport'),function(res)
    {
    ...
    $("#xmindmapSave").click(function(e)
    {
        ...
        $.post(createLink('testcase', 'saveXmindImport', 'applicationID=' + applicationID), data, function(res)
        {
            ...
            else
            {
                if(openApp == 'project')
                {
                    var params = "project=" + projectID + "&applicationID=" + applicationID + "&productID=" + productID;
                    window.location = createLink('project', 'testcase', params);
                }
                else
                {
                    var params = "applicationID=" + applicationID + "&productID=" + productID;
                    window.location = createLink('testcase', 'browse', params);
                }
            }
        });
    })
