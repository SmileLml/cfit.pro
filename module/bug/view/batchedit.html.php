...
<div id='mainContent' class='main-content fade'>
  ...
  ?>
  <form class='main-form' method='post' target='hiddenwin' action="<?php echo inLink('batchEdit', "applicationID=$applicationID&productID=$productID")?>" id='batchEditForm'>
      ...
      <table class='table table-form'>
        <thead>
          <tr>
            ...
            <th class='w-110px'><?php echo $lang->bug->childType;?></th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?php echo html::select("types[$bugID]", $typeList, $bug->type, "class='form-control' onchange='loadChildTypeList(this.value, $bugID)'");?></td>
            <td><?php echo html::select("childTypes[$bugID]", empty($parentChildTypeList[$bug->type]) ? array('' => '') : $parentChildTypeList[$bug->type], $bug->childType, 'class="form-control"');?></td>
            ...
            <td <?php echo zget($visibleFields, 'status', "class='hidden'")?>>
            <?php echo zget($statusList, $bug->status, '');?>
            <?php echo html::select("statuses[$bugID]", $statusList, $bug->status, 'class="form-control hidden"');?>
            </td>
