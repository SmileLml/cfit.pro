  ...
  <div class='center-block'>
    <div class='main-header'>
      <h2>
        ...
        <small><?php echo $lang->arrow . zget($lang->residentsupport->temDeptStatusLableList, $templateDeptInfo->status);?></small>
      </h2>
    </div>
      ...
      <?php else:?>
          <form class="load-indicator main-form form-ajax" method='post' enctype='multipart/form-data' id='dataform'>
              <table class='table table-form'>
                  <tr>
                      <th class='w-120px'><?php echo $lang->residentsupport->result;?></th>
                      <td class='w-p45-f'>
                          <?php echo html::select('result', $lang->residentsupport->reviewConclusionList, '', "class='form-control chosen' required");?>
                      </td>
                      <td></td>
                  </tr>

                  <tr>
                      <th><?php echo $lang->residentsupport->comment;?></th>
