  ...
  <div class='panel-body'>
    <div class='list-group'>
      ...
      foreach($lang->reportList->$submenu->lists as $list)
      {
          ...
          if(common::hasPriv($module, $method)) echo html::a($this->createLink($module, $method, $requestParams), '<i class="icon icon-file-text"></i> ' . $label, '', "class='$class' title='$label' data-app='{$this->app->openApp}'");
      }
      ?>
    </div>
  </div>
