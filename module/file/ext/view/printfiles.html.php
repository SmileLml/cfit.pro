    ...
    <ul class="files-list">
      ...
      foreach($files as $file)
      {
          if(common::hasPriv('file', 'download'))
          {
              ...
              if($objectType == 'projectcreation'){
                  $objectType = 'projectplan';
              }elseif($objectType == 'secondorderDeliver'){
                  $objectType = 'secondorder';
              }
              if($objectType == 'residentwork'){
                  $link = common::hasPriv($objectType, 'recordDutyLog', $object);
              }else{
                  $link = common::hasPriv($objectType, 'edit', $object);
              }
              if($canOperate && $link)
              {
