...
<?php $browseLink = $app->session->riskList ? $app->session->riskList : $this->createLink('risk', 'browse', "projectID={$risk->project}");?>
  ...
  <div class="main-col col-8">
    <div class="cell">
     <!-- <div class="detail">
      ...
      <div class="detail">
            <div class="detail-title"><?php echo $lang->risk->preventionAndremedy;?></div>
            <div class="detail-content article-content"><?php echo $risk->preventionAndremedy;?></div>
       </div>
      <div class="detail">
    ...
    <div class='main-actions'>
      <div class="btn-toolbar">
        ...
        common::printIcon('risk', 'assignedToFrameWork', "riskID=$risk->id", $risk, 'button', 'hand-right', '', 'iframe showinonlybody', true);
          ...
          <div class='tab-pane active' id='legendLifeTime'>
            <table class="table table-data">
              ...
              <tr>
                  ...
                  <td><?php echo $risk->createdDate == '0000-00-00' ? '' : date('Y-m-d',strtotime($risk->createdDate));?></td>
              </tr>
              ...
              <tr class='w-90px'>
                  ...
                  <td><?php echo zget($users, $risk->frameworkUser);?></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <tr>
                  ...
                  <td><?php echo $risk->editedDate == '0000-00-00 00:00:00' ? '' : date('Y-m-d',strtotime($risk->editedDate));?></td>
                </tr>
                <tr>
                  <th><?php echo $lang->risk->assignedDate;?></th>
                  <td><?php echo $risk->assignedDate == '0000-00-00' ? '' : $risk->assignedDate;?></td>
