...
<div id="mainContent" class="main-content fade">
  <div class="center-block">
    <div class="main-header">
      <h2><?php echo  $lang->putproduction->edit;?></h2>
    </div>
            ...
            <tr>
              ...
              <tr>
                  ...
                  foreach($lang->putproduction->internalReviewNodeCodeList as $nodeCode):
                          ...
                          $currentAccounts = '';
                          if(isset($reviewerAccounts[$nodeCode]) && !empty($reviewerAccounts[$nodeCode])){
              ...
              <tr>
                  ...
                  <?php if(in_array($putproductionInfo->status,$lang->putproduction->allowEditStatusArray)):?>
                      <input type="hidden" name="issubmit" value="<?php echo $putproductionInfo->issubmit;?>">
                  ...
                  <?php else:?>
                      ...
                      <td class='form-actions text-center' colspan='4'>
                          <?php echo html::submitButton($lang->putproduction->submit) . html::backButton();?>
                      </td>
                  <?php endif;?>
              </tr>
            </tbody>
...
<input type="hidden" value="<?php echo $putproductionInfo->id?>" id="id">
