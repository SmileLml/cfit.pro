      ...
      <table class="table table-form">
        <tbody>
          <tr>
            ...
            <?php $projectName =  isset($creation->name) ? $creation->name : $plan->name;?>
            <td colspan='2'>
              <?php echo $projectName;?>
              <?php echo html::hidden('name', $projectName)?>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>
              <div class='input-group'>
                ...
                <?php echo html::select('dept[]', $depts, isset($creation->dept) ? $creation->dept : $this->app->user->dept, "class='form-control chosen' multiple");?>
              </div>
            </td>
          </tr>
          <tr>
            <th><?php echo $lang->projectplan->source;?></th>
            <td><?php echo html::select('source[]', $lang->projectplan->basisList, isset($creation->source) ? $creation->source : '', "class='form-control chosen' multiple");?></td>
            <td>
              <div class='input-group'>
                <span class='input-group-addon'><?php echo $lang->opinion->union;?></span>
                <?php echo html::select('union[]', $lang->opinion->unionList, isset($creation->union) ? $creation->union : '', "class='form-control chosen' multiple");?>
              </div>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <th><?php echo $lang->projectplan->background;?><i class="icon icon-help hover" title="<?php echo $lang->projectplan->backgroundNotice;?>"></i></th>
          ...
          <tr>
            <th><?php echo $lang->projectplan->range;?><i class="icon icon-help hover" title="<?php echo $lang->projectplan->rangeNotice;?>"></i></th>
          ...
          <tr>
            <th><?php echo $lang->projectplan->goal;?><i class="icon icon-help hover" title="<?php echo $lang->projectplan->goalNotice;?>"></i></th>
          ...
          <tr>
            <th><?php echo $lang->projectplan->stakeholder;?><i class="icon icon-help hover" title="<?php echo $lang->projectplan->stakeholderNotice;?>"></i></th>
          ...
          <tr>
            <th><?php echo $lang->projectplan->verify;?><i class="icon icon-help hover" title="<?php echo $lang->projectplan->verifyNotice;?>"></i></th>
          ...
          <tr>
            ...
            <td colspan='2'>
                <div class='detail-content article-content'>
                    <?php
                    if(isset($creation->files)){
                        echo $this->fetch('file', 'printFiles', array('files' => $creation->files, 'fieldset' => 'false', 'object' => $creation, 'canOperate' => true, 'isAjaxDel' => true));
                    }
                    ?>
                </div>
                <?php echo $this->fetch('file', 'buildform', 'fileCount=1&percent=0.85');?></td>
          </tr>
          <tr>
