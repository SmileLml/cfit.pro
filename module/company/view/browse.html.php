...
<div id='mainMenu' class='clearfix'>
  ...
  <div class='btn-toolbar pull-left'>
    ...
    <?php echo html::a($this->createLink('company', 'browse', 'browseType=outsideExpertType'), '<span class="text">' . $lang->user->outsideExpertType . '</span>', '', 'class="btn btn-link outsideExpertType"');?>
    ...
    <form class='main-table table-user' data-ride='table' action='<?php echo $this->createLink('user', 'batchEdit', "deptID=$deptID")?>' method='post' id='userListForm'>
      ...
      <table class='table has-sort-head' id='userList'>
        ...
        <tr>
          ...
          <th><?php common::printOrderLink('employeeNumber', $orderBy, $vars, $lang->user->employeeNumber);?></th>
          <th class="w-90px"><?php common::printOrderLink('number', $orderBy, $vars, $lang->user->id);?></th>
...
<!--          <th>--><?php //!empty($this->config->isINT) ? common::printOrderLink('skype', $orderBy, $vars, $lang->user->skype) : common::printOrderLink('qq', $orderBy, $vars, $lang->user->qq);?><!--</th>-->
          <th class="w-400px"><?php common::printOrderLink('usergroup', $orderBy, $vars, $lang->user->belongGroup);?></th>
...
<!--          <td>--><?php //echo !empty($this->config->isINT) ? $user->skype : ($user->qq ? html::a("tencent://message/?uin=$user->qq", $user->qq) : '');?><!--</td>-->
            <td class="text-ellipsis" style ='white-space:normal' title="<?php echo $user->usergroup;?>"><?php echo $user->usergroup;?></td>
