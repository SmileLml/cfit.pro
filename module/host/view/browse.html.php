    ...
    <table class='table has-sort-head table-fixed'>
      <thead>
        <tr>
          ...
          <th class='w-70px'>   <?php common::printOrderLink('t1.status', $orderBy, $vars, $lang->host->status);?></th>
      ...
      <tbody>
        ...
        <tr class='text-left'>
          ...
          <td class='c-actions'>
            ...
            common::printIcon('host','edit',"id=$host->assetID&hostID=$host->hostID", $host, '', 'edit');
