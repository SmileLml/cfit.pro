...
//        a($this->app->dataRoot.$fileName);
        file_put_contents($this->post->generatefilepath.$this->post->generatefilename,$fileData);
        chmod($this->post->generatefilepath.$this->post->generatefilename,0666);
    }
