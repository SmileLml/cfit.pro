  ...
  <form method='post' target='hiddenwin' id='dataform'>
    <table class='table table-form'> 
      ...
      <tr>
        ...
        <td><?php echo html::input('realname', $user->realname, "class='form-control' readonly='readonly'");?></td>
        <th class='w-140px'><?php echo $lang->user->email;?></th>
        <td><?php echo html::input('email', $user->email, "class='form-control' readonly='readonly'");?></td>
      </tr>
      <tr>
        <th><?php echo $lang->user->gender;?></th>
        <td>
        <?php echo html::radio('gender', $lang->user->genderList, $user->gender);?>
        <?php echo html::hidden('groups[]', $userGroups);?>
        </td>
