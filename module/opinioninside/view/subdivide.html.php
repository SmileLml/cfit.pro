...
<div id="mainContent" class="main-content fade">
  <div class="center-block">
    <div class="main-header">
      <h2><?php echo $lang->opinioninside->subdivide;?></h2>
    </div>
    <form method='post' class='load-indicator main-form form-ajax' enctype='multipart/form-data' id="batchCreateForm">
      <table class="table table-form">
        <tbody>
          <tr>
            <th><?php echo $lang->opinioninside->reminder;?></th>
            <td colspan='4' style='color: gray;'><?php echo $lang->opinioninside->reminderDesc;?></td>
          </tr>
          <tr>
            <th id="task" ><?php echo $lang->opinioninside->demandTaskTitle;?></th>
            <th id="demand" style="display:none;"  ><?php echo $lang->opinioninside->demandTitle;?></th>
        ...
        <tr id="app">
            <th ><?php echo $lang->opinioninside->demandApp?></th>
          ...
          <tr id="deadline">
              ...
              <td class='required' colspan='2'>
                  <div class='input-group'>
                      <span class='input-group-addon'><?php echo $lang->opinioninside->end; ?></span>
                      <?php echo html::input('end[]', $opinion->deadline, "class='form-control form-date'"); ?>
                  </div>
              </td>
          </tr>
          <tr id='descTr'>
            <th id="task1"><?php echo $lang->opinioninside->demandTaskDesc;?></th>
            <th id="demand1" style="display:none;"><?php echo $lang->opinioninside->demandDesc;?></th>
          ...
          <tr>
            <th><?php echo $lang->opinioninside->nextUser;?></th>
