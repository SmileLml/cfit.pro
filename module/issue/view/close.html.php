  ...
  <div class='center-block'>
    <div class='main-header'>
      <h2>
        ...
        <small><?php echo $lang->arrow.$lang->issue->closeTitle ;?></small>
      </div>
    </div>
    ...
    <form method='post' enctype='multipart/form-data' target='hiddenwin'>
      <table class='table table-form'>
        ...
        <tr>
          ...
          <td colspan='2'><?php echo html::select('resolution', $lang->issue->resolveMethods, '', 'class="form-control chosen"');?></td>
        </tr>
        <tr>
