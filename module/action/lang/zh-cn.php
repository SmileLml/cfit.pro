...
$lang->action->objectTypes['requirementChange']     = '需求池同步变更单';
$lang->action->objectTypes['deptorder']     = '部门工单';
$lang->action->objectTypes['environmentorder']     = '环境部署工单';
...
$lang->action->desc->renewfile      = '$date, 由 <strong>$actor</strong> 更新了附件。' . "\n";
$lang->action->desc->projectswap    = '$date, 由 <strong>$actor</strong> 移动项目空间。' . "\n";
$lang->action->desc->deletedissue   = '$date, 由 <strong>$actor</strong> 删除了评审问题<strong><i>$extra</i></strong>。' . "\n";
$lang->action->desc->editissue      = '$date, 由 <strong>$actor</strong> 编辑了了评审问题<strong><i>$extra</i></strong>。' . "\n";
$lang->action->desc->createissues      = '$date, 由 <strong>$actor</strong> 批量添加了评审问题。' . "\n";
$lang->action->desc->downloadfiles      = '$date, 由 <strong>$actor</strong> 下载了会议评审材料<strong><i>$extra</i></strong>。' . "\n";
...
$lang->action->desc->kanbanmoved          = '$date, 由 <strong>$actor</strong> 移动。' . "\n";
...
$lang->action->desc->resolved       = '$date, 由 <strong>$actor</strong> 处理。' . "\n";
$lang->action->desc->managed        = '$date, 由 <strong>$actor</strong> 维护。' . "\n";
$lang->action->desc->import         = '$date, 由 <strong>$actor</strong> 导入。' . "\n";
$lang->action->desc->splited        = '$date, 由 <strong>$actor</strong> 拆分。' . "\n";
$lang->action->desc->createfeedbacked        = '$date, 由 <strong>$actor</strong> 反馈。' . "\n";
$lang->action->desc->schedule         = '$date, 由 <strong>$actor</strong> 排期。<strong>$extra</strong>' . "\n";
$lang->action->desc->confirmmeeting         = '$date, 由 <strong>$actor</strong> 确认开会。' . "\n";
$lang->action->desc->notice         = '$date, 由 <strong>$actor</strong> 发送邮件通知。' . "\n";
$lang->action->desc->exportrostering         = '$date, 由 <strong>$actor</strong> 导出排班模板。' . "\n";
$lang->action->desc->exportrosteringdata         = '$date, 由 <strong>$actor</strong> 导出排班数据。' . "\n";
$lang->action->desc->editedtemplate         = '$date, 由 <strong>$actor</strong> 编辑模板。' . "\n";
$lang->action->desc->exporttemplate         = '$date, 由 <strong>$actor</strong> 导入模板。' . "\n";
$lang->action->desc->initchanges         = '$date, 由 <strong>$actor</strong> 发起变更。' . "\n";
...
$lang->action->desc->editreview         = '$date, 由 <strong>$actor</strong> 编辑了评审问题<strong>$extra</strong>。' . "\n";
...
/* 交付管理需求条目时时状态联动*/
$lang->action->desc->linkagestatus     = '$date, 由 <strong>$actor</strong> 进行状态联动 <strong>$extra</strong>。' . "\n";
$lang->action->desc->redeal            = '$date, 由 <strong>$actor</strong> 重新分析 。' . "\n";
...
$lang->action->label->kanbanmoved                 = '移动了';
...
$lang->action->label->import                = '导入了';
$lang->action->label->defectbug             = '转为缺陷';
$lang->action->label->changeorder         = '同步变更单';
$lang->action->label->submitreview         = '申请审批';
$lang->action->label->assignedtoframeworked   = '指派架构部人员';
...
$lang->action->actionNotesDesc = "由 %s 更新为 %s";//历史记录备注描述