...
<div id="mainContent" class="main-content fade">
  <div class="center-block">
    <div class="main-header">
      <h2><?php echo $lang->deptorder->create;?></h2>
    </div>
      ...
      <table class="table table-form">
        <tbody>
          ...
          <tr>
              ...
              <td><?php echo html::select('type', $lang->deptorder->typeList, '', "class='form-control chosen'");?></td>
              <td>
          ...
          <tr>
              ...
              <td><?php echo html::select('source', $lang->deptorder->sourceList, '', "class='form-control chosen'");?></td>
              <td>
                  <div class='input-group'>
          ...
          <tr>
              ...
              <td><?php echo html::select('union', $this->lang->deptorder->unionList, '', "class='form-control chosen'");?></td>
              <td>
                  <div class='input-group'>
                      <span class='input-group-addon'><?php echo $lang->deptorder->team; ?></span>
                      <?php echo html::select('team[]', $users, $this->app->user->account, "class='form-control chosen'multiple");?>
                  </div>
              </td>
          </tr>
          <tr>
