...
$config->effort->list->exportFields  = 'id,date,dept,account,work,consumed,left,objectType,product,execution';
$config->effort->list->defaultFields = 'id,date,account,work,consumed,left,objectType,product,execution';

$config->effort->datatable = new stdclass();
$config->effort->datatable->defaultField = array('id', 'date', 'account', 'work', 'consumed', 'left', 'objectType', 'product', 'execution');
...
$config->effort->datatable->fieldList['execution']['width']    = '180';
