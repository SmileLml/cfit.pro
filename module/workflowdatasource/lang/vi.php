...
$lang->workflowdatasource->options['user']  = 'Người dùng hệ thống';
$lang->workflowdatasource->options['dept']  = 'Phòng/Ban';
$lang->workflowdatasource->options['deptManager'] = 'Trưởng phòng';
$lang->workflowdatasource->options['actor']    = 'Người vận hành';
$lang->workflowdatasource->options['today']    = 'Ngày vận hành';
$lang->workflowdatasource->options['now']   = 'Thời gian vận hành';
$lang->workflowdatasource->options['form']  = 'Form dữ liệu';
$lang->workflowdatasource->options['record']   = 'Ghi dữ liệu';
$lang->workflowdatasource->options['custom']   = 'Tùy biến';
