    ...
    <div class="center-block">
        <div class='main-header'>
            <h2>
                ...
                <?php echo isonlybody() ? ("<span title='$defect->code'>" . $lang->defect->repush . '</span>') : html::a($this->createLink('defect', 'view', "defectID=$defect->id"), $defect->name);?>
                <?php if(!isonlybody()):?>
                    <small><?php echo $lang->arrow . $lang->defect->repush;?></small>
                <?php endif;?>
            </h2>
        </div>
