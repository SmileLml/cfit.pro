 ...
 */
public function getEffort($parent, $begin, $end, $product = 0, $execution = 0, $user = '', $showAll = 0)
{
    return $this->loadExtension('calendar')->getEffort($parent, $begin, $end, $product, $execution, $user, $showAll);
}
