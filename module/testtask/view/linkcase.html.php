  ...
  <div class='btn-toolbar pull-left'>
    ...
    if($suiteList)
    {
        foreach($suiteList as $suiteID => $suite)
        {
            ...
            echo "<li>" . html::a(inlink('linkCase', "taskID=$taskID&type=bysuite&param=$suiteID"), $suiteName, '_self', "data-app={$this->app->openApp}") . "</li>";
        }
    }
    else
    {
    ...
    if($testTask)
    {
        ...
        {
            echo "<li>" . html::a(inlink('linkCase', "taskID=$taskID&type=bybuild&param=$tmpID"), $tmpTitle, '_self', "data-app={$this->app->openApp}") . "</li>";
        }
    }
    else
    {
...
<div class="cell show" id="queryBox" data-module='testtask_link_testcase'></div>
<div id='mainContent'>
    ...
    <table class='table tablesorter'>
      ...
      <thead>
        <tr>
          ...
          <th class='c-pri w-60px'><?php echo $lang->priAB;?></th>
