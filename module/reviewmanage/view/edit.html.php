...
<div id="mainContent" class="main-content fade">
  <div class="center-block">
    ...
    <form class="load-indicator main-form form-ajax" method='post' enctype='multipart/form-data' id='reviewmanageedit'>
      <table class="table table-form">
        <tbody>
        <tr>
            <th class='w-130px'><?php echo $lang->review->object;?></th>
            <td >
                <?php echo html::select('object[]', $lang->review->objectList, $review->object, "class='form-control chosen' multiple");?>
            </td>
        </tr>
          <tr>
        ...
        <tr>
          ...
          <tr>
              <?php $actionLink =$this->createLink('reviewmanage','browse');//inlink('browse', "project=$review->project");?>
