...
<div id="mainContent" class="main-content fade">
    <div class="center-block">
        <div class="main-header">
            <h2><?php echo $lang->componentpublic->editversion; ?></h2>
        </div>
            ...
            <div id="newPublic">
                <table class="table table-form">
                    ...
                    <tr>
                        ...
                        <td class='required'><?php echo html::input('updatedDate', $version->updatedDate, "class='form-control form-date'");?></td>
                    </tr>
                    <tr>
                        <th><?php echo $lang->componentpublic->desc; ?></th>
                        <td class='required'><?php echo html::textarea('desc', $version->desc, "class='form-control' placeholder='可以在编辑器直接贴图，最多支持输入2000个字符'"); ?></td>
                    </tr>
                    <tr>
                    ...
                    <?php if($version->files): ?>
                        <tr>
                            <th></th>
                            <td><?php  echo $this->fetch('file', 'printfilesbycomponent', array('files' => $version->files, 'fieldset' => 'true', 'canOperate' => 'true'));?></td>
                        </tr>
                    <?php endif; ?>
                    </tbody>
                </table>
