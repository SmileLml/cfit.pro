...
$lang->caselib->title        = '用例标题';
$lang->caselib->categories   = '自动化分类';
$lang->caselib->type         = '用例类型';
$lang->caselib->stage        = '适用阶段';
$lang->caselib->precondition = '前置条件';
$lang->caselib->steps        = '用例步骤';
$lang->caselib->expect       = '预期';
$lang->caselib->statusAB     = $lang->statusAB;
$lang->caselib->keywords     = '关键词';
$lang->caselib->priAB        = $lang->priAB;
$lang->caselib->pri          = $lang->priAB;
$lang->caselib->module       = $lang->module;
$lang->caselib->openedBy     = $lang->openedByAB;
