              ...
              <div class='detail'>
                  <div class="detail-title">
                      ...
                      foreach ($lang->residentsupport->schedulingDeptLabelList as $label => $labelName) {
                          ...
                          echo html::a("javascript:void(0)", '<span class="text">' . $labelName . '</span>', '', "class='btn btn-link $active' data-val='$label'");
                      }
                      ?>
                  </div>
                  ...
                  <?php endif;?>
                      ...
                      <tr>
                          <td class='text-center' colspan='8'>
                              ...
                              <?php echo html::submitButton('提交', '', 'btn btn-wide btn-primary enableScheduling').'&nbsp;'. html::commonButton('取消','onclick="return returnBack();"');?>
                          </td>
                      </tr>
                  </tbody>
              </table>
...
<script>
    ...
    var schedulingDeptType = $(".detail-title .btn-active-text").attr("data-val");
    ...
    function search() {
        ...
        var type = $("#type option:selected").val();
        var subType = $("#subType option:selected").val();
        link = link+"?source="+source+"&templateId="+templateId+"&startDate="+startDate+"&endDate="+endDate+"&type="+type+"&subType="+subType+"&schedulingDeptType="+schedulingDeptType
    ...
    $(".detail-title a").click(function () {
        var link = '<?php echo $this->createLink('residentsupport', 'onLineScheduling');?>';
        link = link+"?source="+source+"&templateId="+templateId+"&startDate="+startDate+"&endDate="+endDate+"&type="+type+"&subType="+subType+"&schedulingDeptType="+$(this).attr("data-val");
        location.href = link;
    })
