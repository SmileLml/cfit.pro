...
<div id="mainMenu" class="clearfix">
  <div class="btn-toolbar pull-left">
    <?php echo html::a($this->createLink('reviewcl', 'browse', "object="), '<i class="icon icon-back icon-sm"></i> ' . $lang->goback, '', "class='btn btn-secondary'");?>
  ...
  <div class="main-col col-8">
    ...
    <div class='main-actions text-center' style="margin-top:20px">
      <div class="btn-toolbar">
        ...
        <?php
        common::printIcon('reviewcl', 'edit',   "reviewclID=$reviewcl->id", $reviewcl, 'button', 'edit', '', '', true);
