...
class control extends baseControl
{
    ...
    public function __construct($moduleName = '', $methodName = '', $appName = '')
    {
        ...
        if(defined('IN_USE') or (defined('RUN_MODE') and RUN_MODE == 'api') or (defined('RUN_MODE') and RUN_MODE == 'mobileapi')) $this->setPreference();

        if(!isset($this->config->bizVersion)) return false;

        /* Code for task #9224. Set requiredFields for workflow. */
        if($this->dbh and (defined('IN_USE') or (defined('RUN_MODE') and RUN_MODE == 'api') or (defined('RUN_MODE') and RUN_MODE == 'mobileapi')))
        {
