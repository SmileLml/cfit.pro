...
class myfile extends file
{
    ...
    public function export2Xls()
    {
        ...
        {
            $excelSheet->setCellValue("A" . $i, $this->lang->excel->help->{$this->post->kind});
    ...
    public function setXlsStyle($excelSheet, $i)
    {
        ...
        foreach($this->excelKey as $key => $letter)
        {
            ...
            if(in_array($key, $this->config->excel->autoWidths) and !isset($_POST['width'][$key])) $excelSheet->getColumnDimension($letter)->setAutoSize(true);
