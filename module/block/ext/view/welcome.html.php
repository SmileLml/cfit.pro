...
<div class="panel-body conatiner-fluid">
  <div class="table-row">
    ...
    <h4><small class="text-muted"><?php echo date(DT_DATE3)?></small> <?php echo $lang->block->leftToday?></h4>
      <div class="row tiles">
        <div class="col tile">
          <div class="tile-title"><?php echo $lang->block->myAudit?></div>
          <div class="tile-amount color-red"><?php echo empty($audits) ? html::a($this->createLink('my', 'work', 'mode=audit&browseType=problem'), 0) : html::a($this->createLink('my', 'work', 'mode=audit&browseType=problem'), (int)$audits, '', 'class="color-red"');?></div>
        </div>
          <!--20220712 新增我的评审-->
        <div class="col tile">
              <div class="tile-title"><?php echo $lang->block->myReview?></div>
              <div class="tile-amount color-red"><?php echo empty($myreview) ? html::a($this->createLink('reviewmanage', 'board'), 0) : html::a($this->createLink('reviewmanage', 'board'), (int)$myreview, '', 'class="color-red"');?></div>
        </div>
        <div class="col tile">
          <div class="tile-title"><?php echo $lang->block->myTask?></div>
          <div class="tile-amount color-red"><?php echo empty($tasks) ? html::a($this->createLink('my', 'work', 'mode=task'), 0) : html::a($this->createLink('my', 'work', 'mode=task'), (int)$tasks, '', 'class="color-red"');?></div>
        ...
        <div class="col tile">
          ...
          <div class="tile-amount color-red"><?php echo empty($bugs) ? html::a($this->createLink('my', 'work', 'mode=bug'), 0) : html::a($this->createLink('my', 'work', 'mode=bug'), (int)$bugs, '', 'class="color-red"');?></div>
        ...
        <div class="col tile">
          ...
          <div class="tile-amount"><?php echo empty($stories) ? html::a($this->createLink('my', 'work', 'mode=story'), 0) : html::a($this->createLink('my', 'work', 'mode=story'), (int)$stories, '', 'class="color-red"');?></div>
        </div>
      </div>
    </div>
  </div>
