...
<main id="main">
    <div class="container">
        <div id="mainContent" class='main-content load-indicator'>
            ...
            <form action='<?php echo $this->createLink('report', 'exportbugdiscovery', array('browseType' => 'export'));?>' method='post' target='hiddenwin' onsubmit='setDownloading();' style='margin:20px 0px;'>
