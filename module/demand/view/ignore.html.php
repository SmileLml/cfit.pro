    ...
    <div class="center-block">
        <div class='main-header'>
            <h2>
                ...
                <?php echo isonlybody() ? ("<span title='$demand->code'>" . $lang->demand->ignore . '</span>') : html::a($this->createLink('demand', 'view', "demandID=$demand->id"), $demand->name); ?>
                <?php if (!isonlybody()): ?>
                    <small><?php echo $lang->arrow . $lang->demand->ignore; ?></small>
                <?php endif; ?>
            </h2>
        </div>
