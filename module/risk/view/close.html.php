    ...
    <table class='table table-form'>
      <tbody>
        ...
        <tr>
          ...
          <td><?php echo html::input('actualClosedDate', helper::today(),  "class='form-control form-date' readonly");?></td>
          <td></td>
        </tr>       <tr>
          <th><?php echo $lang->risk->resolution;?></th>
          <td colspan='2'><?php echo html::textarea('resolution', $risk->resolution, "rows='6' class='form-control kindeditor' hidefocus='true'");?></td>
        </tr>
        <tr>
