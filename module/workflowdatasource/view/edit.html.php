...
<form id='ajaxForm' method='post' action='<?php echo inlink('edit', "id=$datasource->id");?>'>
  <table class='table table-form'>
    ...
    <tr class='sqlTR'>
      ...
      <td>
        <div class='required required-wrapper'></div>
        <?php echo html::select('keyField', $fields, $datasource->keyField, "class='form-control chosen'");?>
      </td>
      <td></td>
    </tr>
    <tr class='sqlTR'>
      ...
      <td>
        <div class='required required-wrapper'></div>
        <?php echo html::select('valueField', $fields, $datasource->valueField, "class='form-control chosen'");?>
      </td>
      <td></td>
    </tr>
    <tr class='langTR'>
