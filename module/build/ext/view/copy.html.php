...
<div id='mainContent' class='main-content'>
    <div class='center-block'>
        <div class='main-header'>
            <h2><?php echo $lang->build->copy;?></h2>
        </div>
        <form class='load-indicator main-form form-ajax' id='dataform' method='post' enctype='multipart/form-data'>
            <table class='table table-form'>
                ...
                <tr>
                    ...
                    <td colspan='4'><?php echo html::select('app', $apps, $build->app,"class='form-control chosen' ");?></td>
                </tr>
                <tr>
                    <th><?php echo $lang->build->product;?></th>
                    <td colspan='2'><?php echo html::select('product', $products, !isset($product->id) ? '' : $product->id, 'class="form-control chosen" required');?></td>
                    <td colspan='2'>
                        <div class='input-group'>
                            <span class='input-group-addon'><?php echo $lang->build->version; ?></span>
                            <?php echo html::select('version', $plans, $build->version, 'class="form-control chosen" required ');?>
                        </div>
                    </td>
                </tr>
                <tr>
          ...
          <td></td>
               ...
               <!-- <tr>
                    ...
                    <td colspan='2'><?php /*echo html::select('purpose', $lang->build->purposeList, $build->purpose, 'class="form-control chosen"');*/?></td>
                    <td colspan='2'>
                        <div class='input-group'>
                            <span class='input-group-addon'><?php /*echo $lang->build->rounds;*/?></span>
                            <?php /*echo html::select('rounds', $lang->build->roundsList, $build->rounds, 'class="form-control chosen"');*/?>
                        </div>
                    </td>
                </tr>-->
                <tr>
                    <th><?php echo $lang->build->builder;?></th>
                    <td colspan='2'><?php echo html::select('builder', $users, $build->builder, 'class="form-control chosen" required');?></td>
                    <td colspan='2'>
                        <div class='input-group'>
                            <span class='input-group-addon'><?php echo $lang->build->testUser;?></span>
                            <?php echo html::select('testUser', $users, $build->testUser, 'class="form-control chosen" required');?>
                        </div>
                    </td>
                </tr>
                ...
                <?php if($isSetSeverityTestUser):?>
                    <tr>
                        ...
                        <td colspan='3'>
                            <div class='input-group top'>
                                <?php echo html::select('severityTestUser', array('' => '') + $severityTestUsers, $build->severityTestUser,'class="form-control chosen" required');?>
                            </div>
               ...
               <!-- <tr >
                    ...
                    <td colspan='2' ><?php /*echo html::radio('systemverify', $lang->build->needOptions, $build->systemverify,'onchange ="systemveif()"');*/?></td>
                    <td class="test" colspan='2'>
                        <div class='input-group'>
                            <span class='input-group-addon'><?php /*echo $lang->build->verifyUser;*/?></span>
                            <?php /*echo html::select('verifyUser', $users, $build->verifyUser, "class='form-control chosen' ");*/?>
                        </div>
                    </td>
                </tr>-->
                <tr>
                    <th><?php echo $lang->build->scmPath;?></th>
                    <td colspan='4'><?php echo html::textarea('scmPath', $build->scmPath, "class='form-control' placeholder='{$lang->build->placeholder->scmPath}' rows='2'");?></td>
                </tr>
                <tr>
                    <th><?php echo $lang->build->svnPath;?></th>
                    <td colspan='4'><?php echo html::textarea('svnPath', $build->svnPath, "class='form-control' placeholder='{$lang->build->placeholder->svnPath}' rows='2'");?></td>
                </tr>
                <tr>
                    <th><?php echo $lang->build->buildManual;?></th>
                    <td colspan='4'><?php echo html::input('buildManual', $build->buildManual, "class='form-control' placeholder='{$lang->build->placeholder->buildManual}'");?></td>
                </tr>
                <!--<tr>
                    <th><?php /*echo $lang->build->taskName;*/?></th>
                    <td colspan='4'><?php /*echo html::select('taskName', $build->taskName,'', "class='form-control' required onchange=taskNameChange()");*/?>
                    <span style="color: lightslategray;" colspan='4'><?php /*echo $this->lang->build->taskTip*/?></span></td>
...
js::set('projectID', $build->project);
js::set('task', $build->execution. ',' . $build->taskid);
js::set('app', $build->app);
js::set('version', $build->version);
js::set('product', $build->product);
