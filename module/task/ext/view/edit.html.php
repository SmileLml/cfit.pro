      ...
      <div class='main-col col-8'>
        <div class='cell'>
                ...
                <div class='<?php if(empty($task->children) and empty($task->parent) and $task->type != 'affair') echo 'input-group';?>'>
                  <div class="input-control has-icon-right">
                    <div class="colorpicker">
                      ...
                      <?php if($task->source):?>
                      <?php echo html::input('name', $task->name, 'maxlength = "80" class="form-control task-name" readonly = "readonly" placeholder="' . $lang->task->name . '"');?>
                      <?php else:?>
                      <?php echo html::input('name', $task->name, 'maxlength = "80" class="form-control task-name" placeholder="' . $lang->task->name . '"');?>
                      <?php endif;?>
                  </div>
          ...
          <div class='detail text-center form-actions'>
            <?php echo html::hidden('left', $task->left);?>
            ...
            <br>
            <br>
            <span style='color:#838a9d;' id='taskDurationError'></span>
          </div>
          ...
          <div class='detail'>
            ...
            <table class='table table-form'>
              ...
              <tr>
                ...
                <td><?php echo html::select('resourceTo[]', $members, explode(',', $task->resourceTo), "class='form-control chosen' multiple");?></td>
              </tr>
              <tr>
          ...
          <div class='detail'>
            ...
            <table class='table table-form'>
              <tr>
                ...
                <td><?php echo html::input('estStarted', $task->estStarted, "class='form-control form-date' onchange='changeComputerBegin(this)'");?></td>
              </tr>
              <tr>
                <th><?php echo $lang->task->deadline;?></th>
                <td><?php echo html::input('deadline', $task->deadline, "class='form-control form-date' onchange='changeComputerEnd(this)'");?></td>
              </tr>
              <tr>
                <th><?php echo $lang->task->estimate;?></th>
                <td>
                  <?php $disabled = (!empty($task->team) or $task->parent > 0) ? "readonly='readonly'" : '';?>
          ...
          <div class='detail'>
            ...
            <table class='table table-form'>
              ...
              <tr>
                ...
                <td>
                  <div class="input-group">
                    <?php echo html::input('progress', $task->progress, 'class="form-control"');?>
                    <span class="input-group-addon" style="border-radius: 0px 2px 2px 0px; border-right-width: 1px;">%</span>
                  </div>
                </td>
              </tr>
              <?php endif;?>
...
function changeComputerBegin(obj)
{
    ...
    if(diffValue > 7)
    {
        $('#taskDurationError').text(taskDurationError);
    }
    else
    {
        $('#taskDurationError').text('');
    }
}

function changeComputerEnd(obj)
{
    var beginDate = $('#estStarted').val();
    var endDate   = $(obj).val();
