...
<div id="mainContent" class="main-content fade">
  <div class="center-block">
    <div class="main-header">
        <a href="projectplan-execEdit-<?php echo $plan->id;?>.html" class="btn btn-link"><span class="text">变更年度计划</span></a>
        <span class="btn btn-link btn-active-text"><span class="text">变更立项书</span></span>
    </div>
