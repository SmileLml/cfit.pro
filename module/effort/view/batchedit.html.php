    ...
    <table class='table table-form table-fixed' id='objectTable'>
      <thead>
        ...
        <tr>
          ...
          <th class='w-180px'><?php echo $lang->effort->execution;?></th>
      ...
      <tr id='row<?php echo $id?>'>
        ...
        <td style='overflow:visible'><?php echo html::select("execution[$id]", $executions, $effort->execution, 'class="form-control chosen"');?>
