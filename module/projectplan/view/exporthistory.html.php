        ...
        <div id="mainContent" class='main-content load-indicator'>
            ...
            <form class='main-form' method='post' target='hiddenwin'>
                <table class="table table-form">
                    ...
                    <tr>
                        <th><?php echo $lang->projectplan->actionStartTime;?></th>
                        <td><?php echo html::input('startTime', $startTime, "class='form-control form-datetime' readonly='readonly'  style='background: #FFFFFF;' ");?></td>
                    </tr>
                    <tr>
                        <th><?php echo $lang->projectplan->actionEndTime;?></th>
                        <td><?php echo html::input('endTime', $endTime, "class='form-control form-datetime' readonly='readonly' style='background: #FFFFFF;' ");?></td>
                    </tr>
                    <tr>
                        <th></th>
                        <td>
