...
<div id="mainContent" class="main-content fade">
    <div class="center-block">
        <div class="main-header">
            <h2><?php echo $lang->projectplan->reviewingYear . ' - ' . $title?></h2>
        </div>
        <form class="load-indicator main-form form-ajax" method='post' enctype='multipart/form-data' id='dataform'>
            <table class="table table-form">
                <tbody>
                <tr>
                    <th class='w-140px'><?php echo $lang->projectplan->reviewResult; ?></th>
                    <td colspan='3'>
                ...
                <tr id="leaderOrOther">
                    <th class='w-110px'><?php echo $lang->projectplansh->leaderOther; ?></th>
                    <td colspan='3'>
                        <?php echo html::checkbox("leader", $cto, 'maoting', "onClick='return false' style='cursor:not-allowed;'"); ?>
                ...
                <tr>
                    ...
                    <td colspan='3'><?php echo html::select('reviewer[]', $users, $architect, "class='form-control chosen' multiple"); ?></td>
                </tr>
                <?php endif; ?>
                <tr>
