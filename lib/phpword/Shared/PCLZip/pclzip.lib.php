...
class PclZip
{
        ...
        if ($p_entry['status'] == 'ok') {
            ...
            if (!(($p_entry['external'] & 0x00000010) == 0x00000010)) {
                ...
                if ($p_entry['compression'] == 0) {
                    ...
                    /* 判断是否在站点基础目录下。 */
                    if(strpos($p_entry['filename'], $this->app->basePath) === false) die($this->lang->noBasicDirectory);
    ...
    public function privDirCheck($p_dir, $p_is_dir = false)
    {
        ...
        /* 判断是否在站点基础目录下。 */
        if(strpos($p_dir, $this->app->basePath) === false) die($this->lang->noBasicDirectory);
