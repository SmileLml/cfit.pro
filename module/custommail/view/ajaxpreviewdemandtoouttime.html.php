...
<tr>
  ...
  <td style='padding: 10px; border: none;'>
    <table cellpadding='0' cellspacing='0' style='width: 100%; border: 1px solid #e5e5e5; margin-bottom: 15px; border-collapse: collapse; font-size: 13px; text-align: left;'>
      <tr>
        <th style='width: 150px;text-align: center; border: 1px solid #e5e5e5; background-color: #f5f5f5; padding: 5px;'><?php echo $lang->demand->code;?></th>
        <td style='padding: 10px; border: 1px solid #e5e5e5;'>CFIT-Q-20230609-01</td>
      </tr>
        <tr>
            <th style='width: 150px;text-align: center; border: 1px solid #e5e5e5; background-color: #f5f5f5; padding: 5px;'><?php echo $lang->demand->title;?></th>
            <td style='padding: 10px; border: 1px solid #e5e5e5;'>这是需求条目主题</td>
        </tr>
        <tr>
            <th style='width: 150px;text-align: center; border: 1px solid #e5e5e5; background-color: #f5f5f5; padding: 5px;'><?php echo $lang->demand->end;?></th>
            <td style='padding: 10px; border: 1px solid #e5e5e5;'>2023-07-01 00:00:00</td>
        </tr>
        <tr>
            <th style='width: 150px;text-align: center; border: 1px solid #e5e5e5; background-color: #f5f5f5; padding: 5px;'><?php echo $lang->demand->status;?></th>
            <td style='padding: 10px; border: 1px solid #e5e5e5;'>开发中</td>
        </tr>
        <tr>
            <th style='width: 150px;text-align: center; border: 1px solid #e5e5e5; background-color: #f5f5f5; padding: 5px;'><?php echo $lang->demand->desc;?></th>
