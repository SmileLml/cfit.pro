...
<!--              <td>--><?php //printf('%03d', $plan->id);?><!--</td>-->
              <td class="text-ellipsis" title=<?php echo $plan->name;?>><?php echo common::hasPriv('projectplansh', 'view') ? html::a($this->createLink('projectplansh', 'view', "projectplanID=$plan->id"), $plan->name) : $plan->name;?></td>
