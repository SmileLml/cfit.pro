...
$filter->kanban->space->cookie['showClosed']          = 'int';
...
$filter->project->default->cookie['preProductID']     = 'int';
$filter->project->default->cookie['caseModule']       = 'int';
$filter->project->default->cookie['caseSuite']        = 'int';
...
$filter->qa->default->cookie['lastApplicationID'] = 'int';
...
$filter->caselib->export->cookie['checkedItem']    = 'reg::checked';
...
$filter->demandcollection = new stdClass();
$filter->demandcollection->export = new stdClass();
$filter->demandcollection->export->cookie['checkedItem']    = 'reg::checked';
