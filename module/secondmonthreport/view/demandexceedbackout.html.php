                        ...
                        <div class='btn-group'>
                            ...
                            <ul class="dropdown-menu  pull-right" id='exportActionMenu'>
                                ...
                                if($searchtype == 'history') {
                                    $class = common::hasPriv('secondmonthreport', 'demandExceedBackOutExport') ? '' : 'class=disabled';
                                    $misc  = common::hasPriv('secondmonthreport', 'demandExceedBackOutExport') ? "data-toggle='modal' data-type='iframe' class='export'" : 'class=disabled';
                                    $link  = common::hasPriv('secondmonthreport', 'demandExceedBackOutExport') ? $this->getExportFormUrl('demandExceedBackOutExport', $searchtype,$wholeID,$deptID,$realstarttime,$realendtime,$staticType,$isuseHisData) : '#';
                                    ...
                                    $class = common::hasPriv('secondmonthreport', 'demandExceedBackOutExport') ? '' : 'class=disabled';
                                    $misc  = common::hasPriv('secondmonthreport', 'demandExceedBackOutExport') ? "data-toggle='modal' data-type='iframe' class='export'" : 'class=disabled';
                                    $link  = common::hasPriv('secondmonthreport', 'demandExceedBackOutExport') ? $this->getExportFormUrl('demandExceedBackOutExport', $searchtype,0,$deptID,$realstarttime,$realendtime,$staticType,$isuseHisData) : '#';
                                    echo "<li {$class}>" . html::a($link, $lang->secondmonthreport->export, '', $misc) . '</li>';
                ...
                if ($detailReports) {
                    ...
                    <table class='table table-fixed has-sort-head table-bordered myformtable'>
                        ...
                        <tr>
                            ...
                            <th class='w-120px'><?php echo $lang->secondmonthreport->foverdueNum; ?></th>
                            <th class='w-120px'><?php echo $lang->secondmonthreport->backTotal; ?></th>
                            <th class='w-120px'><?php echo $lang->secondmonthreport->backExceedRate; ?></th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php
