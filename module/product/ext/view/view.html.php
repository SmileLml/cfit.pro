                            ...
                            <div class="detail-content">
                                <table class="table table-data data-basic">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan><strong><?php echo zget($users, $product->createdBy);?></strong></td>
                                        <th class="w-80px"><?php echo $lang->story->openedDate?></th>
                                        <td colspan="1"><strong><?php echo formatTime($product->createdDate, DT_DATE1);?></strong></td>
                                    </tr>
                                    <tr>
                                        <th class="w-80px"><?php echo $lang->product->osName;?></th>
                                        <td><strong><?php echo $selects['osTypeList'][$product->os];?></strong></td>
                                        <th class="w-80px"><?php echo $lang->product->archName;?></th>
                                        <td><strong><?php echo $selects['archTypeList'][$product->arch];?></strong></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <th class="w-80px"><?php echo $lang->product->codebasePath;?></th>
                                        <td><strong><?php echo $product->codebasePath;?></strong></td>
                                    </tr>

                                    <tr>
                                        <th><?php echo $lang->product->belongDeptIds;?></th>
                                        <td colspan="3"><?php echo  zmget($depts, $product->belongDeptIds) ;?></td>
                                    </tr>

                                    <tr>
                                        <th><?php echo $lang->product->piplinePath;?></th>
                                        <td colspan="3"><?php echo  $product->piplinePath ;?></td>
                                    </tr>

                                    <tr>
                                        <th><?php echo $lang->product->skipBuild;?></th>
                                        <td ><?php echo  $product->skipBuild   ?  '是' : '否';?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <table class='table table-detail table-bordered table-condensed table-striped table-fixed  '>
                                        <thead>
                                        <tr>
                                            <th class='w-350px'><?php echo $lang->product->productid; ?></th>
                                            <th class='w-350px'><?php echo $lang->product->enableTime; ?></th>
                                            <th class='w-350px'><?php echo $lang->product->comment ; ?></th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?php if (!empty($codeinfos)) : ?>
                                            <?php foreach ($codeinfos as $codeinfo): ?>
                                                <tr>
                                                    <td class="text-left"><?php echo $codeinfo->code; ?></td>
                                                    <td class="text-left"><?php  echo $codeinfo->enableTime; ?></td>
                                                    <td class="text-left text-ellipsis"><?php  echo $codeinfo->desc; ?></td>
                                                </tr>
                                            <?php endforeach; ?>
                                        <?php else: ?>
                                            <tr>
                                                <td colspan="3 "> <?php echo "<div class='text-center text-muted'>" . $lang->noData . '</div>'; ?></td>
                                            </tr>
                                        <?php endif; ?>
                                        </tbody>
                                    </table>
                                   ...
                                   <!-- <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><strong><?php /*echo $selects['osTypeList'][$product->os];*/?></strong></td>
                                        <th class="w-80px"><?php /*echo $lang->product->archName;*/?></th>
                                        <td colspan="2"><strong><?php /*echo $selects['archTypeList'][$product->arch];*/?></strong></td>
                                    </tr>
