    ...
    <div class='main-header'>
      <h2 class='clearfix'>
        ...
        <div class='input-group'>
          ...
          <?php echo html::select('selectTask', $taskPairs, $defaultTesttaskID, "class='form-control chosen'");?>
        </div>
        <?php endif;?>
      </h2>
    </div>
        ...
        <div class="detail-content">
          <table class='table table-form'>
            <tr>
              ...
              <td class='w-p50'>
                <div class='input-group'>
                  ...
                  <?php
                  echo html::hidden('product', $testtask->product) . html::hidden('project', $testtask->project) . html::hidden('tasks', $tasks);
                  echo html::hidden('applicationID', $testtask->applicationID) . html::hidden('objectID', 0) . html::hidden('objectType', $objectType);
                  ?>
                </div>
              </td>
              <td>
            ...
            <tr>
              ...
              echo '<div>' . sprintf($lang->testreport->buildSummary, empty($builds) ? 0 : count($builds)) . $caseSummary . '</div>';
