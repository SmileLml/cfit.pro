      ...
      <table class="table table-form" id="tableBody">
        <thead>
          <tr class='text-center'>
            ...
            <th class='w-180px required project-input-item'><?php echo $lang->testcase->project;?></th>
            <th class='w-160px<?php echo zget($visibleFields, 'module', ' hidden') . zget($requiredFields, 'module', '', ' required');?>'><?php echo $lang->testcase->module;?></th>
        ...
        <tbody>
          ...
          $pri  = $i == 0 ? 3 : 'ditto';
          $projects += array('ditto' => $lang->testcase->ditto);
          ?>
          <tr>
            <td class="text-center"><?php echo $i+1;?></td>
            <td class='text-left project-input-item' style='overflow:visible'><?php echo html::select("project[$i]", $projects, $projectID, "class='form-control chosen'");?></td>
...
<table class='template' id='trTemp'>
  <tbody>
    <tr>
      ...
      <td class='text-left project-input-item' style='overflow:visible'><?php echo html::select("project[%s]", $projects, '', "class='form-control chosen'");?></td>
...
<script>
  if(projectID > 0) $('.project-input-item').addClass('hidden');
</script>
