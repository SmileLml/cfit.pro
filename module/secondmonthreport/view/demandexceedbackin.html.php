                        ...
                        <div class='btn-group'>
                            ...
                            <ul class="dropdown-menu  pull-right" id='exportActionMenu'>
                                ...
                                if($searchtype == 'history') {
                                    ...
                                    $class = common::hasPriv('secondmonthreport', 'demandExceedBackInExport') ? '' : 'class=disabled';
                                    $misc  = common::hasPriv('secondmonthreport', 'demandExceedBackInExport') ? "data-toggle='modal' data-type='iframe' class='export'" : 'class=disabled';
                                    $link  = common::hasPriv('secondmonthreport', 'demandExceedBackInExport') ? $this->getExportFormUrl('demandExceedBackInExport', $searchtype,$wholeID,$deptID,$realstarttime,$realendtime,$staticType,$isuseHisData) : '#';
                                    ...
                                    $class = common::hasPriv('secondmonthreport', 'demandExceedBackInExport') ? '' : 'class=disabled';
                                    $misc  = common::hasPriv('secondmonthreport', 'demandExceedBackInExport') ? "data-toggle='modal' data-type='iframe' class='export'" : 'class=disabled';
                                    $link  = common::hasPriv('secondmonthreport', 'demandExceedBackInExport') ? $this->getExportFormUrl('demandExceedBackInExport', $searchtype,0,$deptID,$realstarttime,$realendtime,$staticType,$isuseHisData) : '#';
                                    echo "<li {$class}>" . html::a($link, $lang->secondmonthreport->export, '', $misc) . '</li>';
