<?php
$config->newexecution = new stdclass();
$config->newexecution->defaultWorkhours = '7.0';
$config->newexecution->orderBy          = 'isDone,status,order_desc';
$config->newexecution->maxBurnDay       = '31';
$config->newexecution->weekend          = '2';

$config->newexecution->list = new stdclass();
$config->newexecution->list->exportFields = 'id,name,code,PM,end,status,totalEstimate,totalConsumed,totalLeft,progress';

$config->newexecution->modelList['scrum']     = 'sprint';
$config->newexecution->modelList['waterfall'] = 'stage';

global $lang, $app;
$app->loadLang('task');
$config->newexecution->task   = new stdclass();
$config->newexecution->create = new stdclass();
$config->newexecution->edit   = new stdclass();
$config->newexecution->create->requiredFields = 'name,code,begin,end';
$config->newexecution->edit->requiredFields   = 'name,code,begin,end';

$config->newexecution->customBatchEditFields = 'days,type,teamname,status,desc,PO,QD,PM,RD';

$config->newexecution->custom = new stdclass();
$config->newexecution->custom->batchEditFields = 'days,status,PM';

$config->newexecution->editor = new stdclass();
$config->newexecution->editor->create   = array('id' => 'desc',    'tools' => 'simpleTools');
$config->newexecution->editor->edit     = array('id' => 'desc',    'tools' => 'simpleTools');
$config->newexecution->editor->putoff   = array('id' => 'comment', 'tools' => 'simpleTools');
$config->newexecution->editor->activate = array('id' => 'comment', 'tools' => 'simpleTools');
$config->newexecution->editor->close    = array('id' => 'comment', 'tools' => 'simpleTools');
$config->newexecution->editor->start    = array('id' => 'comment', 'tools' => 'simpleTools');
$config->newexecution->editor->suspend  = array('id' => 'comment', 'tools' => 'simpleTools');
$config->newexecution->editor->tree     = array('id' => 'comment', 'tools' => 'simpleTools');
$config->newexecution->editor->view     = array('id' => 'comment,lastComment', 'tools' => 'simpleTools');
