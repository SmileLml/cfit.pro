...
<div id='mainMenu' class='clearfix'>
  <div class='btn-toolbar pull-left'>
    ...
    <div class="page-title">
      <?php
      echo html::a($this->doclib->createLink('browse', "libID=$libID"), $lib->name, '', "data-app='{$app->openApp}'");
      $paths= explode('/', $entry);
  ...
  <div class='panel-heading'>
    <form method='post'>
      <div class='btn-group pull-right'>
        <?php echo html::commonButton($lang->doclib->viewDiffList['inline'], "id='inline'", $arrange == 'inline' ? 'active btn btn-sm' : 'btn btn-sm')?>
        <?php echo html::commonButton($lang->doclib->viewDiffList['appose'], "id='appose'", $arrange == 'appose' ? 'active btn btn-sm' : 'btn btn-sm')?>
      </div>
      <div class='btn-toolbar'>
        <div class='btn-group'>
          <?php if(common::hasPriv('doclib', 'download')) echo html::a($this->doclib->createLink('download', "libID=$libID&path=" . $this->doclib->encodePath($entry) . "&fromRevison=$oldRevision&toRevision=$newRevision&type=path"), $lang->doclib->downloadDiff, 'hiddenwin', "class='btn btn-sm btn-download'");?>
          <div class='btn-group'>
            <?php echo html::commonButton(zget($lang->doclib->encodingList, $encoding, $lang->doclib->encoding) . "<span class='caret'></span>", "data-toggle='dropdown'", 'btn dropdown-toggle btn-sm')?>
