...
$lang->productplan->menuCommon = '版本';
$lang->score->shortCommon       = '积分';
$lang->testreport->shortCommon  = '报告';
$lang->qa->shortCommon          = 'QA';

$lang->bymeaudit = new stdClass();
$lang->bymeaudit->common     = "项目评审";

$lang->dashboard  = '仪表盘';
$lang->contribute = '贡献';
$lang->dynamic    = '动态';
$lang->authorization = '授权管理';
$lang->contact    = '联系人';
$lang->whitelist  = '白名单';
$lang->roadmap    = '路线图';
$lang->track      = '矩阵';
...
$lang->product->AllProduct = '所有'.$lang->productCommon;

$lang->project->report = '周报';

$lang->report->weekly = '项目周报';
...
$lang->notNoticePasteImg = "该字段会同步清总，由于外部系统不支持图片展示，此处不要粘贴图片";
$lang->pasteImgFail      = "贴图失败，请稍后重试。";
$lang->pasteImgUploading = "正在上传图片，请稍后...";
$lang->noBasicDirectory  = "不在站点目录下";
...
/* kanban from 18.0 beta1  */
$lang->delayed = '已延期';

$lang->sftperror = 'sftp用户名密码配置错误';
$lang->md5error = '附件传输-MD5校验错误！';
$lang->neterror = '附件传输-网络错误！';
$lang->fileerror = '-附件不存在！';
$lang->userDoc                              = '用户手册';
$lang->userUseDoc                           = '用户使用手册';
$lang->stayTuned                            = '敬请期待~';
