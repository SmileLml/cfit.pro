...
<div id="mainContent" class="main-content fade">
  <div class="center-block">
    <div class="main-header">
      <h2><?php echo $lang->demandinside->workloadEdit;?></h2>
    </div>
    <form class="load-indicator main-form form-ajax" method='post' enctype='multipart/form-data' id='dataform'>
      <table class="table table-form">
          <tbody>
          <tr>
            <th class='w-140px'><?php echo $lang->demandinside->nodeUser;?></th>
          ...
          ?>
          <tr>
            <th class='w-140px'><?php echo $lang->demandinside->before;?></th>
            <td><?php echo html::select('before', $lang->demandinside->statusList, $consumed->before, "class='form-control chosen'");?></td>
          </tr>
          <tr>
            <th class='w-140px'><?php echo $lang->demandinside->after;?></th>
            <td><?php echo html::select('after', $lang->demandinside->statusList, $consumed->after, "class='form-control chosen'");?></td>
          </tr>
