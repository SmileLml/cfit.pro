  ...
  <div class='center-block'>
    <div class='main-header'>
      <h2>
        ...
        <small><?php echo $lang->arrow.$lang->issue->assignToFrameWorkTitle ;?></small>
      </h2>
      </div>
    </div>
      ...
      <form class="load-indicator main-form form-ajax" method='post' enctype='multipart/form-data' >
        <table class='table table-form'>
            <tr>
                ...
                <td colspan='2'><?php echo html::select('frameworkUser', $frameworkUsers, $issue->frameworkUser, 'class="form-control chosen"');?></td>
            </tr>
            <tr>
