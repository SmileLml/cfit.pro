...
$lang->api->User_demand_background    = '需求背景';
...
$lang->apimeasure->problemStatusList[null]     = 0;         //空值
$lang->apimeasure->problemStatusList['confirmed']     = 1;   //待分配
$lang->apimeasure->problemStatusList['assigned']      = 2;    //待分析
$lang->apimeasure->problemStatusList['feedbacked']    = 3;    //开发中
$lang->apimeasure->problemStatusList['build']         = 4;    //测试中
$lang->apimeasure->problemStatusList['released']      = 5;    //已发布
$lang->apimeasure->problemStatusList['delivery']      = 6;    //已交付
$lang->apimeasure->problemStatusList['onlinesuccess'] = 7;   //上线成功
$lang->apimeasure->problemStatusList['closed']        = 8;    //已关闭
$lang->apimeasure->problemStatusList['returned']      = 9;    //未受理
$lang->apimeasure->problemStatusList['toclose']       = 10;   //待关闭
$lang->apimeasure->problemStatusList['exception']     = 11;  //上线异常
$lang->apimeasure->problemStatusList['deleted']     = 12;  //已删除

$lang->apimeasure->delayStatusList[null]            = 0;        //空值
$lang->apimeasure->delayStatusList['toDepart']            = 1;   //部门负责人处理
$lang->apimeasure->delayStatusList['toManager']           = 2;  //分管领导处理
$lang->apimeasure->delayStatusList['success']             = 3;  //通过
$lang->apimeasure->delayStatusList['fail']                = 4;  //退回
