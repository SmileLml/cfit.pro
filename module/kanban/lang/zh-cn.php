...
$lang->kanban->recordEstimate      ='填报工时';
...
$lang->kanban->importExecution     = '计划阶段';
$lang->kanban->importBuild         = '版本';
$lang->kanban->importTicket        = '工单';
$lang->kanban->importTask          = '任务';
$lang->kanban->allKanban           = '所有看板';
$lang->kanban->allProjects         = '请选择项目';
...
$lang->kanban->editEstimate      = '编辑工时';
$lang->kanban->deleteEstimate    = '删除工时';
...
$lang->kanban->selectedTask    = '请选择项目';
...
$lang->kanban->importObjectList['executions'] = '计划阶段';
...
$lang->kanbancard->confirmDelete     = '您确认删除该卡片吗？';
...
$lang->kanban->execution = new stdclass();
$lang->kanban->execution->name     = '计划阶段';
$lang->kanban->execution->status      = '阶段状态';

$lang->kanban->emptyObject     = '『%s 』不能为空';
$lang->kanban->consumed               = '工作量（小时）';
$lang->kanban->noNumeric      = '『%s 』必须为数字';
$lang->kanban->consumedError   = '工作量错误，最多保留一位小数的正数';
$lang->kanban->selectKanbanSpace   = '选择看板空间';
$lang->kanban->selectSpace   = '选择空间';
$lang->kanban->selectKanban   = '选择看板';
$lang->kanban->historywork   = '历史工作量';
$lang->kanban->ID   = 'ID';
$lang->kanban->recordby = "填报人";
$lang->kanban->workDate = "报工日期";
$lang->kanban->demandcollectionID = "需求收集ID";
$lang->kanban->setCardType = "维护卡片类型";
$lang->kanban->cardType = "卡片类型";

$lang->kanbancard->allcard = '所有';
$lang->kanbancard->relatedToMe = '与我相关';
$lang->kanbancard->cardID = '卡片编号';