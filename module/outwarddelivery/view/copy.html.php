...
<div id="mainContent" class="main-content fade">
    <div class="center-block">
        <div class="main-header">
            <h2><?php echo $lang->outwarddelivery->copy;?></h2>
        </div>
                    ...
                    <div class="panel-body">
                        <table class="table table-form">
                            ...
                            <tr>
                                ...
                                <?php else:?>
                                    <td><?php echo html::select('secondorderId[]', $secondorderList, $outwarddelivery->secondorderId, "class='form-control chosen secondorderIdClass' multiple");?></td>
                                <?php endif;?>
                            ...
                            <tr>
                                ...
                                <?php else:?>
                                    <td><?php echo html::select('problemId[]', $problemList, $outwarddelivery->problemId, "class='form-control chosen problemIdClass' multiple");?></td>
                                <?php endif;?>
                                <!--关联需求 -->
                                ...
                                <?php else:?>
                                    <td><?php echo html::select('demandId[]', $demandList, $outwarddelivery->demandId, "class='form-control chosen demandIdClass' onchange='selectDemand()' multiple");?></td>
                                <?php endif;?>
                            </tr>
                            <tr>
                                <!--关联需求任务 -->
                    ...
                    <div class="panel-body">
                        <table class="table table-form">
                            ...
                            <tr>
                                ...
                                <td colspan="3" class="required">
                                    <?php echo html::textarea('changeImpactAnalysis', !empty($modifycncc)?$modifycncc->changeImpactAnalysis:'', "rows='5' placeholder='".$lang->modifycncc->changeImpactAnalysisTips."' class='form-control' maxlength='500'");?>
