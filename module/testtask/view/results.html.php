      ...
      <table class='table table-condensed table-hover' style='border: 1px solid #ddd; word-break:break-all'>
        ...
        <tr class='result-detail hide' id='tr-detail_<?php echo $trCount++; ?>'>
          <td colspan='7' class='pd-0'>
            ...
            <form data-params='<?php echo "applicationID=$case->applicationID&product=$case->product&branch=$case->branch&extras={$projectParam}caseID=$case->id,version=$case->version,resultID=$result->id,runID=$runID" . $params?>' method='post'>
              <table class='table table-condensed resultSteps'>
                ...
                <tbody>
                  ...
                  <tr class='step <?php echo $stepClass?>'>
                    ...
                    <td class='detail-content article-content'><?php echo $stepResult['real'];?></td>
