...
<div id='mainContent' class='main-row'>
    ...
    <div class='main-col'>
        ...
        <?php if(empty($reviewList)):?>
            <div class="cell">
                <div class='panel'>
                    <?php if(common::hasPriv('report', 'refreshReport')) echo html::a(inLink('refreshReport', array('method' => 'reviewFlowCostWorkload', 'projectID' => $projectID)), $lang->report->refreshReport, '', 'class="btn btn-primary btn-sm"');?>
                </div>
                ...
                <div class='panel'>
                    <div class="panel-heading">
                        ...
                        <nav class="panel-actions btn-toolbar">
                            <?php if(common::hasPriv('report', 'refreshReport')) echo html::a(inLink('refreshReport', array('method' => 'reviewFlowCostWorkload', 'projectID' => $projectID)), $lang->report->refreshReport, '', 'class="btn btn-primary btn-sm"');?>
                            <?php if(common::hasPriv('report', 'exportFlowCostWorkload')) echo html::a(inLink('exportFlowCostWorkload', array('projectID' => $projectID, 'param' => $param)), $lang->export, '', 'class="iframe btn btn-primary btn-sm"');?>
                        </nav>
                    </div>
                    <div data-ride='table' style="width:100%; height:500px; overflow:scroll;">
                        <table class='table table-condensed table-striped table-bordered table-fixed no-margin' id='programList'>
                            ...
                            <tr class='text-center'>
                                ...
                                <th class='w-100px text-left'><?php echo $lang->review->reviewDays;?></th>
                                <th class='w-100px text-left'><?php echo $lang->review->preReviewDays;?></th>
                            ...
                            <?php foreach($reviewList as $reviewID => $list):?>
                                <tr class="text-center">
                                    ...
                                    <td class='text-left'><?php echo $list->reviewDays;?></td>
                                    <td class='text-left'><?php echo $list->preReviewDays;?></td>
