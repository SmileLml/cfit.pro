  ...
  <div class="center-block">
    ...
    <form class="load-indicator main-form form-ajax" method="post" enctype="multipart/form-data" id="dataform">
      <table class="table table-form">
        <tbody>
          <tr>
              <th class='w-180px'><?php echo $lang->reviewissue->review;?></th>
              <td><?php echo html::select('review', $reviewPairs, $reviewID, 'class="form-control chosen"');?></td>
              <td>
                  <div class='input-group'>
                      <span class='input-group-addon'><?php echo $lang->reviewissue->type;?></span>
                      <?php echo html::select('type', $this->lang->reviewissue->typeList, $grade, 'class="form-control chosen"');?>
                  </div>
              </td>
          </tr>

          <tr>
              <th class='w-180px'><?php echo $lang->reviewissue->raiseBy;?></th>
              <td><?php echo html::select('raiseBy', $users, $this->app->user->account, 'class="form-control chosen"');?></td>
              <td>
                  <div class='input-group'>
                      <span class='input-group-addon'><?php echo $lang->reviewissue->raiseDate;?></span>
          ...
          <tr>
            ...
            <td colspan='2'><?php echo html::input('title', '', "class='form-control' placeholder='{$lang->reviewissue->titleTemplate}'");?></td>
         </tr>
