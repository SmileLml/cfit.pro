...
$lang->my->menu->work['subMenu']->audit  = array('link' => '評審|my|work|mode=audit&type=wait', 'subModule' => 'review');
...
$lang->waterfall->menu->execution   = array('link' => "階段|project|execution|status=all&projectID=%s");
...
$lang->waterfall->menu->design      = array('link' => "設計|design|browse|project=%s");
...
$lang->waterfall->menu->programplan['subMenu']->gantt = array('link' => '甘特圖|programplan|browse|projectID=%s&productID=0&type=gantt');
$lang->waterfall->menu->programplan['subMenu']->lists = array('link' => '階段列表|programplan|browse|projectID=%s&productID=0&type=lists', 'alias' => 'create');
...
$lang->waterfall->menu->auditplan['subMenu']->auditplan = array('link' => '質量保證計劃|auditplan|browse|project=%s', 'alias' => 'create,batchcreate,edit,batchcheck');
$lang->waterfall->menu->auditplan['subMenu']->nc        = array('link' => '不符合項|nc|browse|project=%s', 'alias' => 'edit,view');
...
$lang->waterfall->menu->design['subMenu']->hlds     = array('link' => '概要設計|design|browse|projectID=%s&productID=0&browseType=HLDS');
$lang->waterfall->menu->design['subMenu']->dds      = array('link' => '詳細設計|design|browse|projectID=%s&productID=0&browseType=DDS');
$lang->waterfall->menu->design['subMenu']->dbds     = array('link' => '資料庫設計|design|browse|projectID=%s&productID=0&browseType=DBDS');
$lang->waterfall->menu->design['subMenu']->ads      = array('link' => '介面設計|design|browse|projectID=%s&productID=0&browseType=ADS');
...
$lang->waterfall->menu->review['subMenu']->browse = array('link' => '基線評審列表|review|browse|project=%s', 'alias' => 'report,assess,audit,create,edit,view');
...
$lang->admin->menu->model['dropMenu']->allModel  = array('link' => '全局設置|custom|browsestoryconcept|', 'subModule' => 'subject,custom,');
...
$lang->admin->menu->waterfall['subMenu']->stage       = array('link' => '階段|stage|setType|', 'subModule' => 'stage');
...
$lang->admin->menu->waterfall['subMenu']->process     = array('link' => '過程|process|browse|', 'subModule' => ',activity,zoutput,classify,', 'alias' => 'create,view');
