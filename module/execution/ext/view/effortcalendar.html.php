...
<div id="mainMenu" class="clearfix">
  <div class="btn-toolbar pull-left">
    <?php echo html::a(inlink('effortcalendar', "executionID=$executionID"), "<span class='text'>{$lang->effort->common}</span>", '', "class='btn btn-link btn-active-text' id='calendarTab'");?>
    <?php if(common::hasPriv('execution', 'effort')):?>
