...
<div id='mainContent' class='main-content'>
  <div class='main-header'>
    <h2><?php echo $lang->requirement->exportTemplate;?></h2>
  </div>
  <form method='post' target='hiddenwin' onsubmit='setDownloading();' style='padding: 20px 5%'>
    <table class='table table-form'>
      <tr>
        <th class='w-120px'><?php echo $lang->requirement->num;?></th>
        ...
        <td><?php echo html::submitButton($this->lang->requirement->submitBtn, '', 'btn btn-primary');?></td>
      </tr>
    </table>
  </form>
</div>
