...
<div id="mainMenu" class="clearfix">
    <div class="btn-toolbar pull-left">
        ...
        if($task->parent > 0)
        {
            foreach($task->parentName as $parentID => $parentName)
            {
                echo html::a(inlink('view', "taskID={$parentID}"), $parentName) . ' / ';
            }
        }
        ?>
        <?php echo $task->name;?>
    ...
    <?php if(!isonlybody()):?>
        <div class="btn-toolbar pull-right">
            ...
            if(common::hasPriv('task', 'create', $checkObject) && (!$task->source || strpos($project->name,'DEP') !== false)) echo html::a($link, "<i class='icon icon-plus'></i> {$lang->task->create}", '', "class='btn btn-primary'" . $disabled);
            ?>
        </div>
    <?php endif;?>
</div>
<div id="mainContent" class="main-row">
    <div class="main-col col-8">
        <div class="cell">
            ...
            <?php if($execution->type != 'ops'):?>
                ...
                <?php elseif($task->story):?>
                    <div class="detail">
                        ...
                        <?php echo $this->fetch('file', 'printFiles', array('files' => $task->storyFiles, 'fieldset' => 'false', 'object' => null, 'canOperate' => empty($disabled)));?>
                    </div>
                    <div class='detail'>
                        ...
                        <table class='table table-hover table-fixed'>
                            ...
                            <?php foreach($task->children as $child):?>
                                <tr class='text-center'>
                                    ...
                                    <td class='c-actions'>
                                        <?php
                                       // common::printIcon('task', 'assignTo', "executionID=$child->execution&taskID=$child->id", $child, 'list', '', '', 'iframe showinonlybody', true, $disabled);
                                       // common::printIcon('task', 'start',    "taskID=$child->id", $child, 'list', '', '', 'iframe showinonlybody', true, $disabled);
                                       // common::printIcon('task', 'activate', "taskID=$child->id", $child, 'list', '', '', 'iframe showinonlybody', true, $disabled);
                                       // common::printIcon('task', 'close',    "taskID=$child->id", $child, 'list', '', '', 'iframe showinonlybody', true, $disabled);
                                       common::printIcon('task', 'finish',   "taskID=$child->id&flag=2", $child, 'list', '', '', 'iframe showinonlybody', true, $disabled);
                                       // common::printIcon('task', 'recordEstimate', "taskID=$child->id", $child, 'list', 'time', '', 'iframe showinonlybody', true, $disabled);
                                       // common::printIcon('task', 'edit', "taskID=$child->id", $child, 'list', '', '', '', '', $disabled);
                                       common::printIcon('task', 'editTask', "taskID=$child->id", $child, 'list', '', '', 'iframe showinonlybody', true, $disabled);
                                        ?>
                                    </td>
                                </tr>
                            <?php endforeach;?>
            ...
            <?php endif;?>
            <?php
            echo $this->fetch('file', 'printFiles', array('files' => $task->files, 'fieldset' => 'true', 'object' => $task, 'canOperate' => empty($disabled)));
        ...
        <?php if($demandOrProOrSecond):?>
        <?php if($demandOrProOrSecond['problem']):?>
        <div class="cell">
            <div class="detail-title"><?php echo $lang->task->problem;?></div>
            <div class="detail-content article-content ">
                <table class='table ' >
                    <thead>
                    <tr>
                        <th class='w-120px'><?php echo $lang->problem->code;?></th>
                        <th class='w-120px'><?php echo $lang->problem->desc;?></th>
                        <th class='thWidth'><?php echo $lang->problem->solution;?></th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php foreach($demandOrProOrSecond['problem'] as $problem):?>
                        <tr class='main'>
                            <td align='left' title='<?php echo $problem->code; ?>'><?php echo common::hasPriv('problem', 'view') ? html::a($this->createLink('problem','view', "problemID=$problem->id"), $problem->code) : $problem->code; ?></td>
                            <td align='left' style="word-break:break-all"><?php echo $problem->desc?></td>
                            <td align='left' style="word-break:break-all"><?php echo $problem->solution?></td>
                        </tr>
                    <?php endforeach;?>
                    </tbody>
                </table>
        ...
        <?php endif;?>
        <?php if($demandOrProOrSecond['demand']):?>
        <div class="cell">
            <div class="detail-title"><?php echo $lang->task->demand;?></div>
            <div class="detail-content article-content ">
                <table class='table  ' >
                    <thead>
                    <tr>
                        <th class='w-120px'><?php echo $lang->demand->code;?></th>
                        <th class='w-120px'><?php echo $lang->demand->reason;?></th>
                        <th class='thWidth'><?php echo $lang->demand->solution;?></th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php foreach($demandOrProOrSecond['demand'] as $demand):?>
                        <tr class='main'>
                            <td align='left' title='<?php echo $demand->code; ?>'><?php echo common::hasPriv('demand', 'view') ? html::a($this->createLink('demand','view', "demandID=$demand->id"), $demand->code) : $demand->code; ?></td>
                            <td align='left' style="word-break:break-all"><?php echo $demand->reason?></td>
                            <td align='left' style="word-break:break-all"><?php echo $demand->solution?></td>
                        </tr>
                    <?php endforeach;?>
                    </tbody>
                </table>
        ...
        <?php endif;?>
         <?php if($demandOrProOrSecond['second']):?>
        <div class="cell">
            <div class="detail-title"><?php echo $lang->task->second;?></div>
            <div class="detail-content article-content ">
                <table class='table ' >
                    <thead>
                    <tr>
                        <th class='w-120px'><?php echo $lang->secondorder->code;?></th>
                        <th class='w-120px'><?php echo $lang->secondorder->summary;?></th>
                        <th class='thWidth'><?php echo $lang->secondorder->type;?></th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php foreach($demandOrProOrSecond['second'] as $secondorder):?>
                        <tr class='main'>
                            <td align='left' title='<?php echo $secondorder->code; ?>'><?php echo common::hasPriv('secondorder', 'view') ? html::a($this->createLink('secondorder','view', "secondorderID=$secondorder->id"), $secondorder->code) : $secondorder->code; ?></td>
                            <td align='left' style="word-break:break-all"><?php echo $secondorder->summary?></td>
                            <td align='left' ><?php echo zget($lang->secondorder->typeList, $secondorder->type)?></td>
                        </tr>
                    <?php endforeach;?>
                    </tbody>
                </table>
        ...
        <?php endif;?>
            <?php if($demandOrProOrSecond['demandinside']):?>
                <div class="cell">
                    <div class="detail-title"><?php echo $lang->task->demandinside;?></div>
                    <div class="detail-content article-content ">
                        <table class='table ' >
                            <thead>
                            <tr>
                            ...
                            <tbody>
                            <?php foreach($demandOrProOrSecond['demandinside'] as $demandinside):?>
                                <tr class='main'>
                                    <td align='left' title='<?php echo $demandinside->code; ?>'><?php echo common::hasPriv('demandinside', 'view') ? html::a($this->createLink('demandinside','view', "demandinsideID=$demandinside->id")."#app=backlog", $demandinside->code,'','','') : $demandinside->code; ?></td>
                                    <td align='left' style="word-break:break-all"><?php echo $demandinside->reason?></td>
                                    <td align='left' ><?php echo $demandinside->solution?></td>
                                </tr>
                            <?php endforeach;?>
                            </tbody>
                        </table>
            ...
            <?php endif;?>
            <?php if($demandOrProOrSecond['deptorder']):?>
                <div class="cell">
                    <div class="detail-title"><?php echo $lang->task->deptorder;?></div>
                    <div class="detail-content article-content ">
                        <table class='table ' >
                            <thead>
                            <tr>
                            ...
                            <tbody>
                            <?php foreach($demandOrProOrSecond['deptorder'] as $deptorder):?>
                                <tr class='main'>
                                    <td align='left' title='<?php echo $deptorder->code; ?>'><?php echo common::hasPriv('deptorder', 'view') ? html::a($this->createLink('deptorder','view', "deptorderID=$deptorder->id"), $deptorder->code,'','','') : $deptorder->code; ?></td>
                                    <td align='left' style="word-break:break-all"><?php echo $deptorder->summary?></td>
                                    <td align='left' ><?php echo zget($this->lang->deptorder->typeList,$deptorder->type,'')?></td>
                                </tr>
                            <?php endforeach;?>
                            </tbody>
                        </table>
        ...
        <div class="cell">
            <div class="detail">
                <div class="detail-title"><?php echo $lang->task->historyEstimate;?></div>
                <div class="panel-body  scrollbar-hover detail-content article-content" style="height: 300px;">
                    <?php if(!$efforts): echo "<div class='text-center text-muted'>" . $lang->noData . '</div>';?>
                    <?php else:?>
                        <table class='table table-fixed ' >
                            <thead>
                            <tr>
                                 <th class='w-120px'><?php echo $lang->idAB;?></th>
                                 <th class='w-120px'><?php echo $lang->effort->date;?></th>
                                 <th class='w-120px'><?php echo $lang->task->recorder;?></th>
                                 <th class='w-250px' ><?php echo $lang->effort->work;?></th>
                                 <th class='thWidth'><?php echo $lang->effort->consumed;?></th>
                                 <th class='w-120px'><?php echo $lang->effort->createtime;?></th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php foreach($efforts as $effort):?>
                                <tr class='main'>
                                    <td align='left'><?php echo $effort->id;?></td>
                                    <td align='left'><?php echo $effort->date?></td>
                                    <td align='left'><?php echo zget($users, $effort->account);?></td>
                                    <td  style='word-wrap: break-word;word-break: break-all;white-space: normal' title='<?php echo $effort->work;?>'><?php echo $effort->work;?></td>
                                    <td align='left' title="<?php echo $effort->consumed . ' ' . $lang->effort->workHour;?>"><?php echo $effort->consumed . ' H'?></td>
                                    <td align='left'><?php echo $effort->realDate;?></td>
                                </tr>
                            <?php endforeach;?>
                            </tbody>
                        </table>
       ...
       <?php if($oldTask):?>
            <div class="cell">
                <div class="detail">
                    <div class="detail-title"><?php echo $oldTask['taskName'];?></div>
                    <div class="panel-body  scrollbar-hover detail-content article-content" style="height: 300px;">
                        <?php if(!$oldTask['effort']): echo "<div class='text-center text-muted'>" . $lang->noData . '</div>';?>
                        <?php else:?>
                            <table class='table table-fixed ' >
                                <thead>
                                <tr>
                                ...
                                <tbody>
                                <?php foreach($oldTask['effort'] as $effort):?>
                                    <tr class='main'>
                                        <td align='left'><?php echo $effort->id;?></td>
                                        <td align='left'><?php echo $effort->date?></td>
                                        <td align='left'><?php echo zget($users, $effort->account);?></td>
        ...
        <div class='main-actions'>
            <div class="btn-toolbar">
                ...
                <?php if(!$task->deleted and empty($disabled)):?>
                    <?php

                     if($task->source && $task->grade == '2'){
                    /* if(empty($task->children))
                     ...
                     if(empty($task->children) and $canRecordEstimate)
                     {
                         common::printIcon('task', 'finish',         "taskID=$task->id&flag =$flag", $task, 'button', '', '', 'iframe showinonlybody text-success', true);
                     ...
                     common::printIcon('task', 'create', "projctID={$task->execution}&storyID=0&moduleID=0&taskID=$task->id", $task, 'button', 'copy');*/
                      if($task->source && $task->dropType == 0){
                          //系统创建的任务不能删除
                          echo "<button type='button' class='disabled btn' style='pointer-events: unset;'><i class='icon-common-delete icon-trash' title=".$lang->task->delete."></i></button>\n";
 ...
 /*                        if(empty($task->team) or empty($task->children)) common::printIcon('task', 'batchCreate', "execution=$task->execution&storyID=$task->story&moduleID=$task->module&taskID=$task->id", $task, 'button', 'split', '', '', '', "title='{$lang->task->children}'", $lang->task->children);*/
                       ...
                       /*  if(empty($task->children))
                         ...
                         if(empty($task->children) and $canRecordEstimate)
                         {
                              common::printIcon('task', 'finish',         "taskID=$task->id&flag=2", $task, 'button', '', '', 'iframe showinonlybody text-success', true);
                             //common::printIcon('task', 'recordEstimate', "taskID=$task->id", $task, 'button', '', '', 'iframe showinonlybody', true);
                         }
                        ...
                        /* if(empty($task->children))
                         ...
                         common::printIcon('task', 'editTask', "taskID=$task->id", $task, 'button', 'edit', '', 'iframe','true');
                    ...
                    <div class='tab-pane active' id='legendBasic'>
                        <table class="table table-data">
                            ...
                            <tr>
                                ...
                                <td><?php if(!common::printLink($flag == '2'? 'newexecution' : 'execution', 'view', "executionID=$task->execution", $execution->name)) echo $execution->name;?></td>
                            </tr>
                            <tr>
                            ...
                            <?php if($execution->type != 'ops'):?>
                                <tr class='nofixed'>
                                    ...
                                    <td>
                                        ...
                                        if($task->storyTitle and !common::printLink('story', 'view', "storyID={$task->story}&version=0&param={$task->project}", $task->storyTitle, '', "class=$class data-width='80%'", true, true)) echo $task->storyTitle;
                                        if($task->needConfirm)
                                        {
                            ...
                            <tr>
                                <th><?php echo $lang->task->resourceTo;?></th>
                                <td>
                                    <?php
                                    $resourceList = explode(',', str_replace(' ', '', $task->resourceTo));
                                    ...
                                    {
                                        foreach($resourceList as $account) echo ' ' . zget($users, $account, $account);
                                    }
                                    ?>
                                </td>
                            </tr>
                ...
                <div class="detail-content">
                    <table class='table table-data'>
                        ...
                        <tr>
                            ...
                            <td><?php echo ($task->estimate - $task->consumed) . $lang->workingHour;?></td>
                        </tr>
                        <tr>
