...
<div id="mainContent" class="main-content fade">
    <div class="center-block">
        <div class="main-header">
            <h2><?php echo $lang->modify->reissueOrder;?></h2>
        </div>
...
<!--                                <td>--><?php //echo html::select('secondorderId[]', $secondorderList, $modify->secondorderId, "class='form-control chosen' multiple disabled");?><!--</td>-->
                                <td><?php echo html::select('secondorderId[]', [], [], "class='form-control chosen' multiple disabled");?></td>
                                ...
                                <td>
                                    <?php echo html::select('abnormalCode', $abnormalList, $modify->id, "class='form-control chosen ' disabled");?>
                            ...
                            <tr>
                                ...
                                <?php if((!empty($testingrequest) && $testingrequest->disable) || (!empty($productenroll) && $productenroll->disable)):?>
                                    <td><?php echo html::select('problemId[]', $problemSelectList, $modify->problemId, "class='form-control chosen problemIdClass' disabled multiple  disabled");?></td>
                                ...
                                <?php else:?>
<!--                                    <td>--><?php //echo html::select('problemId[]', $problemList, $modify->problemId, "class='form-control chosen problemIdClass' multiple disabled");?><!--</td>-->
                                    <td><?php echo html::select('problemId[]', [], [], "class='form-control chosen problemIdClass' multiple disabled");?></td>
                                <?php endif;?>
                                <!--关联需求 -->
                                <th class='w-100px'><?php echo $lang->modify->demandId;?></th>
<!--                                <td>--><?php //echo html::select('demandId[]', $demandList, $modify->demandId, "class='form-control chosen demandIdClass' onchange='selectDemand()' multiple disabled");?><!--</td>-->
                                <td><?php echo html::select('demandId[]', [], [], "class='form-control chosen demandIdClass' onchange='selectDemand()' multiple disabled");?></td>
                            </tr>
                            <tr>
                                <!--关联需求任务 -->
