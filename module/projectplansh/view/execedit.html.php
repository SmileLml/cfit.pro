...
<div id="mainContent" class="main-content fade">
    <div class="center-block">
        <div class="main-header">
            ...
            <?php  if(common::hasPriv('projectplan', 'editProjectDoc')){ ?>
                <a href="projectplan-editProjectDoc-<?php echo $plan->id;?>.html" class="btn btn-link "><span class="text">变更立项书</span></a>
            <?php } ?>
        </div>
        <form class="load-indicator main-form form-ajax" method='post' enctype='multipart/form-data' id='dataform' onsubmit="return checkTaskDate()">
            <table class="table table-form">
                ...
                <tr>
                    ...
                    <td><?php echo html::input('year', $plan->year, "class='form-control' maxlength='4'");?></td>
                    <td>
                ...
                <tr>
                    ...
                    <td colspan='2'><?php echo html::input('name', $plan->name, "class='form-control' maxlength='100'");?></td>
                </tr>
                <tr>
                    <th ><?php echo $lang->projectplan->insideStatus;?></th>
                    <td colspan='2'><?php echo html::select('insideStatus', $lang->projectplan->insideStatusList,$plan->insideStatus, "class='form-control chosen'");?></td>
                </tr>
                <!--<tr>
                    <th><?php /*echo $lang->projectplan->outsideProject;*/?></th>
                    <td colspan='2'><?php /*echo html::select('outsideProject[]', $outsideProject, $plan->outsideProject, "class='form-control chosen' multiple ");*/?></td>
                </tr>
                <tr>
                ...
                <tr>
                    <th><?php echo $lang->projectplan->outsideProject;?></th>
                    <td colspan='2'>
<!--                        --><?php //echo html::input('outsideProjectShow', $outsideNames, "class='form-control'  disabled='disabled' ");?>
                ...
                <tr>
                    <th><?php echo $lang->projectplan->outsideSubProject;?></th>
                    <td colspan='2'>
<!--                        --><?php //echo html::input('outsideSubProjectShow', $subOutsideNames,  "class='form-control '  disabled='disabled'  ");?>
                ...
                <tr>
                    ...
                    <td><?php echo html::select('basis[]', $lang->projectplan->basisList, $plan->basis, "class='form-control chosen' multiple");?></td>
                    <td>
                        <div class='input-group'>
                ...
                <tr>
                    ...
                    <td>  <?php echo html::select('app[]', $apps, $plan->app, "class='form-control chosen' multiple");?></td>
                ...
                <tr>
                    ...
                    <td><?php echo html::select('owner', $users, $plan->owner, "class='form-control chosen' ");?></td>
                    <td>
                        <div class='input-group'>
                ...
                <tr>
                    ...
                    <td>
                        <div class='input-group'>
                            <?php echo html::input('workload', $plan->workload, "placeholder = '自动计算' class='form-control' readonly onblur='totalWorkload(this)'");?>
                            <span class='input-group-addon'><?php echo $lang->projectplan->monthly;?></span>
                        </div>
                    </td>
                    <td>
                        <div class='input-group'>
                            ...
                            <?php echo html::input('duration', $plan->duration, "class='form-control' maxlength='100' readonly");?>
...
/*                        }
                ...
                <tr>
                    ...
                    <td colspan='2'><?php echo html::textarea('planRemark', $plan->planRemark ?? '', "class='form-control' maxlength='1000'");?></td>
                </tr>
                <tr>
