...
<tr>
    <td style='padding: 10px; border: none;'>
        <table cellpadding='0' cellspacing='0' style='width: 100%; border: 1px solid #e5e5e5; margin-bottom: 15px; border-collapse: collapse; font-size: 13px; text-align: left;'>
            ...
            <tr>
                <th class="infoName"><?php echo $this->lang->my->authorizedPerson;?></th>
                <td class="infoContent"><?php echo zmget($users,$authorization->authorizedPerson)?></td>
            </tr>
            <tr>
                <th class="infoName"><?php echo $this->lang->my->authorizerTerm;?></th>
                <td class="infoContent"><?php echo $authorization->authorizerTerm;?></td>
            </tr>
        </table>
    </td>
</tr>
