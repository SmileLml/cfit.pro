...
<div id="mainMenu" class="clearfix">
    <div class="btn-toolbar pull-left">
        <div class="page-title">
            <span class="text">需求条目-实施单位统计表</span>
        </div>
    </div>
</div>
                    ...
                    <table class='table table-condensed table-striped table-bordered table-fixed no-margin' id='productList'>
                        ...
                        foreach ($list as $id => $item) {
                            ...
                            <tr class="text-center">
                                ...
                                <td class="<?php echo $class;?>"><?php echo zget($depts, $id);?></td>
                                ...
                                <td class="<?php echo $class;?>"><?php echo $item->onlinesuccess; $totalOnline += $item->onlinesuccess; ?></td>
                                <td class="<?php echo $class;?>"><?php echo $total = ($item->wait + $item->delivery + $item->onlinesuccess); $totalAll += $total; ?></td>
                            </tr>
                        <?php } ?>
