...
$lang->testtask->oddNumber        = '测试单号';
/*$lang->testtask->problem          = '关联问题单';
$lang->testtask->requirement      = '关联需求条目';*/
$lang->testtask->problem       = '问题单';
$lang->testtask->requirement   = '需求条目';
$lang->testtask->secondorder   = '任务工单';
$lang->testtask->applicationID = '所属系统';
...
$lang->testtask->confirmUnlinkBug  = '确认解除测试单与实验室缺陷的关联关系？';
...
$lang->testtask->mailConf = '请进入【项目管理】-【测试】-【测试单】处理，具体信息如下：';

$lang->testtask->createdDate    = '发起时间';
$lang->testtask->productVersion = '产品版本';


// 搜索相关的标题
$lang->testtask->bySearch         = '搜索';
$lang->testtask->searchBuild      = '所属制版';
$lang->testtask->searchAssignedTo = '关联用例指派给';
$lang->testtask->searchLastRunner = '关联用例执行人';
