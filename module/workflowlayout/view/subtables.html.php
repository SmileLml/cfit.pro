  ...
  <div class='panel'>
    <table class='table table-layout child child-<?php echo $childModule;?>' data-module="<?php echo $childModule;?>">
      ...
      <tr class='<?php echo ($show ? '' : ' disabled');?>' data-fixed='<?php echo $fixed;?>' data-module='<?php echo $field->module;?>' data-field='<?php echo $field->field;?>' data-control='<?php echo $field->control;?>'>
        ...
        <?php if(!is_numeric($key) and $action->action != 'view'):?>
        <td class='w-160px'>
          <?php /* Layout rules. */ ?>
          <div class='input-group'>
        ...
        <td class='w-280px'>
          ...
          <div class='input-group'>
            ...
            ?>
            <span class='input-group-addon'><input type='checkbox' name="subTables[<?php echo $childModule;?>][custom][<?php echo $key;?>]" value='1' <?php echo "$checked $disabled";?>/> <?php echo $lang->workflowlayout->custom;?></span>
          </div>
        </td>
        <?php endif;?>
