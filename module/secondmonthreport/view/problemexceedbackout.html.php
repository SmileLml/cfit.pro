                            ...
                            <div class='btn-group'>
                                ...
                                <ul class="dropdown-menu  pull-right" id='exportActionMenu'>
                                    ...
                                    if($searchtype == 'history') {
                                        $class = common::hasPriv('secondmonthreport', 'problemExceedBackOutExport') ? '' : 'class=disabled';
                                        $misc  = common::hasPriv('secondmonthreport', 'problemExceedBackOutExport') ? "data-toggle='modal' data-type='iframe' class='export'" : 'class=disabled';
                                        $link  = common::hasPriv('secondmonthreport', 'problemExceedBackOutExport') ? $this->getExportFormUrl('problemExceedBackOutExport', $searchtype,$wholeID,$deptID,$realstarttime,$realendtime,$staticType,$isuseHisData) : '#';
                                        ...
                                        $class = common::hasPriv('secondmonthreport', 'problemExceedBackOutExport') ? '' : 'class=disabled';
                                        $misc  = common::hasPriv('secondmonthreport', 'problemExceedBackOutExport') ? "data-toggle='modal' data-type='iframe' class='export'" : 'class=disabled';
                                        $link  = common::hasPriv('secondmonthreport', 'problemExceedBackOutExport') ? $this->getExportFormUrl('problemExceedBackOutExport', $searchtype,0,$deptID,$realstarttime,$realendtime,$staticType,$isuseHisData) : '#';
                                        echo "<li {$class}>" . html::a($link, $lang->secondmonthreport->export, '', $misc) . '</li>';
                    ...
                    if ($detailReports) {
                        ...
                        <table class='table table-fixed has-sort-head table-bordered myformtable'>
                            ...
                            foreach ($detailReports as $key => $detailReport) {
                                ...
                                <tr>
                                    ...
                                    <td ><?php
                                        ...
                                        /*if( $detailReport->detail->foverdueNum > 0 ){
                                            echo html::a($this->createLink("secondmonthreport",'historyDataShow',"wholeID={$wholeID}&deptID={$detailReport->deptID}&columKey=foverdueNum",'',true),$detailReport->detail->foverdueNum,'_self',"class='btn btn-link iframe' data-size='fullscreen'");

                                        }else {
                                            echo $detailReport->detail->foverdueNum;
                                        }*/
                                    ...
                                    <td ><?php
                                        ...
                                        /*if ($detailReport->detail->backTotal > 0) {
                                            echo html::a($this->createLink("secondmonthreport", 'historyDataShow', "wholeID={$wholeID}&deptID={$detailReport->deptID}&columKey=backTotal", '', true), $detailReport->detail->backTotal, '_self', "class='btn btn-link iframe' data-size='fullscreen'");

                                        } else {
                                            echo $detailReport->detail->backTotal;
                                        }*/
                            ...
                            <tr>
                                ...
                                <td><?php  echo $this->getFormColumnFormat($foverdueNum,'foverdueNum',$searchtype,$wholeID,$deptID,$realstarttime,$realendtime,$staticType,$isuseHisData,$isshowdetaillist); ?></td>
                                <td><?php echo $this->getFormColumnFormat($backTotal,'backTotal',$searchtype,$wholeID,$deptID,$realstarttime,$realendtime,$staticType,$isuseHisData,$isshowdetaillist); ?></td>
