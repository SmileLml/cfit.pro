...
<?php js::set('fixedSortModule', $this->moduleName);?>
<script>
$(function()
{
    ...
    var addSettingButton = function()
    {
        ...
        if($btnToolbar.length > 0)
        {
            ...
            var fixedSortModules = ['testcase', 'caselib', 'bug', 'testsuite','testtask','testreport','project'];
            if (fixedSortModules.indexOf(fixedSortModule) > -1) $dropmenu.append("<li><a href='<?php echo $this->createLink('datatable', 'ajaxFixedSort', 'id=' . $this->moduleName . '&method=' . $this->methodName)?>' data-toggle='modal' data-type='ajax'><?php echo $lang->datatable->fixedSort?></a></li>");
