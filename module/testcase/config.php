...
$config->testcase->create->requiredFields = 'title,type,project';
$config->testcase->edit->requiredFields   = 'title,type,project';
...
$config->testcase->customBatchCreateFields = 'module,story,pri,precondition,keywords,stage,review';
$config->testcase->customBatchEditFields   = 'pri,status,precondition,keywords,stage';

$config->testcase->custom = new stdclass();
$config->testcase->custom->createFields      = $config->testcase->customCreateFields;
$config->testcase->custom->batchCreateFields = 'module,project';
$config->testcase->custom->batchEditFields   = 'pri,status,precondition,keywords,stage';
...
$config->testcase->search['fields']['project']        = $lang->testcase->project;
$config->testcase->search['fields']['stage']          = $lang->testcase->stage;
$config->testcase->search['fields']['module']         = $lang->testcase->module;
$config->testcase->search['fields']['linkTesttask']   = $lang->testcase->linkTesttask;
...
$config->testcase->search['params']['linkTesttask'] = array('operator' => '=',       'control' => 'select', 'values' => '');
...
$config->testcase->search['params']['project']      = array('operator' => '=',       'control' => 'select', 'values' => '');
...
$config->testcase->datatable->defaultField = array('id', 'pri', 'title', 'product', 'project', 'type', 'openedBy', 'lastRunner', 'lastRunDate', 'lastRunResult', 'status', 'bugs', 'results', 'stepNumber', 'actions');
...
$config->testcase->datatable->fieldList['pri']['title']    = 'pri';
$config->testcase->datatable->fieldList['pri']['fixed']    = 'left';
$config->testcase->datatable->fieldList['pri']['width']    = '70';
$config->testcase->datatable->fieldList['pri']['required'] = 'yes';
...
$config->testcase->datatable->fieldList['product']['fixed']    = 'left';
$config->testcase->datatable->fieldList['product']['width']    = '120';
$config->testcase->datatable->fieldList['product']['required'] = 'no';

$config->testcase->datatable->fieldList['project']['title']    = 'project';
$config->testcase->datatable->fieldList['project']['fixed']    = 'left';
$config->testcase->datatable->fieldList['project']['width']    = '120';
$config->testcase->datatable->fieldList['project']['required'] = 'no';
...
$config->testcase->datatable->fieldList['bugs']['sort']     = 'yes';
...
$config->testcase->datatable->fieldList['results']['sort']     = 'yes';
...
$config->testcase->datatable->fieldList['stepNumber']['sort']     = 'yes';
