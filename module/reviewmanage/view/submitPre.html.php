<form class="load-indicator main-form form-ajax" method='post' enctype='multipart/form-data' id='dataform'>
    <table class='table table-form'>
        <tr>
            <th class='w-120px'><?php echo $lang->review->qa;?></th>
            <td class='w-p45-f'><?php echo html::select('qa', $users, $review->qa, "class='form-control chosen'");?></td><td></td>
        </tr>
        <tr class='hidden'>
            <th><?php echo $lang->review->preReviewDeadline;?></th>
            <td>
                <?php echo html::input('preReviewDeadline', $review->preReviewDeadline != '0000-00-00' ? $review->preReviewDeadline:'', "class='form-date form-control' ");?>
            </td>
            <td></td>
        </tr>
