    ...
    <div class='main-header'>
      <h2>
        ...
        <?php echo "<span title='$issue->title'>" . $issue->title . '</span>';?>
          <small><?php echo $lang->arrow.$lang->issue->activateTitle ;?></small>
      </div>
    </div>
    <div class="modal-body" style="min-height: 310px; overflow: auto;">
      <form method='post' enctype='multipart/form-data' target='hiddenwin'>
        <table class='table table-form'>
          <tr>
            <th><?php echo $lang->issue->assignedTo;?></th>
            <td colspan='2'><?php echo html::select('assignedTo', $assignUsers, '', 'class="form-control chosen"');?></td>
          </tr>
          <tr>
