...
$config->kanban->fromType         = array('execution','demandcollection');
...
$config->kanban->demandcollectionField       = array('title','priority','assignFor','belongModel');
...
$config->kanban->search['module']                     = 'kanban';
$config->kanban->search['fields']['name']             = $lang->kanbancard->name;
$config->kanban->search['fields']['fromID']   = $lang->kanban->demandcollectionID;
$config->kanban->search['fields']['id']         = $lang->kanbancard->cardID;
$config->kanban->search['fields']['type']         = $lang->kanban->cardType;
$config->kanban->search['fields']['desc']         = $lang->kanbancard->desc;
$config->kanban->search['fields']['assignedTo']         = $lang->kanbancard->assignedTo;


$config->kanban->search['params']['name']         = array('operator' => '=','control' => 'input',  'values' => '');
$config->kanban->search['params']['fromID']     = array('operator' => '=','control' => 'input',  'values' => '');
$config->kanban->search['params']['id']           = array('operator' => '=','control' => 'input',  'values' => '');
$config->kanban->search['params']['type']           = array('operator' => '=','control' => 'select',  'values' => '');
$config->kanban->search['params']['desc']           = array('operator' => '=','control' => 'input',  'values' => '');
$config->kanban->search['params']['assignedTo']           = array('operator' => '=','control' => 'select',  'values' => '');
