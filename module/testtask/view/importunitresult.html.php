    ...
    <form method='post' target='hiddenwin' id='dataform' enctype='multipart/form-data'>
      <table class='table table-form'>
        <tr>
          ...
          <td class='w-p35-f'><?php echo html::select('product', $products, $productID, "class='form-control chosen' onchange='loadProductBuilds(this.value)'");?></td><td></td>
        </tr>
        <tr>
          <th class='w-80px'><?php echo $lang->testtask->project;?></th>
          <td class='w-p35-f'><?php echo html::select('project', $projects, $projectID, "class='form-control chosen'");?></td><td></td>
        </tr>
        <tr>
        ...
        <tr>
          <td class='text-center form-actions' colspan='3'>
            <?php
            echo html::hidden('applicationID', $applicationID);
            ?>
