<form class="load-indicator main-form form-ajax" method='post' enctype='multipart/form-data' id='changereview'>
    <table class="table table-form">
        ...
        <tr>
            <th></th>
            <td style="color:red" colspan='3'><?php echo $lang->projectrelease->notice;?></td>
        </tr>
        <tr>
        ...
        <?php endif;?>
            ...
            <tr>
                ...
                <td colspan='3'><?php echo html::textarea('comment', '', "class='form-control' placeholder=' ".htmlspecialchars($lang->projectrelease->commentTip)."'");?></td>
            </tr>
