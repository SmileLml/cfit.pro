            ...
            <form class='main-table' id='projectplanForm'   method='post' data-ride='table' data-nested='true'
                ...
                <table class='table table-fixed has-sort-head' id='projectplans'>
                    ...
                    <tr>
                        ...
                        <th style="width: 120px"><?php echo $lang->secondmonthdata->problemlang->code; ?></th>
                        <th class='w-80px'><?php echo $lang->secondmonthdata->problemlang->status; ?></th>
                        <th class='w-80px'><?php echo $lang->secondmonthdata->problemlang->app; ?></th>
                        <th class='w-120px'><?php echo $lang->secondmonthdata->problemlang->abstract; ?></th>
                        <th class='w-110px'> <?php echo $lang->secondmonthdata->problemlang->dealAssigned; ?></th>
                        <th class='w-110px'><?php echo $lang->secondmonthdata->problemlang->solvedTime; ?></th>
                        <th class='w-80px'><?php echo $lang->secondmonthdata->problemlang->acceptDept; ?></th>
                        <th class='w-80px'><?php echo $lang->secondmonthdata->problemlang->acceptUser; ?></th>
                        <th class='w-100px'> <?php echo $lang->secondmonthdata->problemlang->source; ?></th>
                        <th class='w-100px'><?php echo $lang->secondmonthdata->problemlang->type; ?></th>
                    ...
                    <?php foreach ($dataList as $data): ?>
                        <tr>
                            ...
                            <td class='text-ellipsis' >  <?php echo zget($lang->problem->statusList, $data->status); ?>  </td>
                            <?php
                            $as = [];
                            ...
                            <td title='<?php echo $data->abstract; ?>' class='text-ellipsis'><?php echo $data->abstract; ?></td>
                            <td><?php echo $data->dealAssigned; ?></td>
                            ...
                            <td class='text-ellipsis' >
                                <?php echo zget($lang->problem->sourceList, $data->source); ?>
                            </td>
                            <td class='text-ellipsis' >
                                <?php echo zget($lang->problem->typeList, $data->type); ?>
                            </td>
