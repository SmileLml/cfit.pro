...
<?php else:?>
    <div id="mainContent" class="main-content">
        <div class="main-header clearfix">
            <h2><?php echo $lang->demandinside->import;?></h2>
        </div>
        <form class='main-form' target='hiddenwin' method='post' style='overflow-x:auto'>
            <table class='table table-form' id='showData'>
                <thead>
                <tr>
                    <th class='w-60px'><?php echo $lang->demandinside->id?></th>
                    <th class='w-200px required'><?php echo $lang->demandinside->title?></th>
                    <th class='w-200px required'><?php echo $lang->demandinside->requirementID?></th>
                    <th class='w-200px required'><?php echo $lang->demandinside->opinionID?></th>
                    <th class='w-200px required'><?php echo $lang->demandinside->desc?></th>
                    <th class='w-200px required'><?php echo $lang->demandinside->endDate?></th>
                    <!-- <th class='w-200px required'><?php echo $lang->demandinside->acceptDept?></th> -->
                    <th class='w-200px required'><?php echo $lang->demandinside->acceptUser?></th>
                    <th class='w-200px required'><?php echo $lang->demandinside->createdBy?></th>
                    <th class='w-200px required'><?php echo $lang->demandinside->dealUser?></th>
                    <th class='w-200px required'><?php echo $lang->demandinside->app?></th>
                    <th class='w-200px required'><?php echo $lang->demandinside->fixType?></th>
                    <th class='w-200px required'><?php echo $lang->demandinside->product?></th>
                    <th class='w-200px'><?php echo $lang->demandinside->productPlan?></th>
                    <th class='w-200px required'><?php echo $lang->demandinside->status?></th>
                    <th class='w-200px'><?php echo $lang->demandinside->actualOnlineDate?></th>
                    <th class='w-200px'><?php echo $lang->demandinside->comment?></th>
                </tr>
                </thead>
                <tbody>
                <?php
                ...
                <?php foreach($demandData as $key => $demand):?>
                    <tr class='text-top'>
                        <td>
                            <?php
                            $key = $key-1;
                            echo $i++ . " <sub style='vertical-align:sub;color:gray'>{$lang->demandinside->new}</sub>";
                            ?>
                        ...
                        <td><?php echo html::select("fixType[$key]", $this->lang->demandinside->fixTypeList,$demand->fixType, "class='form-control chosen'")?></td>
                        ...
                        <td><?php echo html::select("status[$key]", $this->lang->demandinside->statusList,$demand->status, "class='form-control chosen'")?></td>
