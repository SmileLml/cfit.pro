...
<div id='mainContent' class='main-row fade'>
  <div class='main-col'>
    <?php if(!empty($whitelist)):?>
        <?php $vars = "objectID=$objectID&module=$module&objectType=$objectType&orderBy=%s&recTotal=$pager->recTotal&recPerPage=$pager->recPerPage&pageID=$pager->pageID&programID=$programID&from=$from";?>
        <form class='main-table table-user' action='' method='post' id='userListForm'>
          ...
          <th class='w-140px'><?php common::printOrderLink('account', $orderBy, $vars, $lang->user->realname);?></th>
          ...
          <th class="w-200px"><?php echo $lang->user->email;?></th>
            <?php if($objectType == 'project'):?>
                <th class="w-120px"><?php echo $lang->project->whiteListReason;?></th>
            <?php endif;?>
         ...
         <?php foreach($whitelist as $user):?>
            <tr>
                ...
                <td>
                    ...
                    <?php echo zget($lang->project->whiteListReasonList, $user->reason) ;?>
                    <?php if($user->subObjectID):?>
                        [<?php echo $user->subObjectID;?>]
                    <?php endif;?>
