...
<div id="mainContent" class="main-content fade">
  <div class="center-block">
    <div class="main-header">
      <h2><?php echo $action == 'gain' ? $lang->infoqz->gainApply : $lang->infoqz->fixApply;?></h2>
    </div>
      ...
      <table class="table table-form">
        <tbody>
          <tr>
              ...
              <td><?php echo html::select('type', $lang->infoqz->typeList, '', "class='form-control chosen'");?></td>
              <td>
                  <div class='input-group'>
                      <span class='input-group-addon'><?php echo $lang->infoqz->classify;?></span>
                      <?php echo html::select('classify[]', $lang->infoqz->techList, '', "class='form-control chosen' multiple");?>
                  </div>
              </td>
          </tr>
          <!-- 需求收集4653         -->
          <tr>
              ...
              <td class="required"><?php echo html::select('dataCollectApplyCompany', $lang->infoqz->demandUnitTypeList, '1', "class='form-control chosen' onchange='selectCompany()'");?></td>
              <td class="required">
                  <div class='input-group companySelect'>
                      ...
                      <?php echo html::select('demandUnitOrDepSelect[]', $lang->infoqz->demandUnitList1, '', "class='form-control chosen' multiple");?>
                  </div>
                  <div class='input-group companyInput hidden'>
                      <span class='input-group-addon'><?php echo $lang->infoqz->demandUnitOrDep;?><i title="<?php echo $lang->infoqz->companyTips;?>" class="icon icon-help"></i></span>
                      <?php echo html::input('demandUnitOrDepInput', '', "class='form-control'");?>
                  </div>
              </td>
          </tr>
          <!-- 需求人、需求电话 -->
          <tr>
              ...
              <td class="required"><?php echo html::input('demandUser', '', "class='form-control'");?></td>
              <td class="required">
                  <div class='input-group'>
                      <span class='input-group-addon'><?php echo $lang->infoqz->demandUserPhone;?></span>
                      <?php echo html::input('demandUserPhone', '', "class='form-control'");?>
                  </div>
              </td>
          </tr>
          <!-- 需求人邮箱 -->
          <tr>
              ...
              <td class="required" colspan="2"><input type="email" name="demandUserEmail" class="form-control"></td>
          </tr>
          <!-- 接口人、接口人电话 -->
          <tr>
              <th class='w-140px'><?php echo $lang->infoqz->portUser;?></th>
              <td class="required"><?php echo html::input('portUser', $lang->infoqz->portList['portUser'], "class='form-control'");?></td>
              <td class="required">
                  <div class='input-group'>
                      <span class='input-group-addon'><?php echo $lang->infoqz->portUserPhone;?></span>
                      <?php echo html::input('portUserPhone', $lang->infoqz->portList['portUserPhone'], "class='form-control'");?>
                  </div>
              </td>
          </tr>
          <!-- 接口人邮箱 -->
          <tr>
              ...
              <td class="required" colspan="2"><input type="email" name="portUserEmail" value="<?php echo $lang->infoqz->portList['portUserEmail']?>" class="form-control"></td>
          </tr>
          <!-- 支持人、支持电话 -->
          <tr>
              <th class='w-140px'><?php echo $lang->infoqz->supportUser;?></th>
              <td class="required"><?php echo html::input('supportUser', '', "class='form-control'");?></td>
              <td class="required">
                  <div class='input-group'>
                      <span class='input-group-addon'><?php echo $lang->infoqz->supportUserPhone;?></span>
                      <?php echo html::input('supportUserPhone', '', "class='form-control'");?>
                  </div>
              </td>
          </tr>
          <!-- 支持人邮箱 -->
          <tr>
              ...
              <td class="required" colspan="2"><input type="email" name="supportUserEmail" class="form-control"></td>
          </tr>
          <tr>
              <th class='w-140px'><?php echo $lang->infoqz->isNPC;?></th>
              <td><?php echo html::select('isNPC', $lang->infoqz->isNPCList, '', "class='form-control chosen'");?></td>
              <td>
                  <div class='input-group'>
                      <span class='input-group-addon'><?php echo $action == 'gain' ? $lang->infoqz->gainNode : $lang->infoqz->fixNode;?></span>
                      <?php echo html::select('node[]', $this->lang->infoqz->gainNodeNPCList + $this->lang->infoqz->gainNodeCNCCList, '', "class='form-control chosen' multiple");?>
                  </div>
              </td>
          </tr>
          <?php if($action == 'gain'):?>
              <tr>
                ...
                <td><?php echo html::select('gainType', $lang->infoqz->gainTypeList, '', "class='form-control chosen' ");?></td>
                <td>
                    <div class='input-group'>
                        <span class='input-group-addon'><?php echo $lang->infoqz->createUserPhone;?></span>
                        <?php echo html::input('createUserPhone', '', "class='form-control'");?>
                    </div>
                </td>
              </tr>
          <?php endif;?>
          <tr>
              ...
              <td  class="required">
                  <div class='input-group'>
                      ...
                      <?php echo html::input('planEnd', '', "class='form-control form-datetime'");?>
                  </div>
              </td>
          </tr>
          <tr>
              <th class='w-140px'><?php echo $lang->infoqz->isTest;?></th>
              <td><?php echo html::select('isTest', $lang->infoqz->isTestList, '', "class='form-control chosen'");?></td>
              <td>
                  <div class='input-group'>
                      <span class='input-group-addon'><?php echo $lang->infoqz->systemType;?></span>
                      <?php echo html::select('systemType', $lang->infoqz->systemTypeList, '', "class='form-control chosen'");?>
                  </div>
              </td>
          </tr>
          <tr>
              ...
              <td class="required">
                  <div class='input-group'>
                      ...
                      <?php echo html::select('dataSystem[]', $apps, '', "class='form-control chosen' multiple");?>
                  </div>
              </td>
          </tr>
          ...
          <tr>
              ...
              <td><?php echo html::select('fixType', $lang->infoqz->fixTypeList, '', "class='form-control chosen'");?></td>
              <td>
                  <div class='input-group'>
                      <span class='input-group-addon'><?php echo $lang->infoqz->project;?></span>
                      <?php echo html::select('project[]', $projects, '', "class='form-control chosen' multiple");?>
                  </div>
              </td>
          </tr>
          <tr>
          ...
          <tr>
              ...
              <td colspan='2'><?php echo html::select('secondorderId[]', $secondorders, '', "class='form-control chosen' multiple");?></td>
          </tr>
          <tr>
<!--              <th class='w-140px'>--><?php //echo $lang->infoqz->isTest;?><!--</th>-->
<!--              <td colspan='2'>--><?php //echo html::select('isTest', $lang->infoqz->isTestList, '', "class='form-control chosen'");?><!--</td>-->
              <!--<td>
                  <div class='input-group'>
          ...
          <tr>
              ...
              <td colspan='2'><?php echo html::input('desc', '', "class='form-control' maxlength='200'");?></td>
          </tr>
          <tr>
              <th><?php echo $action == 'gain' ? $lang->infoqz->gainReason : $lang->infoqz->fixReason;?></th>
              <td colspan='2'><?php echo html::textarea('reason', '', "class='form-control' rows='5' maxlength='2000'");?></td>
          </tr>
          <?php if($action == 'gain'):?>
              <tr>
                  <th><?php echo $lang->infoqz->gainPurpose;?></th>
                  <td colspan='2'><?php echo html::textarea('purpose', '', "class='form-control' rows='5' maxlength='2000'");?></td>
              </tr>
          <?php endif;?>

          <tr>
              <th><?php echo $lang->infoqz->test;?></th>
              <td colspan='2'><?php echo html::textarea('test', '', "class='form-control' rows='5' maxlength='1000'");?></td>

          </tr>
          <tr>
              <th><?php echo $lang->infoqz->content;?></th>
              <td colspan='2'><?php echo html::textarea('content', '', "class='form-control' rows='5'");?></td>
          </tr>
          <tr>
              <th><?php echo $lang->infoqz->operation;?></th>
              <td colspan='2'><?php echo html::textarea('operation', '', "class='form-control' rows='5' maxlength='1000'");?></td>
          </tr>

          <tr>
              <th><?php echo $action == 'gain' ? $lang->infoqz->gainStep : $lang->infoqz->fixStep;?></th>
              <td colspan='2'><?php echo html::textarea('step', '', "class='form-control' rows='5' maxlength='1000'");?></td>
          </tr>

          <tr>
              <th><?php echo $lang->infoqz->desensitization;?></th>
              <td colspan='2'><?php echo html::textarea('desensitization', '', "class='form-control' rows='5'");?></td>
          </tr>
          <tr>
              <th><?php echo $lang->infoqz->checkList;?></th>
              <td colspan='2'><?php echo html::textarea('checkList', '', "class='form-control' rows='5' ");?></td>
          </tr>
          <tr>
            <th class='w-140px'><?php echo $lang->infoqz->isJinke ?></th>
            <td class='required'><?php echo html::select('isJinke', $lang->infoqz->isJinkeList, '', "class='form-control chosen'");?></td>
          </tr>
          <tr class='isJinke-tr'>
            <th class='w-140px'><?php echo $lang->infoqz->desensitizationType ?></th>
            <td class='required'><?php echo html::select('desensitizationType', $lang->infoqz->desensitizationTypeList, '', "class='form-control chosen' onchange='setDesensitizationType(this.value)'");?></td>
          </tr>
          <tr class='isJinke-tr'>
            <th class='w-140px'><?php echo $lang->infoqz->deadline; ?></th>
            <td class='required' style="display:flex;align-items:center">
                <span><?php echo html::radio('isDeadline', $lang->infoqz->isDeadlineList,1, "onclick='setDeadline(this.value)'");?></span>
          ...
          <tr>
              ...
              <td class='required'><?php echo html::radio('isDesensitize', $lang->infoqz->aclList, 0, "onclick='setWhite(this.value);' disabled");?></td>
          </tr>
          <tr id="whitelistBox" class="hidden">
              <th><?php echo $lang->infoqz->desensitizeProcess;?></th>
              <td class="required" colspan='2'><?php echo html::textarea('desensitizeProcess', '', "class='form-control' rows='5' ");?></td>
          </tr>
          <tr class="nodes">
              <th class='w-140px'>
