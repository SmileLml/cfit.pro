    ...
    <form class='main-form form-ajax' method='post' enctype='multipart/form-data' id='dataform'>
      <table class='table table-form'>
        ...
        <tr>
          ...
          <td><?php echo html::select('parent', array($task->id => $task->name), $task->id, "class='form-control chosen' required");?></td><td></td><td></td>
        </tr>
        <?php endif;?>
        <tr>
        ...
        <?php if(strpos(",$showFields,", ',resourceTo,') !== false):?>
        <tr>
          <th><?php echo $lang->task->resourceTo;?></th>
          <td><?php echo html::select('resourceTo[]', $members, '', "class='form-control chosen' multiple");?></td>
        </tr>
          <?php endif;?>
        <tr class='hide'>
        ...
        <tr>
          ...
          <td colspan='3'>
            <span id='storyBox' class="<?php if(!empty($stories)) echo 'hidden';?> "><?php printf($lang->task->noticeLinkStory, html::a($this->createLink('projectstory', 'story', "projectID={$this->session->project}"), $lang->execution->linkStory, '_blank', 'class="text-primary"'), html::a("javascript:loadStories($execution->id)", $lang->refresh, '', 'class="text-primary"'));?></span>
          ...
          <td colspan='3'>
            <div class="input-group title-group">
              <div class="input-control has-icon-right">
                ...
                <?php echo html::input('name', '', "maxlength = '80' class='form-control' required");?>
        ...
        <tr>
          ...
          <td><span style='color:#838a9d;'><?php echo $lang->task->taskDurationError;?></span></td>
        </tr>
        <?php endif;?>
...
<?php js::set('showfiled', in_array('story',explode(',',$showFields)));?>
<?php js::set('showdesign', in_array('design',explode(',',$showFields)));?>
<script>
