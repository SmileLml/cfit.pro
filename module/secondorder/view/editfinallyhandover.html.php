...
<div id="mainContent" class="main-content fade">
  <div class="center-block">
    <div class="main-header">
      <h2><?php echo $this->lang->secondorder->editFinallyHandOver  ;?></h2>
    </div>
      ...
      <table class="table table-form">
        <tbody>
          <tr>
            ...
            <td><?php echo html::select('finallyHandOver', $this->lang->sectransfer->finallyHandOverList, $secondorder->finallyHandOver, "class='form-control chosen'");?></td>
          </tr>
          <tr>
