...
$lang->milestone->executionCost   = 'Project Cost';
...
$lang->milestone->executionRisk     = '5.Project Risks (top five highest priority risks)';
...
$lang->milestone->predictedValueDesc = 'Rentenformel (Germany)：If the execution progress performance(SPI)=0,So the predicted value=0,Otherwise,Predicted value=Planned value divided by Project schedule performance(SPI)';
...
$lang->milestone->chart->title    = 'Trend Chart of execution progress to date';
