  ...
  <div class="main-col col-8">
    <div class="cell">
      ...
      <?php if(!empty($work)):?>
          <div class="cell">
              <div class="detail">
                  <div class="detail-title"><?php echo $lang->kanban->historywork; ?></div>
                  <div class="detail-content article-content">
                      <table class="table ops" style="text-align: center">
                          <tr>
                              <th class="w-100px" style="text-align: center"><?php echo $lang->kanban->ID; ?></th>
                              <th class="w-100px" style="text-align: center"><?php echo $lang->kanban->workDate; ?></th>
                              <th class="w-100px" style="text-align: center"><?php echo $lang->kanban->recordby; ?></th>
                              <th class="w-200px" style="text-align: center"><?php echo $lang->effort->work;?></th>
                              <th class="w-80px" style="text-align: center"><?php echo $lang->effort->consumed;?></th>
                          </tr>
                          <?php ;
                          foreach ($work as $val): ?>
                              <tr>
                                  ...
                                  <td><?php echo $users[$val->account]?></td>
                                  <td><?php echo $val->work?></td>
                                  <td><?php echo $val->consumed.'h';?></td>
                              </tr>
                          <?php endforeach; ?>
                      </table>
                  </div>
          ...
          <div class='tab-pane active' id='basicInfo'>
            <table class="table table-data">
              <tbody>
                ...
                <tr>
                    <th><?php echo $lang->kanbancard->consumed;?></th>
                    <td><?php echo round($card->consumed, 2) . ' ' . $lang->kanbancard->lblHour;?></td>
                </tr>
                <?php if($card->fromType == 'demandcollection'):?>
                    <tr>
                        <th><?php echo $lang->kanban->demandcollectionID;?></th>
                        <td><?php echo $card->fromID;?></td>
                    </tr>
                <?php endif;?>
                <tr>
                    <th><?php echo $lang->kanban->cardType;?></th>
                    <td><?php echo $type[$card->type];?></td>
                </tr>
