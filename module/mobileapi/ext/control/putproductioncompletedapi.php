...
class myMobileApi extends mobileapi
{
     ...
     * 金信-生产变更已办列表
     */
    public function putproductionCompletedApi()
    {
        ...
        $modifys = $this->loadModel('putproduction')->getCompletedListApi($pager,$search);
        ...
        $this->loadModel('mobileapi')->response('success', '', $data ,  0, 200,'putproductionCompletedApi');
    }
}
