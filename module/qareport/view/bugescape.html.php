  ...
  <div class='main-col'>
    <div class='cell'>
      <div class="with-padding">
        <form action='<?php echo $this->createLink('qareport', 'bugescape', "queryType=search&recTotal=$pager->recTotal&recPerPage=$pager->recPerPage&pageID=$pager->pageID");?>' method='post'>
      ...
      <div class='panel'>
        <div class="panel-heading">
          ...
          <nav class="panel-actions btn-toolbar" style="z-index: 1;">
            <?php if(common::hasPriv('report', 'exportBugEscape')) echo html::a($this->createLink('report', 'exportBugEscape', array()), $lang->export, '', 'class="iframe btn btn-primary btn-sm"');?>
          </nav>
        </div>
        <div data-ride='table'>
