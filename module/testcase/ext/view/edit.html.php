...
<?php js::set('changeApplicationConfirmed', false);?>
<?php js::set('confirmChangeApplication', $lang->testcase->confirmChangeApplication);?>
<?php js::set('oldApplicationID', $case->applicationID);?>
<style>
    ...
    <div class='main-row'>
      <div class='main-col col-8'>
        <div class='cell'>
         ...
         <div class='detail'>
            <div class='detail-title'><?php echo $lang->testcase->categories;?></div>
            <div class="detail-content">
              <div class="input-control has-icon-right">
              <?php echo html::checkbox('categories', array_filter($lang->testcase->categoryList), $case->categories);?>
              </div>
            </div>
          </div>  
          <div class='detail'>
          ...
          <div class='detail'>
            ...
            <div class='detail-content'><?php echo html::textarea('intro', $case->intro, "rows='2' class='form-control'");?></div>
          </div>
        ...
        <div class='cell'>
          <div class='detail'>
            ...
            <table class='table table-form' cellpadding='0' cellspacing='0'>
              ...
              <?php else:?>
              <tr>
                <th class='w-100px'><?php echo $lang->testcase->applicationID;?></th>
                <td>
                  <div class='input-group'>
                    <?php echo html::select('applicationID', $applicationList, $case->applicationID, "onchange='ajaxGetProductByApplication(this.value)' class='form-control chosen'");?>
                  </div>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <th><?php echo $lang->testcase->project;?></th>
                <td class='text-left'><div><?php echo html::select('project', $projects, $case->project, 'class="form-control chosen" onchange="getProjectExecutions(this.value)"');?></div>
                </td>
              </tr>
              <tr>
                <th><?php echo $lang->testcase->execution;?></th>
                <td class='text-left'><div><?php echo html::select('execution', $executions, $case->execution, 'class="form-control chosen"');?></div>
                </td>
              </tr>
              <tr>
                <th><?php echo $lang->testcase->module;?></th>
