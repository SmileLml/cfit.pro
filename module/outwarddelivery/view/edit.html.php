...
js::set('partitionIndex', empty($modifycncc)||empty($modifycncc->appWithPartition)? 0 : count($modifycncc->appWithPartition)-1);
...
js::set('propertyOld', empty($modifycncc)? '': $modifycncc->property);
js::set('productInfoCodeOld', $outwarddelivery->productInfoCode);
js::set('isFirst', true);
...
$isDisable = "";
if((!empty($testingrequest) && $testingrequest->disable) || (!empty($productenroll) && $productenroll->disable)){
    $isDisable = "disabled";
}
js::set('isDisable', $isDisable);
?>
<style>
...
<div id="mainContent" class="main-content fade">
    <div class="center-block">
        <div class="main-header">
            <h2><?php echo $lang->outwarddelivery->edit;?></h2>
        </div>
            ...
            <table class="table table-form">
                <tbody>
                    <tr>
                        ...
                        <?php if((!empty($testingrequest) && !empty($testingrequest->giteeId)) || (!empty($productenroll) && !empty($productenroll->giteeId))
                                ||(!empty($modifycncc) && ($modifycncc->returnTimes > 0 || $modifycncc->cardStatus == 1))):?>
                        ...
                        <?php if((!empty($testingrequest) && !empty($testingrequest->giteeId)) || (!empty($productenroll) && !empty($productenroll->giteeId))
                            ...
                            <td class='hidden'><?php echo html::checkbox('isNewModifycncc', ["1" => $lang->outwarddelivery->modifycncc],$outwarddelivery->isNewModifycncc,"class='modifycnccCheckbox' onclick='modifycnccChange(this.checked)'");?></td>
                        <?php else:?>
                            <td><?php echo html::checkbox('isNewModifycncc', ["1" => $lang->outwarddelivery->modifycncc],$outwarddelivery->isNewModifycncc,"class='modifycnccCheckbox' onclick='modifycnccChange(this.checked)'");?></td>
                        <?php endif;?>
                    </tr>
                </tbody>
            </table>
                        ...
                        <table class="table table-form">
                            ...
                            <tr>
                                ...
                                <?php if((!empty($testingrequest) && $testingrequest->disable) || (!empty($productenroll) && $productenroll->disable)):?>
                                    <td class='required'><?php echo html::select('app[]', $appList, $outwarddelivery->app, "class='form-control chosen outwarddeliveryApp' disabled");?></td>
                                    <td class='hidden'><?php echo html::select('app[]', $appList, $outwarddelivery->app, "class='form-control chosen outwarddeliveryApp'");?></td>
                                <?php else:?>
                                    <td class='required'><?php echo html::select('app[]', $appList, $outwarddelivery->app, "class='form-control chosen outwarddeliveryApp' onchange='getProductName(this.value)'");?></td>
                                <?php endif;?>
                                <!--产品名称 -->
                                ...
                                <?php if((!empty($testingrequest) && $testingrequest->disable) || (!empty($productenroll) && $productenroll->disable)):?>
                                    <td class="productTd1 required"><?php echo html::select('productId[]', $productSelectList, '', "class='form-control chosen outwarddeliveryProduct1' disabled onchange='selectProductId(this.value)'");?></td>
                            ...
                            <?php
                            $abnormalCodedisabled = '';
                            if($outwarddelivery->abnormalCode != ''){$abnormalCodedisabled = 'disabled';}
                            ?>
                            <tr>
                                <!--二线工单 -->
                                <th class='w-100px'><?php echo $lang->outwarddelivery->secondorderId;?></th>
                                <td><?php echo html::select('secondorderId[]', $secondorderList, $outwarddelivery->secondorderId, "class='form-control chosen secondorderIdClass' ".$abnormalCodedisabled." multiple ");?></td>
                                ...
                                <td class="abnormalCodeTr hidden">
                                    <?php echo html::select('abnormalCode', $abnormalList, $outwarddelivery->abnormalCode, "class='form-control chosen '   onchange='selectabnormalCode()' $isDisable");?>
                                    <?php if($outwarddelivery->abnormalCode!=''):?>
                            ...
                            <tr>
                                ...
                                <?php if((!empty($testingrequest) && $testingrequest->disable) || (!empty($productenroll) && $productenroll->disable)):?>
                                    <td><?php echo html::select('problemId[]', $problemSelectList, $outwarddelivery->problemId, "class='form-control chosen problemIdClass' disabled multiple");?></td>
<!--                                    <td class='hidden'>--><?php //echo html::select('problemId[]', $problemList, $outwarddelivery->problemId, "class='form-control chosen problemIdClass' multiple");?><!--</td>-->
                                <?php else:?>
                                    ...
                                    <td><?php echo html::select('problemId[]', $problemList, $outwarddelivery->problemId, "class='form-control chosen problemIdClass' ".$abnormalCodedisabled." multiple");?></td>
                                <?php endif;?>
                                <!--关联需求 -->
                                <th class='w-100px'><?php echo $lang->outwarddelivery->demandId;?></th>
                                <td><?php
                                    echo html::select('demandId[]', $demandList, $outwarddelivery->demandId, "class='form-control chosen demandIdClass'  onchange='selectDemand()' ".$abnormalCodedisabled." multiple");
                                    ?></td>
                            </tr>
                            <tr>
                                <!--关联需求任务 -->
                                ...
                                <?php if((!empty($testingrequest) && $testingrequest->disable) || (!empty($productenroll) && $productenroll->disable)):?>
                                    <td><?php echo html::select('requirementId[]', $requirementSelectList, $outwarddelivery->requirementId, "class='form-control chosen requirementClass' disabled multiple");?></td>
                    ...
                    <div class="panel-body">
                        <table class="table table-form">
                            ...
                            <tr>
                                ...
                                <?php if((!empty($testingrequest) && $testingrequest->disable)):?>
                                    ...
                                    <td class='hidden'><?php echo html::select('isCentralizedTest', $lang->testingrequest->isCentralizedTestList, !empty($testingrequest)?$testingrequest->isCentralizedTest:'', "class='form-control chosen'");?></td>
                                <?php else:?>
                                    <td colspan='3' class='required'><?php echo html::select('isCentralizedTest', $lang->testingrequest->isCentralizedTestList, !empty($testingrequest)?$testingrequest->isCentralizedTest:'', "class='form-control chosen'");?></td>
                                <?php endif;?>
                            </tr>
                            <tr>
                                ...
                                <?php if((!empty($testingrequest) && $testingrequest->disable)):?>
                                    <td class='required'><?php echo html::select('acceptanceTestType', $lang->testingrequest->acceptanceTestTypeList, !empty($testingrequest)?$testingrequest->acceptanceTestType:'', "class='form-control chosen' ");?></td>
                                    <td class='hidden'><?php echo html::select('acceptanceTestType', $lang->testingrequest->acceptanceTestTypeList, !empty($testingrequest)?$testingrequest->acceptanceTestType:'', "class='form-control chosen'");?></td>
                                <?php else:?>
                                    <td class='required'><?php echo html::select('acceptanceTestType', $lang->testingrequest->acceptanceTestTypeList, !empty($testingrequest)?$testingrequest->acceptanceTestType:'', "class='form-control chosen' ");?></td>
                                <?php endif;?>
                                <!--目前阶段 -->
                                            ...
                                            <div class="app-partitions">
                                                ...
                                                <div style="width: 55%;float:left">
                                                    ...
                                                    <div class="input-group" style="display:none">
                                                        <span class="input-group-addon fix-border fix-padding" style="display:none"><?php echo $lang->modifycncc->partitionName;?></span>
                                    ...
                                    <?php else:?>
                                            <div class="app-partitions">
                                                ...
                                                <div style="width: 55%;float:left">
                                                    ...
                                                    <div class="input-group" style="display:none">
                                                        <span class="input-group-addon testingrequestChangefix-border fix-padding"><?php echo $lang->modifycncc->partitionName;?></span>
<!--                                                        --><?php //echo html::select('partition[0][]', [], ' ', "id='partition0' class='form-control chosen' multiple");?>
                    ...
                    <div class="panel-body">
                        <table class="table table-form">
                            ...
                            <tr>
                                ...
                                <td><?php echo html::textarea('applyReasonOutWindow', !empty($modifycncc)?$modifycncc->applyReasonOutWindow:'', "rows='5' class='form-control'");?></td>
                                <!--重保期变更必要性说明 -->
                                <th><?php echo $lang->modifycncc->keyGuaranteePeriodApplyReason;?></th>
                                <td><?php echo html::textarea('keyGuaranteePeriodApplyReason', !empty($modifycncc)?$modifycncc->keyGuaranteePeriodApplyReason:'', "rows='5' class='form-control'");?></td>
                            </tr>
                            <tr>
                    ...
                    <div class="panel-body">
                        <table class="table table-form">
                            ...
                            <tr>
                                ...
                                <td class="required"><?php echo html::input('controlTableFile', !empty($modifycncc)?$modifycncc->controlTableFile:'', "请填写正常的名称， 否则推送清总和金信失败，比如“2021年数据管理CBP项目上线控制表”' class='form-control' maxlength='100'");?></td>
                            </tr>
                            <tr>
                                <th class="w-100px"><?php echo $lang->modifycncc->controlTableSteps;?></th>
                                <td class="required"><?php echo html::input('controlTableSteps', !empty($modifycncc)?$modifycncc->controlTableSteps:'', "rows='5' placeholder='多个之间以英文逗号分隔，不支持中文，否则推送清总和金信失败，比如“BJ101,BJ102,BJ103”' class='form-control'");?></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
                                            ...
                                            <div class="table-row changeRequired">
                                                ...
                                                <div class="table-col">
                                                    <div class="input-group">
                                                        <span class="input-group-addon fix-border fix-padding"><?php echo $lang->modifycncc->tableTitle->relateNum;?></span>
                                                        <?php if(!empty($modifycncc) && $modifycncc->disable):?>
                                                            <?php echo html::select('relateNum[]', $modifycnccList, $line[1], "id='relateNum$key' class='form-control chosen' disabled");?>
            ...
            <table class="table table-form">
                ...
                <tr>
                    <th class='w-100px'><?php echo $lang->outwarddelivery->applyUsercontact;?></th>
                ...
                <tr>
                    <th class='w-100px'><?php echo $lang->outwarddelivery->ROR;?></th>
                    <td colspan="3" class="required"><?php echo html::input('ROR', '', "placeholder='请简述本次修订内容，如没有变化请填写无' class='form-control' ");?></td>
                </tr>
                <?php foreach($outwarddelivery->RORList as $key => $line):?>
                    <tr>
                        <th class='w-100px'></th>
                        <td colspan="3"><?php echo html::input('rorOld', $line['RORDate']." ".$line['RORContent'], "class='form-control' readonly ");?></td>
                    </tr>
                <?php endforeach;?>
                <tr>
                    <?php if(in_array($outwarddelivery->status,$lang->outwarddelivery->alloweditStatus)):?>
                    ...
                    <?php else:?>
                        ...
                        <td class='form-actions text-center' colspan='4' data-str="submit"><?php echo html::commonButton($lang->outwarddelivery->submit, '', 'btn btn-wide btn-primary submitBtn') . html::backButton();?></td>
                    <?php endif;?>
                </tr>
                </tbody>
            </table>
...
<script>
    ...
    function selectDemand(){
        ...
        $.get(createLink('outwarddelivery', 'ajaxGetOpinionByDemand', "demandIds=" + demandIds+'&isDisable='+isDisable), function(data){
    ...
    function modifycnccChange(isModifycncc){
        ...
        $.get(createLink('outwarddelivery', 'ajaxDemandSelect', "isNewModifycncc=" + modify + '&outwarddeliveryId=' + outwarddeliveryId + '&source=edit'), function(data){
