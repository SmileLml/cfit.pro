  ...
  <form method='post' target='hiddenwin'>
    <table class='table table-form'>
      <tr>
        ...
        <th class='w-100px'><?php echo $lang->host->admin;?></th>
        <td class='w-p60' colspan='3'><?php echo html::select('admin', $accounts, '', "class='form-control chosen'")?></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>
          <div class='input-group'>
            ...
            <?php echo html::select('unit', $lang->host->unitList, 'GB', "class='form-control w-50px'");?>
          </div>
        </td>
      </tr>
      <tr>
