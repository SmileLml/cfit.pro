...
<div id="mainContent" class="main-content fade">
  <div class="center-block">
    <div class="main-header">
      <h2><?php echo $lang->review->workloadEdit;?></h2>
    </div>
    <form class="load-indicator main-form form-ajax" method='post' enctype='multipart/form-data' id='dataform'>
      <table class="table table-form">
          <tbody>
          <tr>
            <th class='w-140px'><?php echo $lang->review->nodeUser;?></th>
            <td><?php echo html::select('account', $users, $consumed->account, "class='form-control chosen'");?></td>
          </tr>
          <tr>
            <th class='w-140px'><?php echo $lang->review->consumed;?></th>
          ...
          <?php
            ...
            ?>
          <tr id='relevantDept1'>
              <th class='w-140px'><?php echo $lang->review->relevantDept;?></th>
              <td>
                  <div class='table-row'>
                      <div class='table-col'>
                      ...
                      <div class='table-col'>
                          <div class='input-group'>
                              <span class='input-group-addon fix-border'><?php echo $lang->review->workload;?></span>
          ...
          ?>
          <tr>
            <th class='w-140px'><?php echo $lang->review->before;?></th>
            <td><?php echo html::select('before', $lang->review->statusList, $consumed->before, "class='form-control chosen'");?></td>
          </tr>
          <tr>
            <th class='w-140px'><?php echo $lang->review->after;?></th>
            <td><?php echo html::select('after', $lang->review->statusList, $consumed->after, "class='form-control chosen'");?></td>
          </tr>

          <?php if($isLastConsumed):?>
          <tr>
              <th class='w-140px'><?php echo $lang->review->nextUser;?></th>
              <td><?php echo html::select('dealUser', $users, $review->dealUser, "class='form-control chosen'");?></td>
          </tr>
          <?php endif;?>
