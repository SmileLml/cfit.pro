...
<div id='mainContent' class='main-content fade in  scrollbar-hover' style="height: 260px;">
          ...
          <form class="load-indicator main-form form-ajax" method='post' enctype='multipart/form-data' id='dataform'>
              <table class='table table-form'>
                  ...
                  <tr>
                      ...
                      <td><?php echo html::select('reviewers[]', $users, $allowEditReviewers, "class='form-control chosen' $multiple");?></td>
                      <td></td>
                  </tr>
