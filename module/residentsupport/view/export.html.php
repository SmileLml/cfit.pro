...
<div id='mainContent' class='main-content'>
  <div class='main-header'>
    <h2><?php echo $lang->residentsupport->export;?></h2>
  </div>
  <form method='post' target='hiddenwin' onsubmit='setDownloading();' style='padding: 20px 5%'>
    <table class='table table-form'>
      <tr>
        <th class='w-120px'><?php echo $lang->residentsupport->exportObj->num;?></th>
        <td class='w-80px'><?php echo html::input('num', '60', "class='form-control'");?></td>
