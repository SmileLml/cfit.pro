...
class zentao
{
    const ztURL        = 'http://www.chengfangjinke.com';            // ZenTaoPMS deploys domain names.
    const ztAccount    = 'admin';            // ZenTaoPMS login account.
    const ztPassword   = 'Asd123456';            // ZenTaoPMS login password.
