      ...
      <table class="table table-form">
        <tbody>
         <tr>
           ...
           <td colspan="2">
               <?php echo html::textarea('name', $risk->name, "class='form-control'");?>
           </td>
         </tr>

         <tr>
             <th><?php echo $lang->risk->identifiedDate;?></th>
             <td><?php echo html::input('identifiedDate', $risk->identifiedDate == '0000-00-00' ? '' : $risk->identifiedDate, "class='form-control form-date' readonly");?></td>
         </tr>
         <tr>
        ...
        <!-- <tr>
         ...
         <tr>
           <th><?php echo $lang->risk->timeFrame;?></th>
           <td><?php echo html::select('timeFrame', $lang->risk->timeFrameList, $risk->timeFrame, "class='form-control chosen'");?></td>
         </tr>
         <tr>
        ...
        <!-- <tr>
         ...
         <tr>
           ...
           <td><?php echo html::select('resolvedBy', $users, empty($risk->resolvedBy) ? '' : $risk->resolvedBy, "class='form-control chosen'");?></td>
         </tr>
         <tr>
           <th><?php echo $lang->risk->assignedTo;?></th>
           <td><?php echo html::select('assignedTo', $assignUsers, empty($risk->assignedTo) ? $this->app->user->account : $risk->assignedTo, "class='form-control chosen'");?></td>
         </tr>
       <!--  <tr>
         ...
         <tr>
             <th><?php echo $lang->risk->preventionAndremedy;?></th>
             <td colspan='2'><?php echo html::textarea('preventionAndremedy', $risk->preventionAndremedy, "class='form-control'");?></td>
         </tr>
         <tr>
