...
{
    public function exportBuildWorkload($projectID = 0, $param = '')
    {
        ...
        if($_POST)
        {
            ...
            $workloadList = $this->report->getBuildWorkload($projectID, $appName, $verifyActionDate, $verifyDealUser);
            ...
            $apps       = array('0' => '') + $this->loadModel('application')->getApps($projectID);
        ...
        $this->view->fileName  = $project->mark . '_' . $this->lang->report->buildWorkload;
