...
<?php js::set('expertType', $user->expertType);?>
    ...
    <form class="load-indicator main-form form-ajax" id="createForm" method="post" target='hiddenwin'>
      <table align='center' class="table table-form">
        ...
        <tr>
          ...
          <td class='w-p40'><?php echo html::input('realname', $user->realname, "class='form-control' readonly='readonly'");?></td>
        ...
        <tr>
          ...
          <td>
            ...
            <?php if($user->type == "inside"):?>
            <th><?php echo $lang->user->expertType;?></th>
            <td><?php echo html::radio('expertType', $lang->user->expertTypeList , $user->expertType);?></td>
            <?php endif;?>
        </tr>
        <tr>
        ...
        <tr>
          <th><?php echo $lang->user->staffType;?></th>
          <td><?php echo html::select('staffType', $lang->user->staffTypeList, $user->staffType, "class='form-control chosen'");?></td>
          <th class='w-130px'><?php echo $lang->user->partDept;?></th>
          <td><?php echo html::select('partDept[]', $depts, $user->partDept, "class='form-control chosen' multiple");?></td>
        </tr>
      </table>
      <table align='center' class='table table-form'>
        ...
        <tr>
          ...
          <td class='w-p40'><?php echo html::input('account', $user->account, "class='form-control' readonly='readonly'");?></td>
          <th class='w-130px'><?php echo $lang->user->email;?></th>
          <td>
            <?php echo html::input('email', $user->email, "class='form-control' readonly='readonly'");?>
        ...
        <tr>
          <th><?php echo $lang->user->employeeNumber;?></th>
          <td><?php echo html::input('employeeNumber', $user->employeeNumber, "class='form-control' readonly='readonly'");?></td>
          <th><?php echo $lang->user->id;?></th>
          <td><?php echo html::input('number', $user->number, "class='form-control' readonly='readonly'");?></td>
        </tr>
        <tr>
