...
$lang->testcase->linkTesttask       = '关联测试单';
...
$lang->testcase->execution          = '所属阶段';
$lang->testcase->applicationID      = '所属系统';
$lang->testcase->zeroCase           = '零用例需求';
$lang->testcase->selectCaseLib      = '请选择用例库';
$lang->testcase->selectCaseLibTips  = '请先选择用例库再进行创建';
$lang->testcase->selectProjectTips  = '请先选择项目再进行创建';
$lang->testcase->selectProducts     = '请选择产品';
$lang->testcase->selectProductsTips = '请先选择产品再进行创建';
$lang->testcase->nthTime            = '第%s次执行';
...
$lang->testcase->confirmLibcaseChange      = '确认用例变动';
$lang->testcase->batchConfirmLibcaseChange = '批量确认用例变动';
...
$lang->testcase->exceedingLength          = '%s行的“%s”超出了系统设计最大长度';
$lang->testcase->noLibrary                = '现在还没有公共库，请先创建！';
$lang->testcase->noProduct                = '现在还没有产品，请先创建！';
...
$lang->testcase->confirmChangeApplication = '修改系统需要重新选择产品、所属项目，并且相应的阶段和研发需求发生变化，确定吗？';

$lang->testcase->searchStories = "键入来搜索{$lang->SRCommon}";
$lang->testcase->selectLib     = '请选择库';

$lang->testcase->action                        = new stdclass();
$lang->testcase->action->fromlib               = ['main' => '$date, 由 <strong>$actor</strong> 从用例库 <strong>$extra</strong>导入。'];
$lang->testcase->action->reviewed              = ['main' => '$date, 由 <strong>$actor</strong> 记录评审结果，结果为 <strong>$extra</strong>。', 'extra' => 'reviewResultList'];
$lang->testcase->action->linked2project        = ['main' => '$date, 由 <strong>$actor</strong> 关联到项目 <strong>$extra</strong>。'];
$lang->testcase->action->unlinkedfromproject   = ['main' => '$date, 由 <strong>$actor</strong> 从项目 <strong>$extra</strong> 移除。'];
$lang->testcase->action->linked2execution      = ['main' => '$date, 由 <strong>$actor</strong> 关联到' . $lang->executionCommon . ' <strong>$extra</strong>。'];
$lang->testcase->action->unlinkedfromexecution = ['main' => '$date, 由 <strong>$actor</strong> 从' . $lang->executionCommon . ' <strong>$extra</strong> 移除。'];
$lang->testcase->action->linked2testtask       = ['main' => '$date, 由 <strong>$actor</strong> 关联到测试单 <strong>$extra</strong>。'];
$lang->testcase->action->unlinkedfromtesttask  = ['main' => '$date, 由 <strong>$actor</strong> 从测试单 <strong>$extra</strong> 移除。'];
