...
class myfile extends file
{
    ...
    public function exportTestReport()
    {
        ...
        if($headerName)
        {
            ...
            $this->addText('(' . date('Y-m-d H:i:s') . ' ' . $this->app->user->realname . ' ' . $this->lang->testreport->exportNotice . ')', array('color' => 'CCCCCC'), true);
            $this->wordContent .= '</w:p>';
        }

        $this->addTitle($this->lang->testreport->legendBasic, 2);
        $this->wordContent .= '<w:tbl>';
        $this->wordContent .= '<w:tblPr><w:tblStyle w:val="a3"/><w:tblW w:w="0" w:type="auto"/><w:tblLayout w:type="fixed"/><w:tblLook w:val="04A0"/></w:tblPr><w:tblGrid><w:gridCol w:w="1101"/><w:gridCol w:w="9421"/></w:tblGrid>';
        $this->wordContent .= '<w:tr w:rsidR="0000463B" w:rsidTr="0000463B">';
        $this->addTh($this->lang->testreport->project);
        $this->addTd($this->post->projectName);
        $this->wordContent .= '</w:tr>';
        $this->wordContent .= '<w:tr w:rsidR="0000463B" w:rsidTr="0000463B">';
        $this->addTh($this->lang->testreport->applicationID);
        $this->addTd($this->post->applicationName);
        $this->wordContent .= '</w:tr>';
        $this->wordContent .= '<w:tr w:rsidR="0000463B" w:rsidTr="0000463B">';
        $this->addTh($this->lang->testreport->product);
        $this->addTd($this->post->productName);
        $this->wordContent .= '</w:tr>';
        $this->wordContent .= '<w:tr w:rsidR="0000463B" w:rsidTr="0000463B">';
        ...
        $projectDesc = $this->pauseHtmlTag($this->post->projectDesc);
        $this->addTd($projectDesc);
        $this->wordContent .= '</w:tr>';
        $this->wordContent .= '<w:tr w:rsidR="0000463B" w:rsidTr="0000463B">';
        ...
        $this->wordContent .= '<w:tblGrid><w:gridCol w:w="678"/><w:gridCol w:w="473"/><w:gridCol w:w="5000"/><w:gridCol w:w="1100"/><w:gridCol w:w="1100"/><w:gridCol w:w="810"/><w:gridCol w:w="810"/><w:gridCol w:w="950"/></w:tblGrid>';
        $this->wordContent .= '<w:tr w:rsidR="0000463B" w:rsidTr="0000463B">';
        ...
        $this->wordContent .= '<w:tbl>';
        $this->wordContent .= '<w:tblPr><w:tblStyle w:val="a3"/><w:tblW w:w="0" w:type="auto"/><w:tblLayout w:type="fixed"/><w:tblLook w:val="04A0"/></w:tblPr>';
        $this->wordContent .= '<w:tblGrid><w:gridCol w:w="678"/><w:gridCol w:w="473"/><w:gridCol w:w="5000"/><w:gridCol w:w="1100"/><w:gridCol w:w="1100"/><w:gridCol w:w="1600"/><w:gridCol w:w="950"/></w:tblGrid>';
        $this->wordContent .= '<w:tr w:rsidR="0000463B" w:rsidTr="0000463B">';
        $this->addTh($this->lang->idAB);
        $this->addTh($this->lang->priAB);
        ...
        $this->wordContent .= '<w:tbl>';
        $this->wordContent .= '<w:tblPr><w:tblStyle w:val="a3"/><w:tblW w:w="0" w:type="auto"/><w:tblLayout w:type="fixed"/><w:tblLook w:val="04A0"/></w:tblPr>';
        $this->wordContent .= '<w:tblGrid><w:gridCol w:w="678"/><w:gridCol w:w="6883"/><w:gridCol w:w="1100"/><w:gridCol w:w="1500"/></w:tblGrid>';
        $this->wordContent .= '<w:tr w:rsidR="0000463B" w:rsidTr="0000463B">';
        ...
        $this->wordContent .= '<w:tbl>';
        $this->wordContent .= '<w:tblPr><w:tblStyle w:val="a3"/><w:tblW w:w="0" w:type="auto"/><w:tblLayout w:type="fixed"/><w:tblLook w:val="04A0"/></w:tblPr>';
        $this->wordContent .= '<w:tblGrid><w:gridCol w:w="678"/><w:gridCol w:w="473"/><w:gridCol w:w="3500"/><w:gridCol w:w="1100"/><w:gridCol w:w="1100"/><w:gridCol w:w="1100"/><w:gridCol w:w="1500"/><w:gridCol w:w="800"/><w:gridCol w:w="950"/></w:tblGrid>';
        $this->wordContent .= '<w:tr w:rsidR="0000463B" w:rsidTr="0000463B">';
        $this->addTh($this->lang->idAB);
        $this->addTh($this->lang->priAB);
        ...
        $this->addTh($this->lang->statusAB);
        $this->wordContent .= '</w:tr>';
        foreach($this->post->cases as $case)
        {
            $this->wordContent .= '<w:tr w:rsidR="0000463B" w:rsidTr="0000463B">';
            $this->addTd($case->id);
            ...
            $this->addTd(zget($this->lang->testtask->statusList, $case->status));
            $this->wordContent .= '</w:tr>';
        }
        $this->wordContent .= '</w:tbl>';
        ...
        $this->wordContent .= '<w:tbl>';
        $this->wordContent .= '<w:tblPr><w:tblStyle w:val="a3"/><w:tblW w:w="0" w:type="auto"/><w:tblLayout w:type="fixed"/><w:tblLook w:val="04A0"/></w:tblPr>';
        $this->wordContent .= '<w:tblGrid><w:gridCol w:w="678"/><w:gridCol w:w="473"/><w:gridCol w:w="5245"/><w:gridCol w:w="1100"/><w:gridCol w:w="1100"/><w:gridCol w:w="1500"/><w:gridCol w:w="950"/></w:tblGrid>';
        $this->wordContent .= '<w:tr w:rsidR="0000463B" w:rsidTr="0000463B">';
        $this->addTh($this->lang->idAB);
        $this->addTh($this->lang->priAB);
        $this->addTh($this->lang->bug->title);
    ...
    public function addText($text, $styles = array(), $inline = false)
    {
        ...
        if($out[2])
        {
            ...
            foreach($noTags as $i => $content)
            {
                ...
                if(empty($content) && $content != 0) continue;
    ...
    public function addImage($imageData, $extension = 'png')
    {
        ...
        $path   = $this->exportPath . '/word/media/image' . $relsID . '.' . $extension;
        file_put_contents($path, base64_decode(substr($imageData, 22)));

        list($width, $height) = getimagesize($path);

        $document  = '';
        $document .= '<w:p>' . $this->wpPr;
        ...
        $document .= '<v:imagedata cropleft="8396f" o:title="5" r:id="rId' . $relsID . '"/>';
    ...
    public function formatDocxFiles($content)
    {
        ...
        foreach($content->files as $file)
        {
            ...
            if(in_array($extension, $this->config->word->imageExtension))
            {
                ...
                $this->addImage("data:image/{$extension};base64," . base64_encode(file_get_contents($linkHref)));
                $this->addTextBreak();
            }
            else
            {
    ...
    public function checkFileExist($matches)
    {
        ...
        return file_exists($realFilePath) ? '<img src="' . $matches[2] . '" alt="" />' : '';
    }
