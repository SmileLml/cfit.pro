...
<div id='mainContent' class='main-content' style="height: 380px">
  <div class='center-block'>
    <div class='main-header'>
      <h2>
        <?php echo $lang->secondorder->assignByUser;?>
      </h2>
    </div>
    <form class="load-indicator main-form form-ajax" method='post' target='hiddenwin'>
      <table class='table table-form'>
        <tr>
          <th><?php echo $lang->secondorder->assignTo;?></th>
          <td colspan='2'><?php echo html::select('dealUser', $users, $secondorder->dealUser, "class='form-control chosen'");?></td>
        </tr>
        <tr>
