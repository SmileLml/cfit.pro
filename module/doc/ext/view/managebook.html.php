...
<?php
$spliter = (empty($this->app->user->feedback) && !$this->cookie->feedbackView && $app->openApp == 'doc') ? true : false;
if(!$spliter) $browseType = '';
?>
<div class="main-row fade" id="mainRow">
  <?php include '../../view/side.html.php';?>
      ...
      <nav class="panel-actions btn-toolbar">
        <div class="dropdown">
          ...
          <ul class='dropdown-menu'>
            ...
            <li><?php common::printLink('doc', 'deleteLib',  "libID=$book->id", "<i class='icon icon-trash'></i>" . $lang->delete, 'hiddenwin');?></li>
          </ul>
        </div>
      </nav>
