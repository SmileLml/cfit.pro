...
$config->workflowdatasource->methods['build']       = array('getProjectBuildPairs', 'getProductBuildPairs');
$config->workflowdatasource->methods['dept']        = array('getOptionMenu', 'getAllChildID', 'getDeptUserPairs');
$config->workflowdatasource->methods['doc']         = array('getProjectModulePairs');
...
$config->workflowdatasource->methods['product']     = array('getPairs', 'getProductsByProject', 'getProjectPairs', 'getTeamMemberPairs');
...
$config->workflowdatasource->methods['execution']   = array('getPairs', 'getRelatedProjects', 'getChildProjects', 'getTeams2Import', 'getProjectBranches');
$config->workflowdatasource->methods['search']      = array('getQueryPairs');
$config->workflowdatasource->methods['story']       = array('getProductStoryPairs', 'getExecutionStoryPairs', 'getUserStoryPairs', 'getProjectMembers', 'getVersions');
$config->workflowdatasource->methods['task']        = array('getProjectTaskPairs', 'getParentTaskPairs', 'getUserTaskPairs', 'getMemberPairs');
...
$config->workflowdatasource->methods['tree']        = array('getOptionMenu', 'getModulePairs', 'getLinePairs', 'getTaskOptionMenu', 'getTaskTreeModules', 'getAllChildID', 'getProjectModule', 'getModulesName');
