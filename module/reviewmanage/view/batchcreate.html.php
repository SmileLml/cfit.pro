        ...
        <div class="table-responsive">
            <table class="table table-form">
                ...
                <tr>
                    ...
                    <th class='w-60px  text-center' <?php echo zget($requiredFields, 'meetingCode', '', '')?>'><?php echo $lang->reviewissue->meetingCode;?></th>
                ...
                <?php for($i = 0; $i < $config->reviewissue->batchCreate; $i++):?>
                    <tr>
                        ...
                        <?php endif;?>
                        <td><?php echo html::input("meetingCode[$i]", '', "class='form-control'");?></td>
