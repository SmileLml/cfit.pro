...
(function($) {
    ...
    var modifycnccTools = ['formatblock', 'fontname', 'fontsize', '|', 'forecolor', 'hilitecolor', 'bold', 'italic','underline', '|',
        'justifyleft', 'justifycenter', 'justifyright', 'insertorderedlist', 'insertunorderedlist', '|',
        'emoticons', 'code', 'link', 'table', '|', 'removeformat','undo', 'redo', 'fullscreen', 'source', 'about']
    var bugTools =
    ...
    var editorToolsMap = {fullTools: fullTools, simpleTools: simpleTools, simpleTools2: simpleTools2,bugTools: bugTools,modifycnccTools: modifycnccTools};
    ...
    var setKindeditor = function(element, options)
    {
        ...
        options      = $.extend({}, editorDefaults, $editor.data(), options,{height:editor.height,minHeight:editor.minHeight});
