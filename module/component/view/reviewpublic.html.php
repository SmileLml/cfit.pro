...
<div id="mainContent" class="main-content fade">
    <div class="center-block">
        <div class="main-header">
            ...
            <h2>公共组件：<?php echo $lang->component->reviewNodeList[$component->reviewStage]; ?></h2>
        </div>
        ...
        <?php elseif ($component->status == 'toappoint'): ?>
            <form class="load-indicator main-form form-ajax" method='post' enctype='multipart/form-data' id='dataform'>
                <table class="table table-form">
                    ...
                    <tr>
                        <th><?php echo $lang->component->result; ?></th>
                        <td class="required"><?php echo html::select('result', $lang->component->teampublicresultList, '', "class='form-control chosen' onchange='teamChoseShow(this.value)'"); ?></td>
                    </tr>
        ...
        <?php elseif ($component->status == 'toarchitreview'):?>
            <form class="load-indicator main-form form-ajax" method='post' enctype='multipart/form-data' id='dataform'>
                <table class="table table-form">
                    ...
                    <tr>
                        <th><?php echo $lang->component->result; ?></th>
                        <td class="required"><?php echo html::select('result', $lang->component->publicconfirmList, $resultStatus, "class='form-control chosen' onchange='rejectShow2(this.value)'"); ?></td>
                    </tr>
                    <?php if($component->type=='public'): ?>
                        <tr id="componentIdList">
                            <th><?php echo $lang->component->name;?></th>
        ...
        <?php elseif ($component->status == 'toarchitleaderreview'): ?>
            <form class="load-indicator main-form form-ajax" method='post' enctype='multipart/form-data' id='dataform'>
                <table class="table table-form">
                    ...
                    <tr>
                        <th><?php echo $lang->component->result; ?></th>
                        <td class="required"><?php echo html::select('result', $lang->component->teampublicresultList, $resultStatus, "class='form-control chosen' disabled"); ?></td>
                        <td class="hidden"><?php echo html::select('result', $lang->component->teampublicresultList, $resultStatus, "class='form-control chosen'"); ?></td>
                    </tr>
                    <?php if($component->type=='public' && $resultStatus=='incorporate'): ?>
                        <tr >
                            ...
                            <td class="hidden"><?php echo html::select('cid', $componentList, $component->cid, "class='form-control chosen' "); ?></td>
                        </tr>
                    <?php endif;?>
                    <tr>
                        <th><?php echo $lang->component->mailto; ?></th>
