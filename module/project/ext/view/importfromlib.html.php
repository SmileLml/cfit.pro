<?php
/**
 * The importfromlib view file of project module of ZenTaoPMS.
 *
...
<div id='mainMenu' class='clearfix'>
  <div class='btn-toolbar pull-left'>
    <div class='input-group w-300px'>
      <span class='input-group-addon'><?php echo $lang->project->selectLib;?></span>
...
<div id='mainContent'>
  <form class='main-table' method='post' target='hiddenwin' id='importFromLib' data-ride='table'>
    <table class='table has-sort-head table-fixed'>
      <thead>
        <?php $vars = "applicationID=$applicationID&productID=$productID&branch=$branch&libID=$libID&orderBy=%s&browseType=$browseType&queryID=$queryID&recTotal={$pager->recTotal}&recPerPage={$pager->recPerPage}";?>
        <tr>
          <th class='c-id'>
          ...
          <?php if($branches):?>
          <th class='w-110px'><?php echo $lang->project->branch ?></th>
          <?php endif;?>
          <th class='w-100px'>  <?php common::printOrderLink('pri',   $orderBy, $vars, $lang->priAB);?></th>
          <th>                <?php common::printOrderLink('title', $orderBy, $vars, $lang->project->title);?></th>
          <th class='w-200px'><?php echo $lang->project->fromModule ?></th>
          <th class='w-200px'><?php echo $lang->project->module ?></th>
          <th class='w-120px'><?php common::printOrderLink('type',  $orderBy, $vars, $lang->project->type)?></th>
        </tr>
      </thead>
      <tbody>
        <?php $i = 0;?>
        ...
        <tr>
          ...
          <td class='text-left nobr'><?php if(!common::printLink('testcase', 'view', "caseID=$case->id", $case->title, '', 'data-app')) echo $case->title;?></td>
          ...
          <td class='text-left' data-module='<?php echo $case->module?>' style='overflow:visible'>
            <?php if($i > 0) $modules['ditto'] = $lang->project->ditto;?>
    ...
    <div class='table-footer'>
      ...
      <div class='table-actions btn-toolbar show-always'>
        <?php echo html::submitButton($lang->project->import, '', 'btn btn-secondary');?>
      </div>
