    ...
    <table class='table table-form'>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><?php echo html::select("roles[$i][]", $statusSelects['roleList'], $member->role.',', "class='form-control chosen' required multiple");?></td>
          ...
          <td>
            ...
            <input type='hidden' name="accounts[<?php echo $i;?>]" value='<?php echo $member->account;?>' />
          </td>
        ...
        <tr class='addedItem'>
          <td><?php echo html::select("accounts[$i]", $users, $deptAccount, "class='form-control chosen'");?></td>
          <td><?php echo html::select("roles[$i][]", $statusSelects['roleList'], '', "class='form-control chosen' multiple");?></td>
        ...
        <?php for($j = 0; $j < 5; $j ++):?>
        <tr class='addedItem'>
          <td><?php echo html::select("accounts[$i]", $users, '', "class='form-control chosen'");?></td>
          <td><?php echo html::select("roles[$i][]", $statusSelects['roleList'], '', "class='form-control chosen' multiple");?></td>
          <td><input type='text' name='days[]'  id='days<?php  echo ($i);?>' class='form-control' value='<?php echo $project->days?>'/></td>
          <td>
            <input type='text'   name='hours[]' id='hours<?php echo ($i);?>' class='form-control' value='<?php echo $config->execution->defaultWorkhours?>' />
...
<div>
  ...
  <table class='hidden'>
    <tr id='addItem' class='hidden'>
      <td><?php echo html::select("accounts[$i]", $users, '', "class='form-control'");?></td>
      <td><?php echo html::select("roles[$i][]", $statusSelects['roleList'], '', "class='form-control' multiple");?></td>
      <td><input type='text' name='days[]'  id='days<?php  echo ($i);?>' class='form-control' value='<?php echo $project->days?>'/></td>
      <td>
        <input type='text'   name='hours[]' id='hours<?php echo ($i);?>' class='form-control' value='<?php echo $config->execution->defaultWorkhours?>' />
      </td>
