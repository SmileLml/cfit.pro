...
<div id="mainContent" class="main-content fade">
  <div class="center-block">
    <div class="main-header">
      <h2><?php echo $lang->demandinside->deal;?></h2>
    </div>
    <form class="load-indicator main-form form-ajax" method='post' enctype='multipart/form-data' id='dataform'>
      <table class="table table-form">
        <tbody>
          <tr>
            <th class='w-140px'><?php echo $lang->demandinside->handler;?></th>
            <td><?php echo html::select('user', $users, $this->app->user->account, "class='form-control chosen'");?></td>
          </tr>
          <tr>
            <th class='w-140px'><?php echo $lang->demandinside->consumed;?></th>
            <td><?php echo html::input('consumed', '', "class='form-control'");?></td>
          </tr>
          <tr id='relevantDept1'>
            <th class='w-140px'><?php echo $lang->demandinside->relevantDept;?></th>
            <td>
              <div class='table-row'>
                <div class='table-col'>
                ...
                <div class='table-col'>
                  <div class='input-group'>
                    <span class='input-group-addon fix-border'><?php echo $lang->demandinside->workload;?></span>
          ...
          <tr>
            <th class='w-140px'><?php echo $lang->demandinside->dealStatus;?></th>
          ...
          <tr>
            <th class='w-140px'><?php echo $lang->demandinside->nextUser;?></th>
            <td><?php echo html::select('dealUser', $users, '', "class='form-control chosen'");?></td>
          </tr>
          <tr>
            <th class='w-140px'><?php echo $lang->demandinside->mailto;?></th>
            <td colspan="2"><?php echo html::select('mailto[]', $users, '', "class='form-control chosen' multiple");?></td>
          </tr>
          <tr class="hidden dev">
            <th class='w-140px'><?php echo $lang->demandinside->end;?></th>
          ...
          <tr class="hidden dev dev2">
            ...
            <td class='required notrequired'><?php echo html::select('fixType', $lang->demandinside->fixTypeList, $demand->fixType, "class='form-control chosen'");?></td>
          </tr>
          <tr class="hidden dev dev2">
            <th><?php echo $lang->demandinside->projectPlan;?></th>
          ...
          <tr class="hidden dev dev2">
            ...
            <td>
              <?php echo html::a('javascript:void(0);', '<i class="icon-plus"></i> ' . $lang->demandinside->createPlan, '', "class='btn btn-info hidden' data-app='product' id='createPlan'");?>
            </td>
          </tr>
          <tr class="hidden dev">
...
<?php
echo js::set('createPlanTips', $lang->demandinside->createPlanTips);
