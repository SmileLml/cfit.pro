...
$config->bug->defectbug = new stdclass();
$config->bug->create->requiredFields  = 'project,title';
$config->bug->edit->requiredFields    = $config->bug->create->requiredFields;
$config->bug->resolve->requiredFields = 'project,resolution,analysis';
$config->bug->defectbug->requiredFields = 'app,title,pri,defectType,developer,resolution';
...
$config->bug->list->exportFields = 'id, applicationID, product, module, project, execution ,story, task,
    title, keywords, severity, pri, type, childType, os, browser, linkTesttask,
    steps, analysis, status, deadline, activatedCount, confirmed, mailto,
    openedBy, openedDate, linkPlan, openedBuild,
    assignedTo, assignedDate,
    resolvedBy, resolution, resolvedBuild, resolvedDate,
    closedBy, closedDate,
    duplicateBug, linkBug,
    case,
    lastEditedBy,
    lastEditedDate, files,defectId';

$config->bug->list->customCreateFields      = 'story,task,pri,severity,os,browser,deadline,mailto,keywords';
$config->bug->list->customBatchCreateFields = 'openedBuild,steps,deadline,pri,severity,os,browser,keywords';
$config->bug->list->customBatchEditFields   = 'severity,pri,assignedTo,deadline,status,resolvedBy,resolution,os,browser,keywords';

$config->bug->custom = new stdclass();
$config->bug->custom->createFields      = $config->bug->list->customCreateFields;
$config->bug->custom->batchCreateFields = 'steps,type,severity,os,browser';
$config->bug->custom->batchEditFields   = 'severity,pri,assignedTo,deadline,status,resolvedBy,resolution';
...
$config->bug->editor->assignto   = array('id' => 'analysis,comment', 'tools' => 'bugTools');
$config->bug->editor->resolve    = array('id' => 'analysis,comment', 'tools' => 'bugTools');
$config->bug->editor->close      = array('id' => 'comment', 'tools' => 'bugTools');
$config->bug->editor->activate   = array('id' => 'comment', 'tools' => 'bugTools');
$config->bug->editor->defectbug  = array('id' => 'remark,issues,analysis,dealComment,EditorImpactscope', 'tools' => 'bugTools');
...
$config->bug->search['fields']['analysis']       = $lang->bug->analysis;
...
$config->bug->search['fields']['linkPlan']       = $lang->bug->productplan;
$config->bug->search['fields']['linkTesttask']   = $lang->bug->linkTesttask;
...
$config->bug->search['fields']['childType']      = $lang->bug->childType;
...
$config->bug->search['fields']['linkDefect']     = $lang->bug->linkDefect;
...
$config->bug->search['params']['analysis']      = array('operator' => 'include', 'control' => 'input',  'values' => '');
...
$config->bug->search['params']['linkPlan']      = array('operator' => 'include', 'control' => 'select', 'values' => '', 'mulit'=>true);
$config->bug->search['params']['linkTesttask']  = array('operator' => 'include', 'control' => 'select', 'values' => '', 'mulit'=>true);
...
$config->bug->search['params']['childType']     = array('operator' => '=',       'control' => 'select', 'values' => '');
...
$config->bug->datatable->defaultField = array('id', 'severity', 'pri', 'confirmed', 'title', 'status', 'openedBy', 'openedDate', 'assignedTo', 'resolution', 'linkPlan', 'actions');
...
$config->bug->datatable->fieldList['pri']['title']    = 'pri';
...
$config->bug->datatable->fieldList['childType']['title']    = 'childType';
$config->bug->datatable->fieldList['childType']['fixed']    = 'no';
$config->bug->datatable->fieldList['childType']['width']    = '100';
$config->bug->datatable->fieldList['childType']['required'] = 'no';

$config->bug->datatable->fieldList['product']['title']    = 'product';
$config->bug->datatable->fieldList['product']['fixed']    = 'no';
$config->bug->datatable->fieldList['product']['width']    = '120';
$config->bug->datatable->fieldList['product']['required'] = 'no';
...
$config->bug->datatable->fieldList['linkPlan']['title']    = 'linkPlan';
$config->bug->datatable->fieldList['linkPlan']['fixed']    = 'no';
$config->bug->datatable->fieldList['linkPlan']['width']    = '120';
$config->bug->datatable->fieldList['linkPlan']['required'] = 'no';

$config->bug->datatable->fieldList['linkTesttask']['title']    = 'linkTesttask';
$config->bug->datatable->fieldList['linkTesttask']['fixed']    = 'no';
$config->bug->datatable->fieldList['linkTesttask']['width']    = '200';
$config->bug->datatable->fieldList['linkTesttask']['required'] = 'no';
...
$config->bug->datatable->fieldList['resolution']['width']    = '120';
...
$config->bug->datatable->fieldList['actions']['width']    = '170';
$config->bug->datatable->fieldList['actions']['required'] = 'yes';
$config->bug->datatable->fieldList['actions']['sort']     = 'no';
