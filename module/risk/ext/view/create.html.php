      ...
      <table class="table table-form">
        <tbody>
          <tr>
            ...
            <td colspan="2">
                <?php echo html::textarea('name', '', "class='form-control'");?>
            </td>
          </tr>
          <tr>
              <th><?php echo $lang->risk->identifiedDate;?></th>
              <td ><?php echo html::input('identifiedDate', '', "class='form-control form-date' readonly");?></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><?php echo html::select('timeFrame', $lang->risk->timeFrameList, 3, "class='form-control chosen'");?></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><?php echo html::select('assignedTo', $assignUsers, '', "class='form-control chosen'");?></td>
          </tr>
         <!-- <tr>
          ...
          <tr>
              ...
              <td colspan='2'><?php echo html::textarea('preventionAndremedy', '', "class='form-control'");?></td>
          </tr>
          <tr>
