...
$config->workflowaction->buildin->actions['program']     = array('browse', 'create', 'edit', 'view', 'delete', 'close', 'activate', 'start', 'suspend');
...
$config->workflowaction->buildin->actions['execution']   = array('task', 'create', 'batchedit', 'edit', 'view', 'delete', 'close', 'activate', 'start', 'putoff', 'suspend');
...
$config->workflowaction->buildin->actions['bug']         = array('browse', 'create', 'batchcreate', 'batchedit', 'exporttemplate', 'import', 'showimport', 'edit', 'view', 'delete', 'close', 'activate', 'assignTo', 'confirmBug', 'resolve', 'batchconfirm', 'batchresolve');
...
$config->workflowaction->buildin->actions['feedback']    = array('browse', 'create', 'batchedit', 'edit', 'view', 'delete', 'close', 'assignTo', 'review', 'comment', 'admin', 'adminview');
