...
$lang->custom->order                = '排序';
$lang->custom->extendInfo           = new stdClass();
$lang->custom->extendInfo->productmanager  = '产品经理';
$lang->custom->changeUnlock         = '变更锁开关';
...
$lang->custom->roleNotEmpty        = '至少选择一种角色';
$lang->custom->defaultRoleNotEmpty = '默认角色不能为空';
...
$lang->custom->bug->fields['typeList']       = 'Bug分类';
$lang->custom->bug->fields['childTypeList']  = 'Bug子类';
$lang->custom->bug->fields['resolutionList'] = '解决方案';
$lang->custom->bug->fields['statusList']     = '状态';
$lang->custom->bug->fields['longlife']       = '久未处理天数';
$lang->custom->bug->fields['guide']          = '缺陷定级指南';
$lang->custom->bug->fields['allowDeptList']          = '通知人员允许回填部门';
...
$lang->custom->changeStatus[1] = '开启';
$lang->custom->changeStatus[2] = '关闭';

$lang->custom->singleUsageList['on']  = '开启';
$lang->custom->singleUsageList['off'] = '关闭';
