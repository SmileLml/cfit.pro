<?php
$lang->reportList->program->lists[5]  = '项目汇总表|report|projectsummary';
$lang->reportList->program->lists[10] = '项目工作量统计表|report|projectworkload';

$lang->report->projectSummary  = '项目汇总表';
$lang->report->projectWorkload = '项目工作量统计表';
...
$lang->report->titleList['ev']     = '项目组实际工作量[人时]';
