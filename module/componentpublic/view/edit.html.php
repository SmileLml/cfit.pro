...
<div id="mainContent" class="main-content fade">
    <div class="center-block">
        <div class="main-header">
            <h2><?php echo $lang->componentpublic->edit; ?></h2>
        </div>
            ...
            <div id="newPublic">
                <table class="table table-form">
                    ...
                    <tr>
                        ...
                        <td class='required'
                            colspan='2'><?php echo html::input('name', $componentpublic->name, "maxlength='60' class='form-control' required"); ?></td>
                        <th><?php echo $lang->componentpublic->latestVersion; ?></th>
                        <td class='required'
                            colspan='2'><?php echo html::input('latestVersion', $componentpublic->latestVersion, "class='form-control' required"); ?></td>
                    </tr>
                    <tr>
                        <th><?php echo $lang->componentpublic->level; ?></th>
                        <td class='required'
                            colspan='2'><?php echo html::select('level', array('' => '') + $lang->componentpublic->levelList, $componentpublic->level, "class='form-control chosen'"); ?></td>
                        <th><?php echo $lang->componentpublic->category; ?></th>
                        <td class='required'
                            colspan='2'><?php echo html::select('category', array('' => '') + $lang->component->categoryList, $componentpublic->category, "class='form-control chosen'"); ?></td>
                    </tr>
                    <tr>
                        <th><?php echo $lang->componentpublic->developLanguage; ?></th>
                        <td class='required'
                            colspan='2'><?php echo html::select('developLanguage', array('' => '') + $lang->component->developLanguageList, $componentpublic->developLanguage, "class='form-control chosen'"); ?></td>
                        <th><?php echo $lang->componentpublic->status; ?></th>
                        <td class='required'
                            colspan='2'><?php echo html::select('status', array('' => '') + $lang->component->publishStatusList, $componentpublic->status, "class='form-control chosen'"); ?></td>
                    </tr>
                    <tr>
                        <th><?php echo $lang->componentpublic->maintainer; ?></th>
                        <td class='required' colspan='2'><?php echo html::select('maintainer', array('' => '') + $users, $componentpublic->maintainer, "class='form-control chosen' onchange='selectUser(this.value)'"); ?></td>
                        <th><?php echo $lang->componentpublic->maintainerDept; ?></th>
                        <td class='required' colspan='2'><?php echo html::select('maintainerDept', $depts, $componentpublic->maintainerDept, "class='form-control chosen'"); ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class='required' colspan='2'><?php echo html::input('location', $componentpublic->location, "class='form-control' required"); ?></td>
                    </tr>
                    </tbody>
                </table>
            </div>
