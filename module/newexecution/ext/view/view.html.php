...
<div id="mainMenu" class="clearfix">
  <div class="btn-toolbar pull-left">
    <?php if(!isonlybody()):?>
    <?php echo html::a($this->createLink('newexecution', 'execution', "browseType=all&projectID=$execution->project"), '<i class="icon icon-back icon-sm"></i> ' . $lang->goback, '', "class='btn btn-secondary'");?>
  ...
  <div class="main-col col-8">
    ...
    <div class='main-actions'>
      <div class="btn-toolbar">
        <?php common::printBack($this->createLink('newexecution', 'execution', "browseType=all&projectID=$execution->project"));?>
        <div class='divider'> </div>
          <?php
          ...
          if(empty($disabled))
          {
              if($execution->source ){
                  if($this->app->user->account == 'admin'){
                      common::printIcon('newexecution', 'delete', "executionID=$execution->id", $execution, 'button', 'trash', 'hiddenwin');
                  }else if(strpos($execution->code,'DEP') !== false){
                      common::printIcon('newexecution', 'edit', "executionID=$execution->id", $execution, 'button');
                      common::printIcon('newexecution', 'delete', "executionID=$execution->id", $execution, 'button', 'trash', 'hiddenwin');
                  }else{
