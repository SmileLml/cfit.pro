...
$lang->project->testsuite         = '套件';
$lang->project->defect            = '清总缺陷';
$lang->project->build             = '制版';
...
$lang->project->selectProduct     = '请选择产品';
$lang->project->selectProductTips = '请选择具体产品进行创建！';
$lang->project->import            = "导入";
$lang->project->importFromLib     = "从用例库中导入";
$lang->project->ajaxImportFromLib = "指定用例库";
$lang->project->lib               = "所属库";
$lang->project->selectLib         = '请选择库';
$lang->project->type              = '用例类型';
$lang->project->title             = '用例标题';
$lang->project->module            = '所属模块';
$lang->project->fromModule        = '来源模块';
$lang->project->ditto             = '同上';
...
$lang->project->begin              = '计划开始时间';
$lang->project->end                = '计划完成时间';
$lang->project->status             = '项目空间状态';
...
$lang->project->dateRange          = '计划起止日期';//'起止日期';
$lang->project->realBeginAndEnd    = '实际起止日期';
$lang->project->to                 = '至';
...
$lang->project->closedProjects     = '已关闭';
...
$lang->project->setOrganization               = [];
$lang->project->setOrganization               = [''=>''];
$lang->project->pushWeeklyreportQingZong      = [''=>''];
$lang->project->setSystemAdmin      = [''=>''];
$lang->project->monthReportCustomUser      = [''=>''];
...
$lang->project->rolesEmpty = '请选择角色';

//自定义默认选择
$lang->project->outsideReportStatusList = array();
$lang->project->outsideReportStatusList[''] = '';
$lang->project->insideReportStatusList = array();
$lang->project->insideReportStatusList[''] = '';
$lang->project->workHours = array();
$lang->project->workHours['effectiveDate'] = '';
$lang->project->workHours['workHours'] = '';
$lang->project->workHoursTitle = '人月工时计算参数';
$lang->project->planWorkload = '计划工作量（人月）';

$lang->project->sendProjectInfoApi  = '人力接口';
$lang->project->apiError            = '接口配置未开启！';

$lang->project->product     = '所属产品';
$lang->project->project     = '所属项目';
$lang->project->severity    = '严重程度';
$lang->project->severityAB  = '严重级';
$lang->project->pri         = '优先级';
$lang->project->source      = '缺陷来源';
$lang->project->createdDate = '创建时间';
$lang->project->nextUser    = '待处理人';
$lang->project->dealSuggest = '处置建议';
$lang->project->uatId       = '外部缺陷ID';
$lang->project->syncStatus  = '推送状态';
$lang->project->defectTitle = '缺陷标题';
$lang->project->oddNumber   = '测试单号';
$lang->project->owner       = '负责人';
$lang->project->bugTitle    = 'Bug标题';
$lang->project->bugType     = 'Bug分类';
$lang->project->childType   = 'Bug子分类';
$lang->project->resolvedBy  = '解决者';
$lang->project->resolution  = '方案';
$lang->project->nameAB      = '名称';

$lang->project->testcaseTitle      = '用例标题';
$lang->project->testcaseCategories = '自动化分类';
$lang->project->lastRunner         = '执行人';
$lang->project->openedBy           = '由谁创建';
$lang->project->assignedTo         = '指派';
$lang->project->lastRunDate        = '执行时间';
$lang->project->lastRunResult      = '结果';

$lang->project->addedBy         = '由谁创建';
$lang->project->addedDate       = '创建时间';
$lang->project->createdBy       = '由谁创建';
$lang->project->tasks           = '测试版本';
$lang->project->testreportTitle = '测试报告标题';

$lang->project->isSafetyTest      = '是否需要安全测试';
$lang->project->isPerformanceTest = '是否需要性能测试';

//是否需要安全测试
$lang->project->isSafetyTestList = array();
$lang->project->isSafetyTestList[1] = '--请选择--';
$lang->project->isSafetyTestList[2] = '是';
$lang->project->isSafetyTestList[3] = '否';

//是否需要性能测试
$lang->project->isPerformanceTestList = array();
$lang->project->isPerformanceTestList[1] = '--请选择--';
$lang->project->isPerformanceTestList[2] = '是';
$lang->project->isPerformanceTestList[3] = '否';
$lang->project->noChangeError = "没有信息修改，无需提交";
