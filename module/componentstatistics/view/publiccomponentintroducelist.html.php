      ...
      <div class='panel'>
        <div class="panel-heading">
          ...
          <nav class="panel-actions btn-toolbar">
            <?php if(common::hasPriv('componentstatistics', 'exportPublicComponentIntroduceList')) echo html::a(inLink('exportPublicComponentIntroduceList'), $lang->export, '', 'class="iframe btn btn-primary btn-sm"');?>
          </nav>
        </div>
        <div data-ride='table'>
            ...
            <tbody>
              ...
              <tr class="text-center">
                ...
                <td><?php
                        ...
                        echo zget($lang->componentstatistics->columnkeylable,$key);
