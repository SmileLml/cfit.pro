    ...
    <div class="panel-body">
      <form class="load-indicator main-form form-horizontal" id="paramsForm" target='reportWin' method='post'>
        ...
        <div class="form-group">
          ...
          <div class="col-md-9">
            <?php if(!$projectID) echo html::select('projectID', $programPairs, $projectID, "$disablePgm class='form-control chosen'");?>
...
<div class="col-md-9">
  <iframe name='reportWin' frameborder='0' scrolling='no' class='w-p100' height="700"></iframe>
</div>
