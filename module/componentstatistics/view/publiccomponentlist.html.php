              ...
              <form method='post'>
                  <div class="table-row" id='conditions'>
                      <div class='w-120px col-md-2 col-sm-2' >
                          <div style="line-height:24px;"><?php echo $lang->componentstatistics->componentPublishTime;?>: </div>
                      </div>
                      <?php
...
<!--                                  <span class='input-group-addon'><a class="--><?php //if($selectfilterkey==$filterkey){ echo 'red';}?><!--" href="--><?php //echo $this->createLink("componentstatistics","publicComponentList","filterdate={$filterkey}") ?><!--">--><?php //echo $filterdate;?><!--</a> </span>-->
                  ...
                  <div class="table-row" id='conditions2'>
                      ...
                      <div class='w-220px col-md-3 col-sm-6'>
                          <div class='input-group'>
                              ...
                              <div class=''><?php echo html::radio("searchtype",$lang->componentstatistics->searchTypeList,$searchtype) ?></div>
      ...
      <div class='panel'>
        <div class="panel-heading">
          ...
          <nav class="panel-actions btn-toolbar">
            <?php if(common::hasPriv('componentstatistics', 'exportPublicComponentStatistics')) echo html::a(inLink('exportPublicComponentStatistics'), $lang->export, '', 'class="iframe btn btn-primary btn-sm"');?>
          </nav>
        </div>
        <div data-ride='table'>
          ...
          <table class='table datatables has-sort-head table-bordered'  id="tableaccount">
            <thead>
              <tr class='text-center'>
                <th data-type="number" class='sort-disabled'><?php echo $lang->componentstatistics->bianhao;?></th>
                <th class='sort-disabled'><?php
                    if($searchtype == 1){
                        echo $lang->componentstatistics->maintainerDept;
                    }else{
                        echo $lang->componentstatistics->category;
                    }
                    ?></th>
              ...
              <tr class="text-center">
                ...
                <td><?php
                    if($searchtype == 1){
                        ...
                        echo zget($lang->component->categoryList,$key);
                    }
...
<script>
    $(function(){
        ...
        var tablesort = $("table.datatables").datatable({
            sortable: true,
            sort:function (event){
