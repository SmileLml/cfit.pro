...
<div id="mainContent" class="main-content">
  <div class="center-block">
    <div class="main-header">
      <h2><?php echo $lang->processimprove->create;?></h2>
    </div>
      ...
      <table class="table table-form">
        <tbody>
          <tr>
            ...
            <td><?php echo html::select('source', $lang->processimprove->sourceList, '', "class='form-control chosen'");?></td><td></td>
          </tr>
          <tr>
            <th><?php echo $lang->processimprove->desc;?></th>
            <td colspan='2'>
              <?php echo html::textarea('desc', '', "rows='8' class='form-control' placeholder=$lang->tips hidefocus='true' tabindex='' required");?>
            </td>
          </tr>
          <tr>
