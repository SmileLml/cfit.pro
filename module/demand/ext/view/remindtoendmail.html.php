...
<thead>
  <tr>
      <th style='width: 130px;'><?php echo  $this->lang->demand->code; ?></th>
      <th style='width: 100px;'><?php echo  $this->lang->demand->demandStatus; ?></th>
      <th style='width: 150px;'><?php echo  $this->lang->demand->title;?></th>
      <th style='width: 120px;'><?php echo  $this->lang->demand->requirementCode;?></th>
      <th style='width: 150px;'><?php echo  $this->lang->demand->requirementName;?></th>
      <th style='width: 150px;'><?php echo  $this->lang->demand->requirementPlanEnd;?></th>
