      ...
      <table class='table table-form'>
        <tbody>
          ...
          <tr>
            ...
            <td colspan='2'><?php echo html::textarea('desc', '', "rows='10' class='form-control kindeditor disabled-ie-placeholder' hidefocus='true' placeholder='" . htmlspecialchars($lang->release->descTemplate) . "'");?></td>
          </tr>
          <tr>
