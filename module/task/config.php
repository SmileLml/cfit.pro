...
$config->task->customCreateFields      = 'estStarted,deadline,mailto,pri,estimate,resourceTo,story';//20220610 新增三个自定义
...
$config->task->custom->createFields      = 'estStarted,deadline,mailto,pri,estimate';//$this->config->task->customCreateFields;
...
//$config->task->datatable->defaultField = array('id', 'pri', 'name','type', 'status', 'assignedTo', 'finishedBy', 'estimate', 'consumed', 'left', 'progress', 'deadline', 'actions');
$config->task->datatable->defaultField = array('id', 'pri', 'name','type', 'status', 'assignedTo', 'finishedBy','consumed', 'progress', 'deadline', 'actions');
