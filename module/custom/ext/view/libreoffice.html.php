...
<div id='mainContent' class="main-content">
  ...
  <table class="table table-form">
    <tr>
      <th class="w-140px"><?php echo $lang->custom->libreOfficeTurnon?></th>
    ...
    <tr class=''>
      <th><?php echo $lang->custom->publicPath?></th>
      <td><?php echo html::input('publicPath', zget($config->file, 'publicPath', ''), "class='form-control' autocomplete='off' placeholder='{$lang->custom->publicPath}'")?></td>
    </tr>
    <tr class=''>
      <th><?php echo $lang->custom->internalAddress;?></th>
      <td><?php echo html::input('internalAddress', zget($config->file, 'internalAddress', ''), "class='form-control' autocomplete='off' placeholder='{$lang->custom->internalAddress}'")?></td>
    </tr>
    <tr>
